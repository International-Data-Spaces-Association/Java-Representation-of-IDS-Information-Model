...
public enum SecurityProfile implements ModelClass {
    ...
    BASE_SECURITY_PROFILE("https://w3id.org/idsa/code/BASE_SECURITY_PROFILE",
        Arrays.asList(new TypedLiteral("Base security profile", "en")),
        Arrays.asList(new TypedLiteral("Default security profile of a certified IDS Connector.", "en"))),
    ...
    TRUST_PLUS_SECURITY_PROFILE("https://w3id.org/idsa/code/TRUST_PLUS_SECURITY_PROFILE",
        Arrays.asList(new TypedLiteral("Trust Plus security profile", "en")),
        Arrays.asList(new TypedLiteral("The Security Profile TRUST+ as defined by the IDS certification criteria.", "en"))),

    /**
     * The Security Profile TRUST as defined by the IDS certification criteria.
     */
    TRUST_SECURITY_PROFILE("https://w3id.org/idsa/code/TRUST_SECURITY_PROFILE",
        Arrays.asList(new TypedLiteral("Trust security profile", "en")),
        Arrays.asList(new TypedLiteral("The Security Profile TRUST as defined by the IDS certification criteria.", "en")));
