...
/**
 * Default implementation of package de.fraunhofer.iais.eis.SwapRequest
 * 
 * The ContractRequest class representing the 'Data Swap' policy class.
 */
@JsonIgnoreProperties(ignoreUnknown = true)
@JsonTypeName("ids:SwapRequest")
public class SwapRequestImpl implements SwapRequest {
    ...
    protected List<TypedLiteral> comment =
        Arrays.asList(new TypedLiteral("The ContractRequest class representing the 'Data Swap' policy class.", "en"));
    ...
    protected SwapRequestImpl() {
        id = VocabUtil.getInstance().createRandomUrl("swapRequest");
    }
    ...
    public boolean equals(Object obj) {
        if (this == obj) {
            ...
            SwapRequestImpl other = (SwapRequestImpl) obj;
    ...
    public SwapRequest deepCopy() {
        SwapRequestBuilder builder = new SwapRequestBuilder();
