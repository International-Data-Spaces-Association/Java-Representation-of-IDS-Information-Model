...
/**
 * Default implementation of package de.fraunhofer.iais.eis.TextRepresentation
 * 
 * Representation of a textual content.
 */
@JsonIgnoreProperties(ignoreUnknown = true)
@JsonTypeName("ids:TextRepresentation")
public class TextRepresentationImpl implements TextRepresentation {
    ...
    @JsonIgnore
    protected List<TypedLiteral> label = Arrays.asList(new TypedLiteral("Text representation", "en"));

    // List of all comments of this class
    @JsonIgnore
    protected List<TypedLiteral> comment = Arrays.asList(new TypedLiteral("Representation of a textual content.", "en"));
    ...
    public boolean equals(Object obj) {
        if (this == obj) {
            ...
            TextRepresentationImpl other = (TextRepresentationImpl) obj;
    ...
    public TextRepresentation deepCopy() {
        TextRepresentationBuilder builder = new TextRepresentationBuilder();
