...
public enum LogLevel implements ModelClass {
     ...
     * Debug level logging.
     */
    DEBUG_LEVEL_LOGGING("https://w3id.org/idsa/code/DEBUG_LEVEL_LOGGING", Arrays.asList(new TypedLiteral("Debug Level Logging", "en")),
        Arrays.asList(new TypedLiteral("Debug level logging.", "en"))),

    /**
     * Minimal logging.
     */
    MINIMAL_LOGGING("https://w3id.org/idsa/code/MINIMAL_LOGGING", Arrays.asList(new TypedLiteral("Minimal Logging", "en")),
        Arrays.asList(new TypedLiteral("Minimal logging.", "en"))),

    /**
     * No logging.
     */
    NO_LOGGING("https://w3id.org/idsa/code/NO_LOGGING", Arrays.asList(new TypedLiteral("No Logging", "en")),
        Arrays.asList(new TypedLiteral("No logging.", "en")));
