...
/**
 * Default implementation of package de.fraunhofer.iais.eis.RentalOffer
 * 
 * The ContractOffer class representing the 'Data Rental' policy class.
 */
@JsonIgnoreProperties(ignoreUnknown = true)
@JsonTypeName("ids:RentalOffer")
public class RentalOfferImpl implements RentalOffer {
    ...
    protected List<TypedLiteral> comment =
        Arrays.asList(new TypedLiteral("The ContractOffer class representing the 'Data Rental' policy class.", "en"));
    ...
    public boolean equals(Object obj) {
        if (this == obj) {
            ...
            RentalOfferImpl other = (RentalOfferImpl) obj;
    ...
    public RentalOffer deepCopy() {
        RentalOfferBuilder builder = new RentalOfferBuilder();
