...
public class AppUploadResponseMessageBuilder implements Builder<AppUploadResponseMessage> {
     ...
     */
    @Override
    public AppUploadResponseMessage build() throws ConstraintViolationException {
