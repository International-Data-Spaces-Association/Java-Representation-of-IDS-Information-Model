...
/**
 * Default implementation of package de.fraunhofer.iais.eis.SalesAgreement
 * 
 * The ContractAgreement class representing the Perpetual Data Sale policy class.
 */
@JsonIgnoreProperties(ignoreUnknown = true)
@JsonTypeName("ids:SalesAgreement")
public class SalesAgreementImpl implements SalesAgreement {
    ...
    @JsonIgnore
    protected List<TypedLiteral> label = Arrays.asList(new TypedLiteral("Sales Agreement", "en"));

    // List of all comments of this class
    @JsonIgnore
    protected List<TypedLiteral> comment =
        Arrays.asList(new TypedLiteral("The ContractAgreement class representing the Perpetual Data Sale policy class.", "en"));
    ...
    public boolean equals(Object obj) {
        if (this == obj) {
            ...
            SalesAgreementImpl other = (SalesAgreementImpl) obj;
    ...
    public SalesAgreement deepCopy() {
        SalesAgreementBuilder builder = new SalesAgreementBuilder();
