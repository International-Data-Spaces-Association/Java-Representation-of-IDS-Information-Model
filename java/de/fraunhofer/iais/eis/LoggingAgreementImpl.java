...
/**
 * Default implementation of package de.fraunhofer.iais.eis.LoggingAgreement
 * 
 * The ContractAgreement class representing the 'Local Logging' policy class.
 */
@JsonIgnoreProperties(ignoreUnknown = true)
@JsonTypeName("ids:LoggingAgreement")
public class LoggingAgreementImpl implements LoggingAgreement {
    ...
    protected List<TypedLiteral> comment =
        Arrays.asList(new TypedLiteral("The ContractAgreement class representing the 'Local Logging' policy class.", "en"));
    ...
    public LoggingAgreement deepCopy() {
        LoggingAgreementBuilder builder = new LoggingAgreementBuilder();
