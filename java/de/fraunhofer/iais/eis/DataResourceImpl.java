...
/**
 * Default implementation of package de.fraunhofer.iais.eis.DataResource
 * 
...
public class DataResourceImpl implements DataResource {
    ...
    @JsonIgnore
    protected List<TypedLiteral> comment = Arrays.asList(new TypedLiteral("Resource (at least partially) comprising data content.", "en"));
