...
/**
 * Default implementation of package de.fraunhofer.iais.eis.AppResourceCatalog
 * 
...
public class AppResourceCatalogImpl implements AppResourceCatalog {
    ...
    protected List<AppResource> _listedAppResource = new ArrayList<>();
    ...
    @Override
    public int hashCode() {
        return Objects.hash(this._listedAppResource);
    }
