...
/**
 * Default implementation of package de.fraunhofer.iais.eis.ResultMessage
 * 
...
public class ResultMessageImpl implements ResultMessage {
    ...
    protected List<TypedLiteral> comment =
        Arrays.asList(new TypedLiteral("Result messages are intended to annotate the results of a query command. ", "en"));
