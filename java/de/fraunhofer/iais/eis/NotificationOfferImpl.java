...
/**
 * Default implementation of package de.fraunhofer.iais.eis.NotificationOffer
 * 
 * The ContractOffer class representing the 'Remote Notifications' policy class.
 */
@JsonIgnoreProperties(ignoreUnknown = true)
@JsonTypeName("ids:NotificationOffer")
public class NotificationOfferImpl implements NotificationOffer {
    ...
    protected List<TypedLiteral> comment =
        Arrays.asList(new TypedLiteral("The ContractOffer class representing the 'Remote Notifications' policy class.", "en"));
    ...
    protected NotificationOfferImpl() {
    ...
    public boolean equals(Object obj) {
        if (this == obj) {
            ...
            NotificationOfferImpl other = (NotificationOfferImpl) obj;
    ...
    public NotificationOffer deepCopy() {
        NotificationOfferBuilder builder = new NotificationOfferBuilder();
