...
public class DataResourceBuilder implements Builder<DataResource> {
     ...
     */
    public DataResourceBuilder _publisherAsObject_(Agent _publisher_) {
        this.dataResourceImpl.setPublisherAsObject(_publisher_);
        return this;
    }
     ...
     */
    public DataResourceBuilder _publisherAsUri_(URI _publisher_) {
        this.dataResourceImpl.setPublisherAsUri(_publisher_);
        return this;
    }
     ...
     */
    public DataResourceBuilder _sovereignAsObject_(Agent _sovereign_) {
        this.dataResourceImpl.setSovereignAsObject(_sovereign_);
        return this;
    }
     ...
     */
    public DataResourceBuilder _sovereignAsUri_(URI _sovereign_) {
        this.dataResourceImpl.setSovereignAsUri(_sovereign_);
        return this;
    }
     ...
     */
    public DataResourceBuilder _hasQualityMeasurement_(List<QualityMeasurement> _hasQualityMeasurement_) {
        this.dataResourceImpl.setHasQualityMeasurement(_hasQualityMeasurement_);
        return this;
    }
     ...
     * @return Builder object with new value for _hasQualityMeasurement
     */
    public DataResourceBuilder _hasQualityMeasurement_(QualityMeasurement _hasQualityMeasurement_) {
        this.dataResourceImpl.getHasQualityMeasurement().add(_hasQualityMeasurement_);
        return this;
    }
