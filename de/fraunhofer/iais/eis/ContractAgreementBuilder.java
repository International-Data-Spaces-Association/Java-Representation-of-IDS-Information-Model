...
public class ContractAgreementBuilder {
	...
	*/
	final public ContractAgreementBuilder _permission_(List<Permission> _permission_) {
	...
	*/
	final public ContractAgreementBuilder _prohibition_(List<Prohibition> _prohibition_) {
	...
	*/
	final public ContractAgreementBuilder _obligation_(List<Duty> _obligation_) {
