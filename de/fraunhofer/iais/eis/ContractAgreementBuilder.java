...
public class ContractAgreementBuilder {
	...
	*/
	final public ContractAgreementBuilder _permission_(ArrayList<? extends Permission> _permission_) {
	...
	*/
	final public ContractAgreementBuilder _prohibition_(ArrayList<? extends Prohibition> _prohibition_) {
	...
	*/
	final public ContractAgreementBuilder _obligation_(ArrayList<? extends Duty> _obligation_) {
