...
public class ClearingHouseImpl implements ClearingHouse {
    ...
    public ClearingHouse deepCopy() {
        ClearingHouseBuilder builder = new ClearingHouseBuilder();
    ...
    @Override
    /**
     * Helper function for (de-)serialization of the _clearingHouse and the
     * _clearingHouseAsParticipantfields.
     *
