...
/** 
	"Message Processed Notification Message"@en

	"Notification that a message has been successfully processed (i.e. not ignored or rejected)."@en */
@JsonIgnoreProperties(ignoreUnknown = true)
@JsonTypeName("ids:MessageProcessedNotificationMessage")
public class MessageProcessedNotificationMessageImpl implements Serializable, MessageProcessedNotificationMessage {
	...
	@JsonIgnore
	java.util.List<TypedLiteral> label = Arrays.asList(new TypedLiteral("Message Processed Notification Message", "en"));
	//List of all comments of this class
	@JsonIgnore
	java.util.List<TypedLiteral> comment = Arrays.asList(new TypedLiteral("Notification that a message has been successfully processed (i.e. not ignored or rejected).", "en"));
	...
	*/
	...
	MessageProcessedNotificationMessageImpl() {
