...
public class MessageProcessedNotificationMessageImpl implements Serializable, MessageProcessedNotificationMessage {
	...
	@JsonIgnore
	protected List<TypedLiteral> comment = Arrays.asList(new TypedLiteral("Notification that a message has been successfully processed (i.e. not ignored or rejected).", "en"));
