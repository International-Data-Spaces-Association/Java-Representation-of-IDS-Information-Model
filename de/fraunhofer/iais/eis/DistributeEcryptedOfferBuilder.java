...
public class DistributeEcryptedOfferBuilder {
	...
	*/
	final public DistributeEcryptedOfferBuilder _permission_(List<Permission> _permission_) {
	...
	*/
	final public DistributeEcryptedOfferBuilder _prohibition_(List<Prohibition> _prohibition_) {
	...
	*/
	final public DistributeEcryptedOfferBuilder _obligation_(List<Duty> _obligation_) {
