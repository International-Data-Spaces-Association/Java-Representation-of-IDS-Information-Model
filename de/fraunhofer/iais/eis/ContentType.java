...
public enum ContentType implements ModelClass {
     ...
     * Blueprint, WSDL.
     */
    INTERFACE_DEFINITION("https://w3id.org/idsa/code/INTERFACE_DEFINITION", Arrays.asList(new TypedLiteral("Interface definition", "")),
     ...
     */
    SCHEMA_DEFINITION("https://w3id.org/idsa/code/SCHEMA_DEFINITION", Arrays.asList(new TypedLiteral("Schema definition", "")),
        Arrays.asList(new TypedLiteral("Formal, machine-interpretable definition of a data schema, e.g., XMLSchema, JSONSchema", "en")));
