...
public class NotMoreThanNOfferBuilder {
	...
	*/
	final public NotMoreThanNOfferBuilder _permission_(List<Permission> _permission_) {
	...
	*/
	final public NotMoreThanNOfferBuilder _prohibition_(List<Prohibition> _prohibition_) {
	...
	*/
	final public NotMoreThanNOfferBuilder _obligation_(List<Duty> _obligation_) {
