...
public class RentalRequestBuilder {
	...
	*/
	final public RentalRequestBuilder _permission_(List<Permission> _permission_) {
	...
	*/
	final public RentalRequestBuilder _prohibition_(List<Prohibition> _prohibition_) {
	...
	*/
	final public RentalRequestBuilder _obligation_(List<Duty> _obligation_) {
