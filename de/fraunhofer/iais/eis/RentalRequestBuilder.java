...
public class RentalRequestBuilder implements Builder<RentalRequest> {
    ...
    public RentalRequestBuilder(URI id) {
        this();
     ...
     */
    public RentalRequestBuilder _contractStart_(XMLGregorianCalendar _contractStart_) {
        this.rentalRequestImpl.setContractStart(_contractStart_);
        return this;
    }
     ...
     */
    public RentalRequestBuilder _contractEnd_(XMLGregorianCalendar _contractEnd_) {
        this.rentalRequestImpl.setContractEnd(_contractEnd_);
        return this;
    }
     ...
     */
    public RentalRequestBuilder _contractDate_(XMLGregorianCalendar _contractDate_) {
        this.rentalRequestImpl.setContractDate(_contractDate_);
        return this;
    }
     ...
     */
    public RentalRequestBuilder _provider_(URI _provider_) {
        this.rentalRequestImpl.setProvider(_provider_);
        return this;
    }
     ...
     */
    public RentalRequestBuilder _consumer_(URI _consumer_) {
        this.rentalRequestImpl.setConsumer(_consumer_);
        return this;
    }
     ...
     */
    public RentalRequestBuilder _contractDocument_(TextResource _contractDocument_) {
        this.rentalRequestImpl.setContractDocument(_contractDocument_);
        return this;
    }
     ...
     */
    public RentalRequestBuilder _contractAnnex_(Resource _contractAnnex_) {
        this.rentalRequestImpl.setContractAnnex(_contractAnnex_);
        return this;
    }
     ...
     */
    public RentalRequestBuilder _permission_(List<Permission> _permission_) {
        this.rentalRequestImpl.setPermission(_permission_);
        return this;
    }
     ...
     * @return Builder object with new value for _permission
     */
    public RentalRequestBuilder _permission_(Permission _permission_) {
        this.rentalRequestImpl.getPermission().add(_permission_);
        return this;
    }
     ...
     */
    public RentalRequestBuilder _prohibition_(List<Prohibition> _prohibition_) {
        this.rentalRequestImpl.setProhibition(_prohibition_);
        return this;
    }
     ...
     * @return Builder object with new value for _prohibition
     */
    public RentalRequestBuilder _prohibition_(Prohibition _prohibition_) {
        this.rentalRequestImpl.getProhibition().add(_prohibition_);
        return this;
    }
     ...
     */
    public RentalRequestBuilder _obligation_(List<Duty> _obligation_) {
        this.rentalRequestImpl.setObligation(_obligation_);
        return this;
    }
     ...
     * @return Builder object with new value for _obligation
     */
    public RentalRequestBuilder _obligation_(Duty _obligation_) {
        this.rentalRequestImpl.getObligation().add(_obligation_);
        return this;
    }
     ...
     */
    @Override
    public RentalRequest build() throws ConstraintViolationException {
