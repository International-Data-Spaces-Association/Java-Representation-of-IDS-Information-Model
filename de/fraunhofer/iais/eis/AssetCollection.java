...
public interface AssetCollection extends Asset {
	...
	*/
	...
	/**
	* This function returns a hash code value for the AssetCollection for the benefit of e.g. hash tables.
	* @return a hash code value for the AssetCollection
	*/
	public int hashCode();
	...
	* @return true if this AssetCollection is the same as the obj argument; false otherwise.
	*/
