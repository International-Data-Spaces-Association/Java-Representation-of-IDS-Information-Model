...
public class DeleteAfterIntervalOfferBuilder {
	...
	*/
	final public DeleteAfterIntervalOfferBuilder _permission_(ArrayList<? extends Permission> _permission_) {
	...
	*/
	final public DeleteAfterIntervalOfferBuilder _prohibition_(ArrayList<? extends Prohibition> _prohibition_) {
	...
	*/
	final public DeleteAfterIntervalOfferBuilder _obligation_(ArrayList<? extends Duty> _obligation_) {
	...
	*/
	...
	final public DeleteAfterIntervalOffer build() throws ConstraintViolationException {
