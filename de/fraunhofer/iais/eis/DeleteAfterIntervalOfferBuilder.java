...
public class DeleteAfterIntervalOfferBuilder {
	...
	*/
	final public DeleteAfterIntervalOfferBuilder _permission_(List<Permission> _permission_) {
	...
	*/
	final public DeleteAfterIntervalOfferBuilder _prohibition_(List<Prohibition> _prohibition_) {
	...
	*/
	final public DeleteAfterIntervalOfferBuilder _obligation_(List<Duty> _obligation_) {
