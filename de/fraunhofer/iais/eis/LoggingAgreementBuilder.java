...
public class LoggingAgreementBuilder {
	...
	*/
	final public LoggingAgreementBuilder _permission_(ArrayList<? extends Permission> _permission_) {
	...
	*/
	final public LoggingAgreementBuilder _prohibition_(ArrayList<? extends Prohibition> _prohibition_) {
	...
	*/
	final public LoggingAgreementBuilder _obligation_(ArrayList<? extends Duty> _obligation_) {
