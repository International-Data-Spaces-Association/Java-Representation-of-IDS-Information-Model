...
public class LoggingAgreementBuilder {
	...
	*/
	final public LoggingAgreementBuilder _permission_(List<Permission> _permission_) {
	...
	*/
	final public LoggingAgreementBuilder _prohibition_(List<Prohibition> _prohibition_) {
	...
	*/
	final public LoggingAgreementBuilder _obligation_(List<Duty> _obligation_) {
