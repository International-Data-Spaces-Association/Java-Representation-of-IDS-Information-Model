...
public class IntervalUsageOfferImpl implements Serializable, IntervalUsageOffer {
	...
	@JsonIgnore
	protected List<TypedLiteral> comment = Arrays.asList(new TypedLiteral("The ContractOffer class representing the 'Interval-restricted Data Usage' policy class.", "en"));
