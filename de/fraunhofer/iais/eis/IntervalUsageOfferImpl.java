...
/** 
	...
	"The ContractOffer class representing the \'Interval-restricted Data Usage\' policy class."@en */
@JsonIgnoreProperties(ignoreUnknown = true)
@JsonTypeName("ids:IntervalUsageOffer")
public class IntervalUsageOfferImpl implements Serializable, IntervalUsageOffer {
	...
	@JsonIgnore
	java.util.List<TypedLiteral> comment = Arrays.asList(new TypedLiteral("The ContractOffer class representing the 'Interval-restricted Data Usage' policy class.", "en"));
	...
	*/
	...
	IntervalUsageOfferImpl() {
		id = VocabUtil.getInstance().createRandomUrl("intervalUsageOffer");
	}
