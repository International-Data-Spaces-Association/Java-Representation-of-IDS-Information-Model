...
/** 
* "Upload Message"@en
* "Message used to upload a data to a recipient. Payload contains data."@en 
*/
@JsonIgnoreProperties(ignoreUnknown = true)
@JsonTypeName("ids:UploadMessage")
public class UploadMessageImpl implements Serializable, UploadMessage {
	...
	@JsonIgnore
	protected List<TypedLiteral> comment = Arrays.asList(new TypedLiteral("Message used to upload a data to a recipient. Payload contains data.", "en"));
