...
public class UploadMessageImpl implements Serializable, UploadMessage {
	...
	@JsonIgnore
	java.util.List<TypedLiteral> label = Arrays.asList(new TypedLiteral("Upload Message", "en"));
	//List of all comments of this class
	@JsonIgnore
	java.util.List<TypedLiteral> comment = Arrays.asList(new TypedLiteral("Message used to upload a data to a recipient. Payload contains data.", "en"));
