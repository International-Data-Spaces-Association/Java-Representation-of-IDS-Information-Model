...
public class NotificationOfferBuilder implements Builder<NotificationOffer> {
    ...
    public NotificationOfferBuilder(URI id) {
        this();
     ...
     */
    public NotificationOfferBuilder _contractStart_(XMLGregorianCalendar _contractStart_) {
        this.notificationOfferImpl.setContractStart(_contractStart_);
        return this;
    }
     ...
     */
    public NotificationOfferBuilder _contractEnd_(XMLGregorianCalendar _contractEnd_) {
        this.notificationOfferImpl.setContractEnd(_contractEnd_);
        return this;
    }
     ...
     */
    public NotificationOfferBuilder _contractDate_(XMLGregorianCalendar _contractDate_) {
        this.notificationOfferImpl.setContractDate(_contractDate_);
        return this;
    }
     ...
     */
    public NotificationOfferBuilder _provider_(URI _provider_) {
        this.notificationOfferImpl.setProvider(_provider_);
        return this;
    }
     ...
     */
    public NotificationOfferBuilder _consumer_(URI _consumer_) {
        this.notificationOfferImpl.setConsumer(_consumer_);
        return this;
    }
     ...
     */
    public NotificationOfferBuilder _contractDocument_(TextResource _contractDocument_) {
        this.notificationOfferImpl.setContractDocument(_contractDocument_);
        return this;
    }
     ...
     */
    public NotificationOfferBuilder _contractAnnex_(Resource _contractAnnex_) {
        this.notificationOfferImpl.setContractAnnex(_contractAnnex_);
        return this;
    }
     ...
     */
    public NotificationOfferBuilder _permission_(List<Permission> _permission_) {
        this.notificationOfferImpl.setPermission(_permission_);
        return this;
    }
     ...
     * @return Builder object with new value for _permission
     */
    public NotificationOfferBuilder _permission_(Permission _permission_) {
        this.notificationOfferImpl.getPermission().add(_permission_);
        return this;
    }
     ...
     */
    public NotificationOfferBuilder _prohibition_(List<Prohibition> _prohibition_) {
        this.notificationOfferImpl.setProhibition(_prohibition_);
        return this;
    }
     ...
     * @return Builder object with new value for _prohibition
     */
    public NotificationOfferBuilder _prohibition_(Prohibition _prohibition_) {
        this.notificationOfferImpl.getProhibition().add(_prohibition_);
        return this;
    }
     ...
     */
    public NotificationOfferBuilder _obligation_(List<Duty> _obligation_) {
        this.notificationOfferImpl.setObligation(_obligation_);
        return this;
    }
     ...
     * @return Builder object with new value for _obligation
     */
    public NotificationOfferBuilder _obligation_(Duty _obligation_) {
        this.notificationOfferImpl.getObligation().add(_obligation_);
        return this;
    }
     ...
     */
    @Override
    public NotificationOffer build() throws ConstraintViolationException {
