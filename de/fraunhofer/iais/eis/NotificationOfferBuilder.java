...
public class NotificationOfferBuilder {
	...
	*/
	final public NotificationOfferBuilder _permission_(List<Permission> _permission_) {
	...
	*/
	final public NotificationOfferBuilder _prohibition_(List<Prohibition> _prohibition_) {
	...
	*/
	final public NotificationOfferBuilder _obligation_(List<Duty> _obligation_) {
