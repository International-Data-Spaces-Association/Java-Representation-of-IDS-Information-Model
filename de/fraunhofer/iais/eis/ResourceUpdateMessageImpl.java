...
public class ResourceUpdateMessageImpl implements Serializable, ResourceUpdateMessage {
	...
	@JsonIgnore
	java.util.List<TypedLiteral> label = Arrays.asList(new TypedLiteral("Resource Update Message", "en"));
	//List of all comments of this class
	@JsonIgnore
	java.util.List<TypedLiteral> comment = Arrays.asList(new TypedLiteral("Message indicating the availability and current description of a specific resource. The resource must be present in the payload of this message.", "en"));
	...
	*/
	@NotNull@JsonAlias({"ids:affectedResource", "affectedResource"})
	 URI _affectedResource;
