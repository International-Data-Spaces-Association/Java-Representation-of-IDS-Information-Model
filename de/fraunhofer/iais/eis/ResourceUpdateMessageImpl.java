...
/** 
* "Resource Update Message"@en
* "Message indicating the availability and current description of a specific resource. The resource must be present in the payload of this message."@en 
*/
@JsonIgnoreProperties(ignoreUnknown = true)
@JsonTypeName("ids:ResourceUpdateMessage")
public class ResourceUpdateMessageImpl implements Serializable, ResourceUpdateMessage {
	...
	@JsonIgnore
	protected List<TypedLiteral> label = Arrays.asList(new TypedLiteral("Resource Update Message", "en"));

	//List of all comments of this class
	@JsonIgnore
	protected List<TypedLiteral> comment = Arrays.asList(new TypedLiteral("Message indicating the availability and current description of a specific resource. The resource must be present in the payload of this message.", "en"));
	...
	*/
	...
	protected ResourceUpdateMessageImpl() {
		id = VocabUtil.getInstance().createRandomUrl("resourceUpdateMessage");
	}
	...
	public int hashCode() {
		return Objects.hash(new Object[]{this._affectedResource,
			this._modelVersion,
			this._issued,
	...
	public boolean equals(Object obj) {
		if (this == obj) {
			...
			ResourceUpdateMessageImpl other = (ResourceUpdateMessageImpl) obj;
