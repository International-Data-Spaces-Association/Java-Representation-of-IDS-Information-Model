...
public class AppResourceCatalogImpl implements Serializable, AppResourceCatalog {
	...
	@JsonIgnore
	protected List<TypedLiteral> label = Arrays.asList(new TypedLiteral("App Resource Catalog", "en"));

	//List of all comments of this class
	@JsonIgnore
	protected List<TypedLiteral> comment = Arrays.asList(new TypedLiteral("Class that aggregates App Resources from a (distributable) Catalog. May be used to list installed apps in a component.", "en"));
	...
	*/
	...
	protected AppResourceCatalogImpl() {
