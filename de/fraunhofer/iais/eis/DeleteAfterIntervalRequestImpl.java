...
public class DeleteAfterIntervalRequestImpl implements Serializable, DeleteAfterIntervalRequest {
	...
	@JsonIgnore
	java.util.List<TypedLiteral> label = Arrays.asList(new TypedLiteral("Sales Request", "en"));
	//List of all comments of this class
	@JsonIgnore
	java.util.List<TypedLiteral> comment = Arrays.asList(new TypedLiteral("The ContractRequest class representing the 'Interval-restricted Data Usage' policy class with the further obligation to delete the data.", "en"));
	...
	*/
	...
	DeleteAfterIntervalRequestImpl() {
