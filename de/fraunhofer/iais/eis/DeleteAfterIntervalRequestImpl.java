...
/** 
* "Sales Request"@en
* "The ContractRequest class representing the \'Interval-restricted Data Usage\' policy class with the further obligation to delete the data."@en 
*/
@JsonIgnoreProperties(ignoreUnknown = true)
@JsonTypeName("ids:DeleteAfterIntervalRequest")
public class DeleteAfterIntervalRequestImpl implements Serializable, DeleteAfterIntervalRequest {
	...
	@JsonIgnore
	protected List<TypedLiteral> label = Arrays.asList(new TypedLiteral("Sales Request", "en"));

	//List of all comments of this class
	@JsonIgnore
	protected List<TypedLiteral> comment = Arrays.asList(new TypedLiteral("The ContractRequest class representing the 'Interval-restricted Data Usage' policy class with the further obligation to delete the data.", "en"));
	...
	*/
	...
	protected DeleteAfterIntervalRequestImpl() {
		id = VocabUtil.getInstance().createRandomUrl("deleteAfterIntervalRequest");
	}
	...
	public boolean equals(Object obj) {
		if (this == obj) {
			...
			DeleteAfterIntervalRequestImpl other = (DeleteAfterIntervalRequestImpl) obj;
