...
public enum DefaultIntegrityGuarantee implements IntegrityGuarantee {
    ...
    */
    ...
    private static final Map<String, DefaultIntegrityGuarantee> uriInstanceMapping;
    static {
    ...
    private IntegrityGuarantee integrityGuarantee;

    DefaultIntegrityGuarantee(String id) {
        this.integrityGuarantee = new IntegrityGuaranteeBuilder(URI.create(id)).build();
    }
    ...
    final public URI getId() {
        return this.integrityGuarantee.getId();
    }
    ...
    final public List<TypedLiteral> getLabel() {
        return this.integrityGuarantee.getLabel();
    }
    ...
    final public List<TypedLiteral> getComment() {
        return this.integrityGuarantee.getComment();
    }
    ...
    @JsonCreator
    public static DefaultIntegrityGuarantee deserialize(JsonNode node) {
        return uriInstanceMapping.get(node.has("@id") ? node.get("@id").textValue() : node.textValue());
    }

    @Override
    public String toString() {
        return this.integrityGuarantee.getId().toString();
    }
