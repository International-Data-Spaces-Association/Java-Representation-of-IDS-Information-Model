...
public class IntervalUsageAgreementBuilder {
	...
	*/
	final public IntervalUsageAgreementBuilder _permission_(List<Permission> _permission_) {
	...
	*/
	final public IntervalUsageAgreementBuilder _prohibition_(List<Prohibition> _prohibition_) {
	...
	*/
	final public IntervalUsageAgreementBuilder _obligation_(List<Duty> _obligation_) {
