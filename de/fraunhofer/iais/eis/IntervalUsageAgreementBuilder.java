...
public class IntervalUsageAgreementBuilder {
	...
	*/
	final public IntervalUsageAgreementBuilder _permission_(ArrayList<? extends Permission> _permission_) {
	...
	*/
	final public IntervalUsageAgreementBuilder _prohibition_(ArrayList<? extends Prohibition> _prohibition_) {
	...
	*/
	final public IntervalUsageAgreementBuilder _obligation_(ArrayList<? extends Duty> _obligation_) {
	...
	*/
	...
	final public IntervalUsageAgreement build() throws ConstraintViolationException {
