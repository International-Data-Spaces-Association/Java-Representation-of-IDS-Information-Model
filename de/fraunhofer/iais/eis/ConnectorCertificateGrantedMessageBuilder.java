...
public class ConnectorCertificateGrantedMessageBuilder {
	...
	*/
	final public ConnectorCertificateGrantedMessageBuilder _recipientConnector_(ArrayList<? extends URI> _recipientConnector_) {
	...
	*/
	final public ConnectorCertificateGrantedMessageBuilder _recipientAgent_(ArrayList<? extends URI> _recipientAgent_) {
	...
	*/
	...
	final public ConnectorCertificateGrantedMessage build() throws ConstraintViolationException {
