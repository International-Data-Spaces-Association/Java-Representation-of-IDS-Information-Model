...
/**
 * Default implementation of package de.fraunhofer.iais.eis.AudioRepresentation
 * 
 * Audio representation
 */
@JsonIgnoreProperties(ignoreUnknown = true)
@JsonTypeName("ids:AudioRepresentation")
public class AudioRepresentationImpl implements AudioRepresentation {
    ...
    @JsonIgnore
    protected List<TypedLiteral> label = Arrays.asList(new TypedLiteral("Audio Representation", "en"));

    // List of all comments of this class
    @JsonIgnore
    protected List<TypedLiteral> comment = Arrays.asList(new TypedLiteral("Audio representation", "en"));
    ...
    protected java.math.BigDecimal _samplingRate;
    ...
    protected AudioRepresentationImpl() {
    ...
    @Override
    public int hashCode() {
        return Objects.hash(this._samplingRate,
            this._instance,
            this._mediaType,
    ...
    public boolean equals(Object obj) {
        if (this == obj) {
            ...
            AudioRepresentationImpl other = (AudioRepresentationImpl) obj;
            return Objects.equals(this._samplingRate, other._samplingRate) &&
    ...
    public AudioRepresentation deepCopy() {
        AudioRepresentationBuilder builder = new AudioRepresentationBuilder();
        builder._samplingRate_(this._samplingRate);
