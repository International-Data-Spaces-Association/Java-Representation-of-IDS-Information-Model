...
/** 
* "AccessToken Request Message"@en
* "Message requesting an access token. This is intended for point-to-point communication with, e.g., Brokers."@en 
*/
@JsonIgnoreProperties(ignoreUnknown = true)
@JsonTypeName("ids:AccessTokenRequestMessage")
public class AccessTokenRequestMessageImpl implements Serializable, AccessTokenRequestMessage {
	...
	@JsonIgnore
	protected List<TypedLiteral> label = Arrays.asList(new TypedLiteral("AccessToken Request Message", "en"));

	//List of all comments of this class
	@JsonIgnore
	protected List<TypedLiteral> comment = Arrays.asList(new TypedLiteral("Message requesting an access token. This is intended for point-to-point communication with, e.g., Brokers.", "en"));
	...
	*/
	...
	protected AccessTokenRequestMessageImpl() {
		id = VocabUtil.getInstance().createRandomUrl("accessTokenRequestMessage");
	}
	...
	public boolean equals(Object obj) {
		if (this == obj) {
			...
			AccessTokenRequestMessageImpl other = (AccessTokenRequestMessageImpl) obj;
