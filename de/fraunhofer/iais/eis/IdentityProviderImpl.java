...
/**
 * Default implementation of package de.fraunhofer.iais.eis.IdentityProvider
 * 
 * The Identity Provider manages and validates the digital identity of International Data Spaces
 * Participants.
 */
@JsonIgnoreProperties(ignoreUnknown = true)
@JsonTypeName("ids:IdentityProvider")
public class IdentityProviderImpl implements IdentityProvider {
    ...
    @JsonIgnore
    protected List<TypedLiteral> label = Arrays.asList(new TypedLiteral("Identity provider", "en"));

    // List of all comments of this class
    @JsonIgnore
    protected List<TypedLiteral> comment = Arrays.asList(new TypedLiteral(
        "The Identity Provider manages and validates the digital identity of International Data Spaces Participants.", "en"));
    ...
    protected IdentityProviderImpl() {
        id = VocabUtil.getInstance().createRandomUrl("identityProvider");
    }
    ...
    public boolean equals(Object obj) {
        if (this == obj) {
            ...
            IdentityProviderImpl other = (IdentityProviderImpl) obj;
    ...
    public IdentityProvider deepCopy() {
        IdentityProviderBuilder builder = new IdentityProviderBuilder();
    ...
    @Override
    /**
     * Helper function for (de-)serialization of the _identityProvider and the
     * _identityProviderAsParticipantfields.
     *
