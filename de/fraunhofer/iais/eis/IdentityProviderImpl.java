...
public class IdentityProviderImpl implements Serializable, IdentityProvider {
	...
	@JsonIgnore
	java.util.List<TypedLiteral> label = Arrays.asList(new TypedLiteral("Identity provider", "en"));
	//List of all comments of this class
	@JsonIgnore
	java.util.List<TypedLiteral> comment = Arrays.asList(new TypedLiteral("The Identity Provider manages and validates the digital identity of International Data Spaces Participants.", "en"));
