...
public class IdentityProviderImpl implements Serializable, IdentityProvider {
	...
	@JsonIgnore
	protected List<TypedLiteral> comment = Arrays.asList(new TypedLiteral("The Identity Provider manages and validates the digital identity of International Data Spaces Participants.", "en"));
