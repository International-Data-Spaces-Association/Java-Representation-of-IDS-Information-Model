...
public class HTTPAuthenticationImpl implements Serializable, HTTPAuthentication {
	...
	@JsonIgnore
	java.util.List<TypedLiteral> label = Arrays.asList(new TypedLiteral("HTTP Authentication", "en"));
	//List of all comments of this class
	@JsonIgnore
	java.util.List<TypedLiteral> comment = Arrays.asList(new TypedLiteral("HTTP authentication.", "en"));
