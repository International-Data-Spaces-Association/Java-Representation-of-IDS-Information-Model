...
public class SecurityOfferBuilder {
	...
	*/
	final public SecurityOfferBuilder _permission_(List<Permission> _permission_) {
	...
	*/
	final public SecurityOfferBuilder _prohibition_(List<Prohibition> _prohibition_) {
	...
	*/
	final public SecurityOfferBuilder _obligation_(List<Duty> _obligation_) {
