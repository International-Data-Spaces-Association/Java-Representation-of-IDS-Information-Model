...
public class SecurityOfferBuilder {
	...
	*/
	final public SecurityOfferBuilder _permission_(ArrayList<? extends Permission> _permission_) {
	...
	*/
	final public SecurityOfferBuilder _prohibition_(ArrayList<? extends Prohibition> _prohibition_) {
	...
	*/
	final public SecurityOfferBuilder _obligation_(ArrayList<? extends Duty> _obligation_) {
	...
	*/
	...
	final public SecurityOffer build() throws ConstraintViolationException {
