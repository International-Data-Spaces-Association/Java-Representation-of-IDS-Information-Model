...
/** 
* "Notification Agreement"@en
* "The ContractAgreement class representing the \'Remote Notifications\' policy class."@en 
*/
@JsonIgnoreProperties(ignoreUnknown = true)
@JsonTypeName("ids:NotificationAgreement")
public class NotificationAgreementImpl implements Serializable, NotificationAgreement {
	...
	@JsonIgnore
	protected List<TypedLiteral> label = Arrays.asList(new TypedLiteral("Notification Agreement", "en"));

	//List of all comments of this class
	@JsonIgnore
	protected List<TypedLiteral> comment = Arrays.asList(new TypedLiteral("The ContractAgreement class representing the 'Remote Notifications' policy class.", "en"));
	...
	*/
	...
	protected NotificationAgreementImpl() {
		id = VocabUtil.getInstance().createRandomUrl("notificationAgreement");
	}
	...
	public boolean equals(Object obj) {
		if (this == obj) {
			...
			NotificationAgreementImpl other = (NotificationAgreementImpl) obj;
