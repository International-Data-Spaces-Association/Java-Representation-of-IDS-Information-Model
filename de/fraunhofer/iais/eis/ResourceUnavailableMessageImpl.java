...
/** 
* "Resource Unavailable Message"@en
...
public class ResourceUnavailableMessageImpl implements Serializable, ResourceUnavailableMessage {
	...
	@JsonIgnore
	protected List<TypedLiteral> comment = Arrays.asList(new TypedLiteral("Message indicating that a specific resource is unavailable. The same resource may be available again in the future.", "en"));
