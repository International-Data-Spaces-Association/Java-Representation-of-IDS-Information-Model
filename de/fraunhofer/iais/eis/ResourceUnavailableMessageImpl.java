...
public class ResourceUnavailableMessageImpl implements Serializable, ResourceUnavailableMessage {
	...
	@JsonIgnore
	java.util.List<TypedLiteral> label = Arrays.asList(new TypedLiteral("Resource Unavailable Message", "en"));
	//List of all comments of this class
	@JsonIgnore
	java.util.List<TypedLiteral> comment = Arrays.asList(new TypedLiteral("Message indicating that a specific resource is unavailable. The same resource may be available again in the future.", "en"));
	...
	*/
	...
	ResourceUnavailableMessageImpl() {
