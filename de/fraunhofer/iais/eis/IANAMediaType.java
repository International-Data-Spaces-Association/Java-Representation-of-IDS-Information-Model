...
public enum IANAMediaType implements ModelClass {
    ...
    private static final Map<String, IANAMediaType> uriInstanceMapping;
    static {
    ...
    IANAMediaType(String id, List<TypedLiteral> label, List<TypedLiteral> comment) {
        try {
            this.id = new URI(id);
            this.label = label;
    ...
    @JsonCreator
    public static IANAMediaType deserialize(JsonNode node) {
