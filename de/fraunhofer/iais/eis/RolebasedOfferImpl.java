...
public class RolebasedOfferImpl implements Serializable, RolebasedOffer {
	...
	@JsonIgnore
	java.util.List<TypedLiteral> label = Arrays.asList(new TypedLiteral("Role-restricted Data Usage Offer", "en"));
	//List of all comments of this class
	@JsonIgnore
	java.util.List<TypedLiteral> comment = Arrays.asList(new TypedLiteral("The ContractOffer class representing the 'Role-restricted Data Usage' policy class.", "en"));
