...
/** 
* "Role-restricted Data Usage Offer"@en
* "The ContractOffer class representing the \'Role-restricted Data Usage\' policy class."@en 
*/
@JsonIgnoreProperties(ignoreUnknown = true)
@JsonTypeName("ids:RolebasedOffer")
public class RolebasedOfferImpl implements Serializable, RolebasedOffer {
	...
	@JsonIgnore
	protected List<TypedLiteral> label = Arrays.asList(new TypedLiteral("Role-restricted Data Usage Offer", "en"));

	//List of all comments of this class
	@JsonIgnore
	protected List<TypedLiteral> comment = Arrays.asList(new TypedLiteral("The ContractOffer class representing the 'Role-restricted Data Usage' policy class.", "en"));
	...
	*/
	...
	protected RolebasedOfferImpl() {
		id = VocabUtil.getInstance().createRandomUrl("rolebasedOffer");
	}
	...
	public boolean equals(Object obj) {
		if (this == obj) {
			...
			RolebasedOfferImpl other = (RolebasedOfferImpl) obj;
