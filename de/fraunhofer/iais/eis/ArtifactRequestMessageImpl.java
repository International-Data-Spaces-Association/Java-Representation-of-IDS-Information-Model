...
/** 
* "Artifact Request Message"@en
* "Message asking for retrieving the specified Artifact as the payload of an ArtifactResponse message."@en 
*/
@JsonIgnoreProperties(ignoreUnknown = true)
@JsonTypeName("ids:ArtifactRequestMessage")
public class ArtifactRequestMessageImpl implements Serializable, ArtifactRequestMessage {
	...
	@JsonIgnore
	protected List<TypedLiteral> label = Arrays.asList(new TypedLiteral("Artifact Request Message", "en"));

	//List of all comments of this class
	@JsonIgnore
	protected List<TypedLiteral> comment = Arrays.asList(new TypedLiteral("Message asking for retrieving the specified Artifact as the payload of an ArtifactResponse message.", "en"));
	...
	*/
	...
	/**
	* "Requested Artifact"@en
	* "References an artifact in the context of a request."@en
	*/
	@NotNull
	...
	*/
	...
	protected ArtifactRequestMessageImpl() {
		id = VocabUtil.getInstance().createRandomUrl("artifactRequestMessage");
	}
	...
	public int hashCode() {
		return Objects.hash(new Object[]{this._requestedArtifact,
			this._modelVersion,
			this._issued,
	...
	public boolean equals(Object obj) {
		if (this == obj) {
			...
			ArtifactRequestMessageImpl other = (ArtifactRequestMessageImpl) obj;
			return Objects.equals(this._requestedArtifact, other._requestedArtifact) &&
	...
	final public URI getRequestedArtifact() {
		return _requestedArtifact;
	}
	
	final public void setRequestedArtifact (URI _requestedArtifact_) {
		this._requestedArtifact = _requestedArtifact_;
	}
