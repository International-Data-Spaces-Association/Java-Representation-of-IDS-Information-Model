...
public class ArtifactRequestMessageImpl implements Serializable, ArtifactRequestMessage {
	...
	@JsonIgnore
	java.util.List<TypedLiteral> label = Arrays.asList(new TypedLiteral("Artifact Request Message", "en"));
	//List of all comments of this class
	@JsonIgnore
	java.util.List<TypedLiteral> comment = Arrays.asList(new TypedLiteral("Message asking for retrieving the specified Artifact as the payload of an ArtifactResponse message.", "en"));
	...
	*/
	@NotNull@JsonAlias({"ids:requestedArtifact", "requestedArtifact"})
	 URI _requestedArtifact;
