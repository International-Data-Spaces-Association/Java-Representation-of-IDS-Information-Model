...
/** 
* "Operation Result Message"@en
* "Message indicating that the result of a former InvokeOperation message is available. May transfer the result data in its associated payload section."@en 
*/
@JsonIgnoreProperties(ignoreUnknown = true)
@JsonTypeName("ids:OperationResultMessage")
public class OperationResultMessageImpl implements Serializable, OperationResultMessage {
	...
	@JsonIgnore
	protected List<TypedLiteral> label = Arrays.asList(new TypedLiteral("Operation Result Message", "en"));

	//List of all comments of this class
	@JsonIgnore
	protected List<TypedLiteral> comment = Arrays.asList(new TypedLiteral("Message indicating that the result of a former InvokeOperation message is available. May transfer the result data in its associated payload section.", "en"));
	...
	*/
	...
	protected OperationResultMessageImpl() {
		id = VocabUtil.getInstance().createRandomUrl("operationResultMessage");
	}
	...
	public boolean equals(Object obj) {
		if (this == obj) {
			...
			OperationResultMessageImpl other = (OperationResultMessageImpl) obj;
