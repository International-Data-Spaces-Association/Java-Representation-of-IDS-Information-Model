...
/** 
* "Event-restricted Data Usage Request"@en
* "The ContractRequest class representing the \'Event-restricted Usage Policy\' policy class."@en 
*/
@JsonIgnoreProperties(ignoreUnknown = true)
@JsonTypeName("ids:EventRequest")
public class EventRequestImpl implements Serializable, EventRequest {
	...
	@JsonIgnore
	protected List<TypedLiteral> label = Arrays.asList(new TypedLiteral("Event-restricted Data Usage Request", "en"));

	//List of all comments of this class
	@JsonIgnore
	protected List<TypedLiteral> comment = Arrays.asList(new TypedLiteral("The ContractRequest class representing the 'Event-restricted Usage Policy' policy class.", "en"));
	...
	*/
	...
	protected EventRequestImpl() {
		id = VocabUtil.getInstance().createRandomUrl("eventRequest");
	}
	...
	public boolean equals(Object obj) {
		if (this == obj) {
			...
			EventRequestImpl other = (EventRequestImpl) obj;
