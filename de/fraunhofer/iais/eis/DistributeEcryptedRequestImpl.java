...
public class DistributeEcryptedRequestImpl implements Serializable, DistributeEcryptedRequest {
	...
	@JsonIgnore
	java.util.List<TypedLiteral> label = Arrays.asList(new TypedLiteral("Distribute Encrypted Request", "en"));
	//List of all comments of this class
	@JsonIgnore
	java.util.List<TypedLiteral> comment = Arrays.asList(new TypedLiteral("The ContractRequest class representing the 'Distribute only if Encrypted' policy class.", "en"));
