...
/** 
* "Distribute Encrypted Request"@en
* "The ContractRequest class representing the \'Distribute only if Encrypted\' policy class."@en 
*/
@JsonIgnoreProperties(ignoreUnknown = true)
@JsonTypeName("ids:DistributeEcryptedRequest")
public class DistributeEcryptedRequestImpl implements Serializable, DistributeEcryptedRequest {
	...
	@JsonIgnore
	protected List<TypedLiteral> label = Arrays.asList(new TypedLiteral("Distribute Encrypted Request", "en"));

	//List of all comments of this class
	@JsonIgnore
	protected List<TypedLiteral> comment = Arrays.asList(new TypedLiteral("The ContractRequest class representing the 'Distribute only if Encrypted' policy class.", "en"));
	...
	*/
	...
	protected DistributeEcryptedRequestImpl() {
		id = VocabUtil.getInstance().createRandomUrl("distributeEcryptedRequest");
	}
	...
	public boolean equals(Object obj) {
		if (this == obj) {
			...
			DistributeEcryptedRequestImpl other = (DistributeEcryptedRequestImpl) obj;
