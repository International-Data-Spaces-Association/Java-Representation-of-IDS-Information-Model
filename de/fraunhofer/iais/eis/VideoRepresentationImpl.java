...
public class VideoRepresentationImpl implements Serializable, VideoRepresentation {
	...
	*/
	...
	/**
	* "Video frame rate, as frames/second."@en
	* @return Returns the java.math.BigDecimal for the property frameRate.
	* More information under https://w3id.org/idsa/core/frameRate
	*/
	@JsonProperty("ids:frameRate")
	final public java.math.BigDecimal getFrameRate() {
		return _frameRate;
	}
	...
	/**
	* "Video frame rate, as frames/second."@en
	* @param _frameRate_ desired value for the property frameRate.
	* More information under https://w3id.org/idsa/core/frameRate
	*/
