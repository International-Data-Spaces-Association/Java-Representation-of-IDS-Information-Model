...
public class TrustedConnectorImpl implements TrustedConnector {
	...
	@JsonIgnore
	protected List<TypedLiteral> comment = Arrays.asList(new TypedLiteral("Hardened implementation of the Connector specification providing enhanced security capabilities.", "en"));
