...
/**
 * Default implementation of package de.fraunhofer.iais.eis.TrustedConnector
 * 
...
public class TrustedConnectorImpl implements TrustedConnector {
    ...
    @JsonIgnore
    protected List<TypedLiteral> label = Arrays.asList(new TypedLiteral("Trusted Connector", "en"));

    // List of all comments of this class
    @JsonIgnore
    protected List<TypedLiteral> comment = Arrays
        .asList(new TypedLiteral("Hardened implementation of the Connector specification providing enhanced security capabilities.", "en"));
    ...
    protected TrustedConnectorImpl() {
    ...
    public boolean equals(Object obj) {
        if (this == obj) {
            ...
            TrustedConnectorImpl other = (TrustedConnectorImpl) obj;
    ...
    @Override
    /**
     * Helper function for (de-)serialization of the _trustedConnector and the
     * _trustedConnectorAsParticipantfields.
     *
