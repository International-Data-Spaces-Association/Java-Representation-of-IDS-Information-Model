...
public class EndpointBuilder implements Builder<Endpoint> {
     ...
     */
    public EndpointBuilder _apiSpecifiation_(List<IdsProtocolSpecification> _apiSpecifiation_) {
        this.endpointImpl.setApiSpecifiation(_apiSpecifiation_);
        return this;
    }
     ...
     * @return Builder object with new value for _apiSpecifiation
     */
    public EndpointBuilder _apiSpecifiation_(IdsProtocolSpecification _apiSpecifiation_) {
        this.endpointImpl.getApiSpecifiation().add(_apiSpecifiation_);
        return this;
    }
