...
public class BrokerImpl implements Serializable, Broker {
	...
	*/
	...
	protected List<ConnectorCatalog> _connectorCatalog;
	...
	*/
	...
	public int hashCode() {
		return Objects.hash(new Object[]{this._connectorCatalog,
			this._hasEndpoint,
			this._hasAgent,
	...
	final public List<ConnectorCatalog> getConnectorCatalog() {
		return _connectorCatalog;
	}
	
	final public void setConnectorCatalog (List<ConnectorCatalog> _connectorCatalog_) {
