...
public class BrokerImpl implements Serializable, Broker {
	...
	@JsonIgnore
	java.util.List<TypedLiteral> label = Arrays.asList(new TypedLiteral("Broker", "en"));
	//List of all comments of this class
	@JsonIgnore
	java.util.List<TypedLiteral> comment = Arrays.asList(new TypedLiteral("Broker holding an index of published data endpoints.", "en"));
	...
	*/
	@JsonAlias({"ids:connectorCatalog", "connectorCatalog"})
	 java.util.ArrayList<? extends ConnectorCatalog> _connectorCatalog;
	...
	*/
	...
	final public void setConnectorCatalog (java.util.ArrayList<? extends ConnectorCatalog> _connectorCatalog_) {
