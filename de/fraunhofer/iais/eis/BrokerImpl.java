...
public class BrokerImpl implements Serializable, Broker {
	...
	*/
	...
	protected ArrayList<? extends ConnectorCatalog> _connectorCatalog;
	...
	*/
	...
	final public ArrayList<? extends ConnectorCatalog> getConnectorCatalog() {
	...
	/**
	* "Reference to catalog of Connectors, which are listed in the Broker."@en
	* @param _connectorCatalog_ desired value for the property connectorCatalog.
	* More information under https://w3id.org/idsa/core/connectorCatalog
	*/
	final public void setConnectorCatalog (ArrayList<? extends ConnectorCatalog> _connectorCatalog_) {
