...
/** 
* "Security Offer"@en
* "The ContractOffer class representing the \'Security Level Restricted Policy\' policy class."@en 
*/
@JsonIgnoreProperties(ignoreUnknown = true)
@JsonTypeName("ids:SecurityOffer")
public class SecurityOfferImpl implements Serializable, SecurityOffer {
	...
	@JsonIgnore
	protected List<TypedLiteral> label = Arrays.asList(new TypedLiteral("Security Offer", "en"));

	//List of all comments of this class
	@JsonIgnore
	protected List<TypedLiteral> comment = Arrays.asList(new TypedLiteral("The ContractOffer class representing the 'Security Level Restricted Policy' policy class.", "en"));
	...
	*/
	...
	protected SecurityOfferImpl() {
		id = VocabUtil.getInstance().createRandomUrl("securityOffer");
	}
	...
	public boolean equals(Object obj) {
		if (this == obj) {
			...
			SecurityOfferImpl other = (SecurityOfferImpl) obj;
