...
public class AuthInfoImpl implements Serializable, AuthInfo {
	...
	@JsonIgnore
	java.util.List<TypedLiteral> label = Arrays.asList(new TypedLiteral("AuthInfo", "en"));
	//List of all comments of this class
	@JsonIgnore
	java.util.List<TypedLiteral> comment = Arrays.asList(new TypedLiteral("Holds authentication information so that connections to the Connector's data offerings can be establised.", "en"));
	...
	*/
	@NotNull@JsonAlias({"ids:authService", "authService"})
	 URI _authService;
