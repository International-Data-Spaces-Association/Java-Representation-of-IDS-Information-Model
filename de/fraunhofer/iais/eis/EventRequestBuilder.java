...
public class EventRequestBuilder {
	...
	*/
	final public EventRequestBuilder _permission_(List<Permission> _permission_) {
	...
	*/
	final public EventRequestBuilder _prohibition_(List<Prohibition> _prohibition_) {
	...
	*/
	final public EventRequestBuilder _obligation_(List<Duty> _obligation_) {
