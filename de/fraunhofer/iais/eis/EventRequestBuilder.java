...
public class EventRequestBuilder implements Builder<EventRequest> {
     ...
     */
    public EventRequestBuilder _contractStart_(XMLGregorianCalendar _contractStart_) {
        this.eventRequestImpl.setContractStart(_contractStart_);
        return this;
    }
     ...
     */
    public EventRequestBuilder _contractEnd_(XMLGregorianCalendar _contractEnd_) {
        this.eventRequestImpl.setContractEnd(_contractEnd_);
        return this;
    }
     ...
     */
    public EventRequestBuilder _contractDate_(XMLGregorianCalendar _contractDate_) {
        this.eventRequestImpl.setContractDate(_contractDate_);
        return this;
    }
     ...
     */
    public EventRequestBuilder _provider_(URI _provider_) {
        this.eventRequestImpl.setProvider(_provider_);
        return this;
    }
     ...
     */
    public EventRequestBuilder _consumer_(URI _consumer_) {
        this.eventRequestImpl.setConsumer(_consumer_);
        return this;
    }
     ...
     */
    public EventRequestBuilder _contractDocument_(TextResource _contractDocument_) {
        this.eventRequestImpl.setContractDocument(_contractDocument_);
        return this;
    }
     ...
     */
    public EventRequestBuilder _contractAnnex_(Resource _contractAnnex_) {
        this.eventRequestImpl.setContractAnnex(_contractAnnex_);
        return this;
    }
     ...
     */
    public EventRequestBuilder _permission_(List<Permission> _permission_) {
        this.eventRequestImpl.setPermission(_permission_);
        return this;
    }
     ...
     * @return Builder object with new value for _permission
     */
    public EventRequestBuilder _permission_(Permission _permission_) {
        this.eventRequestImpl.getPermission().add(_permission_);
        return this;
    }
     ...
     */
    public EventRequestBuilder _prohibition_(List<Prohibition> _prohibition_) {
        this.eventRequestImpl.setProhibition(_prohibition_);
        return this;
    }
     ...
     * @return Builder object with new value for _prohibition
     */
    public EventRequestBuilder _prohibition_(Prohibition _prohibition_) {
        this.eventRequestImpl.getProhibition().add(_prohibition_);
        return this;
    }
     ...
     */
    public EventRequestBuilder _obligation_(List<Duty> _obligation_) {
        this.eventRequestImpl.setObligation(_obligation_);
        return this;
    }
     ...
     * @return Builder object with new value for _obligation
     */
    public EventRequestBuilder _obligation_(Duty _obligation_) {
        this.eventRequestImpl.getObligation().add(_obligation_);
        return this;
    }
     ...
     */
    @Override
    public EventRequest build() throws ConstraintViolationException {
