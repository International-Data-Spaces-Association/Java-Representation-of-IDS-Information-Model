...
/** 
	"Participant Certificate Granted Message"@en

	"Whenever a Participant has been successfully certified by the Certification Body, the Identity Provider can use this message to notify Infrastructure Components."@en */
@JsonIgnoreProperties(ignoreUnknown = true)
@JsonTypeName("ids:ParticipantCertificateGrantedMessage")
public class ParticipantCertificateGrantedMessageImpl implements Serializable, ParticipantCertificateGrantedMessage {
	...
	@JsonIgnore
	java.util.List<TypedLiteral> label = Arrays.asList(new TypedLiteral("Participant Certificate Granted Message", "en"));
	//List of all comments of this class
	@JsonIgnore
	java.util.List<TypedLiteral> comment = Arrays.asList(new TypedLiteral("Whenever a Participant has been successfully certified by the Certification Body, the Identity Provider can use this message to notify Infrastructure Components.", "en"));
	...
	*/
	...
	ParticipantCertificateGrantedMessageImpl() {
