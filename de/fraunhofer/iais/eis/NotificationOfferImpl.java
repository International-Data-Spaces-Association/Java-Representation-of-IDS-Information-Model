...
/** 
	...
	"The ContractOffer class representing the \'Remote Notifications\' policy class."@en */
@JsonIgnoreProperties(ignoreUnknown = true)
@JsonTypeName("ids:NotificationOffer")
public class NotificationOfferImpl implements Serializable, NotificationOffer {
	...
	@JsonIgnore
	java.util.List<TypedLiteral> comment = Arrays.asList(new TypedLiteral("The ContractOffer class representing the 'Remote Notifications' policy class.", "en"));
	...
	*/
	...
	NotificationOfferImpl() {
		id = VocabUtil.getInstance().createRandomUrl("notificationOffer");
	}
