...
public class DeleteAfterIntervalOfferImpl implements Serializable, DeleteAfterIntervalOffer {
	...
	@JsonIgnore
	protected List<TypedLiteral> comment = Arrays.asList(new TypedLiteral("The ContractOffer class representing the 'Interval-restricted Data Usage' policy class with the further obligation to delete the data.", "en"));
	...
	*/
	...
	protected DeleteAfterIntervalOfferImpl() {
	...
	public boolean equals(Object obj) {
		if (this == obj) {
			...
			DeleteAfterIntervalOfferImpl other = (DeleteAfterIntervalOfferImpl) obj;
