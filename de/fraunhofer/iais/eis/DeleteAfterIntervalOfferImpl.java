...
/** 
	...
	"The ContractOffer class representing the \'Interval-restricted Data Usage\' policy class with the further obligation to delete the data."@en */
@JsonIgnoreProperties(ignoreUnknown = true)
@JsonTypeName("ids:DeleteAfterIntervalOffer")
public class DeleteAfterIntervalOfferImpl implements Serializable, DeleteAfterIntervalOffer {
	...
	@JsonIgnore
	java.util.List<TypedLiteral> label = Arrays.asList(new TypedLiteral("Sales Offer", "en"));
	//List of all comments of this class
	@JsonIgnore
	java.util.List<TypedLiteral> comment = Arrays.asList(new TypedLiteral("The ContractOffer class representing the 'Interval-restricted Data Usage' policy class with the further obligation to delete the data.", "en"));
	...
	*/
	...
	DeleteAfterIntervalOfferImpl() {
		id = VocabUtil.getInstance().createRandomUrl("deleteAfterIntervalOffer");
	}
