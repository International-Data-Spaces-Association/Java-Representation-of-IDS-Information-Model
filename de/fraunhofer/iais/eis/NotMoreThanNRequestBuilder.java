...
public class NotMoreThanNRequestBuilder {
	...
	*/
	final public NotMoreThanNRequestBuilder _permission_(List<Permission> _permission_) {
	...
	*/
	final public NotMoreThanNRequestBuilder _prohibition_(List<Prohibition> _prohibition_) {
	...
	*/
	final public NotMoreThanNRequestBuilder _obligation_(List<Duty> _obligation_) {
