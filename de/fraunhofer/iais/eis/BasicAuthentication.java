...
public interface BasicAuthentication extends UserAuthentication {
	...
	*/
	...
	/**
	* This function returns a hash code value for the BasicAuthentication for the benefit of e.g. hash tables.
	* @return a hash code value for the BasicAuthentication
	*/
	public int hashCode();
	...
	* @return true if this BasicAuthentication is the same as the obj argument; false otherwise.
	*/
