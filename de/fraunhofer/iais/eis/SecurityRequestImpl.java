...
/** 
	...
	"The ContractRequest class representing the \'Security Level Restricted Policy\' policy class."@en */
@JsonIgnoreProperties(ignoreUnknown = true)
@JsonTypeName("ids:SecurityRequest")
public class SecurityRequestImpl implements Serializable, SecurityRequest {
	...
	@JsonIgnore
	java.util.List<TypedLiteral> label = Arrays.asList(new TypedLiteral("Security Request", "en"));
	//List of all comments of this class
	@JsonIgnore
	java.util.List<TypedLiteral> comment = Arrays.asList(new TypedLiteral("The ContractRequest class representing the 'Security Level Restricted Policy' policy class.", "en"));
