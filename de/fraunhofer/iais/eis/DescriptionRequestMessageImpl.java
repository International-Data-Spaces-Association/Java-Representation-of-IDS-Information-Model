...
public class DescriptionRequestMessageImpl implements Serializable, DescriptionRequestMessage {
	...
	*/
	...
	public int hashCode() {
		return Objects.hash(new Object[]{this._requestedElement,
			this._modelVersion,
			this._issued,
	...
	final public URI getRequestedElement() {
		return _requestedElement;
	}
	
	final public void setRequestedElement (URI _requestedElement_) {
