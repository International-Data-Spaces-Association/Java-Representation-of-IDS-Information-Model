...
public interface HTTPAuthentication extends BasicAuthentication {
	...
	*/
	...
	/**
	* This function returns a hash code value for the HTTPAuthentication for the benefit of e.g. hash tables.
	* @return a hash code value for the HTTPAuthentication
	*/
	public int hashCode();
	...
	* @return true if this HTTPAuthentication is the same as the obj argument; false otherwise.
	*/
