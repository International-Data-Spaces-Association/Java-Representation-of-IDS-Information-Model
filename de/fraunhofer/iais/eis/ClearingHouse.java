...
public interface ClearingHouse extends InfrastructureComponent {
	...
	*/
	...
	/**
	* This function returns a hash code value for the ClearingHouse for the benefit of e.g. hash tables.
	* @return a hash code value for the ClearingHouse
	*/
	public int hashCode();
	...
	* @return true if this ClearingHouse is the same as the obj argument; false otherwise.
	*/
