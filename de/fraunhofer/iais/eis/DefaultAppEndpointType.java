...
public enum DefaultAppEndpointType implements AppEndpointType {

    /**
     * Endpoint is used for runtime-related app configurations and app parameters.
     */
    CONFIG_ENDPOINT("https://w3id.org/idsa/code/CONFIG_ENDPOINT"),

    /**
     * Endpoint is used for data input.
     */
    INPUT_ENDPOINT("https://w3id.org/idsa/code/INPUT_ENDPOINT"),

    /**
     * Endpoint is used for data output.
     */
    OUTPUT_ENDPOINT("https://w3id.org/idsa/code/OUTPUT_ENDPOINT"),

    /**
     * Endpoint is used to start (or control) app processing.
     */
    PROCESS_ENDPOINT("https://w3id.org/idsa/code/PROCESS_ENDPOINT"),
     ...
     */
    STATUS_ENDPOINT("https://w3id.org/idsa/code/STATUS_ENDPOINT"),
    ...
    private static final Map<String, DefaultAppEndpointType> uriInstanceMapping;
    static {
    ...
    DefaultAppEndpointType(String id) {
        this.appEndpointType = new AppEndpointTypeBuilder(URI.create(id)).build();
    }
    ...
    final public URI getId() {
        return this.appEndpointType.getId();
    }
    ...
    final public List<TypedLiteral> getLabel() {
        return this.appEndpointType.getLabel();
    }
    ...
    final public List<TypedLiteral> getComment() {
        return this.appEndpointType.getComment();
    }
    ...
    @JsonCreator
    public static DefaultAppEndpointType deserialize(JsonNode node) {
        return uriInstanceMapping.get(node.has("@id") ? node.get("@id").textValue() : node.textValue());
    }

    @Override
    public String toString() {
        return this.appEndpointType.getId().toString();
    }
