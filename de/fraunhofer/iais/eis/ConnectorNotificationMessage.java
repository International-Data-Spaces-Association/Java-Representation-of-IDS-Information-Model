...
public interface ConnectorNotificationMessage extends NotificationMessage {
	...
	*/
	...
	/**
	* This function returns a hash code value for the ConnectorNotificationMessage for the benefit of e.g. hash tables.
	* @return a hash code value for the ConnectorNotificationMessage
	*/
	public int hashCode();
	...
	* @return true if this ConnectorNotificationMessage is the same as the obj argument; false otherwise.
	*/
