...
public class TemporalEntityImpl implements Serializable, TemporalEntity {
	...
	@JsonIgnore
	java.util.List<TypedLiteral> label = Arrays.asList(new TypedLiteral("TemporalEntity", "en"));
	//List of all comments of this class
	@JsonIgnore
	java.util.List<TypedLiteral> comment = Arrays.asList(new TypedLiteral("A temporal interval, instant or a relative duration.", "en"));
