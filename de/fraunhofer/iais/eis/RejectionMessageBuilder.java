...
public class RejectionMessageBuilder {
	...
	*/
	final public RejectionMessageBuilder _recipientConnector_(ArrayList<? extends URI> _recipientConnector_) {
	...
	*/
	final public RejectionMessageBuilder _recipientAgent_(ArrayList<? extends URI> _recipientAgent_) {
