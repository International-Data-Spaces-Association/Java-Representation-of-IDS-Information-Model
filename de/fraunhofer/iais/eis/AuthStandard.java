...
public enum AuthStandard implements ModelClass {
     ...
     * OAUTH2 via JWT
     */
    OAUTH2_JWT("https://w3id.org/idsa/code/OAUTH2_JWT", Collections.emptyList(), Arrays.asList(new TypedLiteral("OAUTH2 via JWT", "")));
    ...
    AuthStandard(String id, List<TypedLiteral> label, List<TypedLiteral> comment) {
        try {
            this.id = new URI(id);
            this.label = label;
