...
public interface ConnectorEndpoint extends Endpoint {
	...
	*/
	...
	/**
	* This function returns a hash code value for the ConnectorEndpoint for the benefit of e.g. hash tables.
	* @return a hash code value for the ConnectorEndpoint
	*/
	public int hashCode();
	...
	* @return true if this ConnectorEndpoint is the same as the obj argument; false otherwise.
	*/
