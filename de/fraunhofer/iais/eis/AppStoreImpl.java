...
/**
 * Default implementation of package de.fraunhofer.iais.eis.AppStore
 * 
...
public class AppStoreImpl implements AppStore {
    ...
    public boolean equals(Object obj) {
        if (this == obj) {
            ...
            AppStoreImpl other = (AppStoreImpl) obj;
    ...
    public AppStore deepCopy() {
        AppStoreBuilder builder = new AppStoreBuilder();
    ...
    /**
     * Helper function for (de-)serialization of the _appStore and the _appStoreAsfields.
     *
