...
/** 
	...
	"The ContractOffer class representing the \'Local Logging\' policy class."@en */
@JsonIgnoreProperties(ignoreUnknown = true)
@JsonTypeName("ids:LoggingOffer")
public class LoggingOfferImpl implements Serializable, LoggingOffer {
	...
	@JsonIgnore
	java.util.List<TypedLiteral> comment = Arrays.asList(new TypedLiteral("The ContractOffer class representing the 'Local Logging' policy class.", "en"));
	...
	*/
	...
	LoggingOfferImpl() {
		id = VocabUtil.getInstance().createRandomUrl("loggingOffer");
	}
