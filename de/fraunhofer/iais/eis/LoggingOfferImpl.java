...
/**
 * Default implementation of package de.fraunhofer.iais.eis.LoggingOffer
 * 
 * The ContractOffer class representing the 'Local Logging' policy class.
 */
@JsonIgnoreProperties(ignoreUnknown = true)
@JsonTypeName("ids:LoggingOffer")
public class LoggingOfferImpl implements LoggingOffer {
    ...
    protected List<TypedLiteral> comment =
        Arrays.asList(new TypedLiteral("The ContractOffer class representing the 'Local Logging' policy class.", "en"));
    ...
    public boolean equals(Object obj) {
        if (this == obj) {
            ...
            LoggingOfferImpl other = (LoggingOfferImpl) obj;
    ...
    public LoggingOffer deepCopy() {
        LoggingOfferBuilder builder = new LoggingOfferBuilder();
