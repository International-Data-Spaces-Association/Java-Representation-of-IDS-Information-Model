...
public class AppDeleteMessageBuilder {
	...
	*/
	final public AppDeleteMessageBuilder _recipientConnector_(ArrayList<? extends URI> _recipientConnector_) {
	...
	*/
	final public AppDeleteMessageBuilder _recipientAgent_(ArrayList<? extends URI> _recipientAgent_) {
