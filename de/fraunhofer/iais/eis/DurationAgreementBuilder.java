...
public class DurationAgreementBuilder {
	...
	*/
	final public DurationAgreementBuilder _permission_(ArrayList<? extends Permission> _permission_) {
	...
	*/
	final public DurationAgreementBuilder _prohibition_(ArrayList<? extends Prohibition> _prohibition_) {
	...
	*/
	final public DurationAgreementBuilder _obligation_(ArrayList<? extends Duty> _obligation_) {
