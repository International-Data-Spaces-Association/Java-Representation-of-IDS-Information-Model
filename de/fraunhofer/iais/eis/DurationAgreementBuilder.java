...
public class DurationAgreementBuilder {
	...
	*/
	final public DurationAgreementBuilder _permission_(List<Permission> _permission_) {
	...
	*/
	final public DurationAgreementBuilder _prohibition_(List<Prohibition> _prohibition_) {
	...
	*/
	final public DurationAgreementBuilder _obligation_(List<Duty> _obligation_) {
