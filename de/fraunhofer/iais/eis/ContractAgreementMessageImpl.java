...
/** 
* "Contract Agreement Message"@en
* "Message containing a contract, as an instance of ids:ContractAgreement, with resource access modalities on which two parties have agreed in the payload."@en 
*/
@JsonIgnoreProperties(ignoreUnknown = true)
@JsonTypeName("ids:ContractAgreementMessage")
public class ContractAgreementMessageImpl implements Serializable, ContractAgreementMessage {
	...
	@JsonIgnore
	protected List<TypedLiteral> label = Arrays.asList(new TypedLiteral("Contract Agreement Message", "en"));

	//List of all comments of this class
	@JsonIgnore
	protected List<TypedLiteral> comment = Arrays.asList(new TypedLiteral("Message containing a contract, as an instance of ids:ContractAgreement, with resource access modalities on which two parties have agreed in the payload.", "en"));
	...
	*/
	...
	protected ContractAgreementMessageImpl() {
		id = VocabUtil.getInstance().createRandomUrl("contractAgreementMessage");
	}
