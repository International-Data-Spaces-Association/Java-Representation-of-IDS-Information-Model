...
public class RentalAgreementBuilder {
	...
	*/
	final public RentalAgreementBuilder _permission_(List<Permission> _permission_) {
	...
	*/
	final public RentalAgreementBuilder _prohibition_(List<Prohibition> _prohibition_) {
	...
	*/
	final public RentalAgreementBuilder _obligation_(List<Duty> _obligation_) {
