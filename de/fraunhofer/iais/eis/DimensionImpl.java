...
/**
 * Default implementation of package de.fraunhofer.iais.eis.Dimension
 * 
...
@JsonTypeName("http://www.w3.org/ns/dqv#Dimension")
public class DimensionImpl implements Dimension {
    ...
    @JsonIgnore
    protected List<TypedLiteral> label = Arrays.asList(new TypedLiteral("Dimension", "en"));
    ...
    protected DimensionImpl() {
        id = VocabUtil.getInstance().createRandomUrl("dimension");
    }
