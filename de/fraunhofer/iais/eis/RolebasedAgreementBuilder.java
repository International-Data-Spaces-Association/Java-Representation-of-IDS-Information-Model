...
public class RolebasedAgreementBuilder {
	...
	*/
	final public RolebasedAgreementBuilder _permission_(ArrayList<? extends Permission> _permission_) {
	...
	*/
	final public RolebasedAgreementBuilder _prohibition_(ArrayList<? extends Prohibition> _prohibition_) {
	...
	*/
	final public RolebasedAgreementBuilder _obligation_(ArrayList<? extends Duty> _obligation_) {
