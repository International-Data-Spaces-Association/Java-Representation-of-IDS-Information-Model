...
public interface ResourceCatalog extends Catalog {
	...
	*/
	...
	/**
	* This function returns a hash code value for the ResourceCatalog for the benefit of e.g. hash tables.
	* @return a hash code value for the ResourceCatalog
	*/
	public int hashCode();
	...
	* @return true if this ResourceCatalog is the same as the obj argument; false otherwise.
	*/
