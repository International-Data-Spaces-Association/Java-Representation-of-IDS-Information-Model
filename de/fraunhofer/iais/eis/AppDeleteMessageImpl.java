...
/** 
* "App Delete Message"@en
* "Message indicating that an App should be deleted from the AppStore."@en 
*/
@JsonIgnoreProperties(ignoreUnknown = true)
@JsonTypeName("ids:AppDeleteMessage")
public class AppDeleteMessageImpl implements Serializable, AppDeleteMessage {
	...
	@JsonIgnore
	protected List<TypedLiteral> comment = Arrays.asList(new TypedLiteral("Message indicating that an App should be deleted from the AppStore.", "en"));
