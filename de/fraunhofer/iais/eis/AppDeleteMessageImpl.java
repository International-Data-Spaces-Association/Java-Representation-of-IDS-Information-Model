...
public class AppDeleteMessageImpl implements Serializable, AppDeleteMessage {
	...
	@JsonIgnore
	java.util.List<TypedLiteral> label = Arrays.asList(new TypedLiteral("App Delete Message", "en"));
	//List of all comments of this class
	@JsonIgnore
	java.util.List<TypedLiteral> comment = Arrays.asList(new TypedLiteral("Message indicating that an App should be deleted from the AppStore.", "en"));
