...
public interface Instant extends TemporalEntity {
	...
	*/
	...
	/**
	* This function returns a hash code value for the Instant for the benefit of e.g. hash tables.
	* @return a hash code value for the Instant
	*/
	public int hashCode();
	...
	* @return true if this Instant is the same as the obj argument; false otherwise.
	*/
