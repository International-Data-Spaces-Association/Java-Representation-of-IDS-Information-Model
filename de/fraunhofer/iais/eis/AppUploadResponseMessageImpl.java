...
/** 
* "App Upload Response Message"@en
* "Message that follows up an AppUploadMessage and contains the app upload confimation."@en 
*/
@JsonIgnoreProperties(ignoreUnknown = true)
@JsonTypeName("ids:AppUploadResponseMessage")
public class AppUploadResponseMessageImpl implements Serializable, AppUploadResponseMessage {
	...
	@JsonIgnore
	protected List<TypedLiteral> label = Arrays.asList(new TypedLiteral("App Upload Response Message", "en"));

	//List of all comments of this class
	@JsonIgnore
	protected List<TypedLiteral> comment = Arrays.asList(new TypedLiteral("Message that follows up an AppUploadMessage and contains the app upload confimation.", "en"));
	...
	*/
	...
	protected AppUploadResponseMessageImpl() {
		id = VocabUtil.getInstance().createRandomUrl("appUploadResponseMessage");
	}
	...
	public boolean equals(Object obj) {
		if (this == obj) {
			...
			AppUploadResponseMessageImpl other = (AppUploadResponseMessageImpl) obj;
