...
public class AppUploadResponseMessageImpl implements Serializable, AppUploadResponseMessage {
	...
	@JsonIgnore
	java.util.List<TypedLiteral> label = Arrays.asList(new TypedLiteral("App Upload Response Message", "en"));
	//List of all comments of this class
	@JsonIgnore
	java.util.List<TypedLiteral> comment = Arrays.asList(new TypedLiteral("Message that follows up an AppUploadMessage and contains the app upload confimation.", "en"));
