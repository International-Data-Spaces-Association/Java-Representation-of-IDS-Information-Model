...
@JsonTypeName("ids:ResponseMessage")
public class ResponseMessageImpl implements Serializable, ResponseMessage {
	...
	@JsonIgnore
	java.util.List<TypedLiteral> label = Arrays.asList(new TypedLiteral("Response Message", "en"));
	//List of all comments of this class
	@JsonIgnore
	java.util.List<TypedLiteral> comment = Arrays.asList(new TypedLiteral("Response messages hold information about the reaction of a recipient to a formerly sent command or event. They must be correlated to this message.", "en"));
	...
	*/
	...
	ResponseMessageImpl() {
		id = VocabUtil.getInstance().createRandomUrl("responseMessage");
	}
