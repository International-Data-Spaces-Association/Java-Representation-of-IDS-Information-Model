...
public enum CustomMediaType implements ModelClass {
    ...
    private static final Map<String, CustomMediaType> uriInstanceMapping;
    static {
    ...
    CustomMediaType(String id, List<TypedLiteral> label, List<TypedLiteral> comment) {
        try {
            this.id = new URI(id);
            this.label = label;
    ...
    @JsonCreator
    public static CustomMediaType deserialize(JsonNode node) {
