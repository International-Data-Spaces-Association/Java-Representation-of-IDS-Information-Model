...
public interface ComponentCertification extends Certification {
	...
	*/
	...
	/**
	* This function returns a hash code value for the ComponentCertification for the benefit of e.g. hash tables.
	* @return a hash code value for the ComponentCertification
	*/
	public int hashCode();
	...
	* @return true if this ComponentCertification is the same as the obj argument; false otherwise.
	*/
