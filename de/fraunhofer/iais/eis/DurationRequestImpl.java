...
/** 
* "Sales Request"@en
* "The ContractRequest class representing the \'Duration-restricted Data Usage\' policy class."@en 
*/
@JsonIgnoreProperties(ignoreUnknown = true)
@JsonTypeName("ids:DurationRequest")
public class DurationRequestImpl implements Serializable, DurationRequest {
	...
	@JsonIgnore
	protected List<TypedLiteral> comment = Arrays.asList(new TypedLiteral("The ContractRequest class representing the 'Duration-restricted Data Usage' policy class.", "en"));
	...
	*/
	...
	protected DurationRequestImpl() {
		id = VocabUtil.getInstance().createRandomUrl("durationRequest");
	}
	...
	public boolean equals(Object obj) {
		if (this == obj) {
			...
			DurationRequestImpl other = (DurationRequestImpl) obj;
