...
public class DurationRequestImpl implements Serializable, DurationRequest {
	...
	@JsonIgnore
	java.util.List<TypedLiteral> comment = Arrays.asList(new TypedLiteral("The ContractRequest class representing the 'Duration-restricted Data Usage' policy class.", "en"));
