...
public class ConnectorEndpointBuilder implements Builder<ConnectorEndpoint> {
     ...
     */
    public ConnectorEndpointBuilder _apiSpecifiation_(List<IdsProtocolSpecification> _apiSpecifiation_) {
        this.connectorEndpointImpl.setApiSpecifiation(_apiSpecifiation_);
        return this;
    }
     ...
     * @return Builder object with new value for _apiSpecifiation
     */
    public ConnectorEndpointBuilder _apiSpecifiation_(IdsProtocolSpecification _apiSpecifiation_) {
        this.connectorEndpointImpl.getApiSpecifiation().add(_apiSpecifiation_);
        return this;
    }
