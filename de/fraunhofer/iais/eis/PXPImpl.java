...
/**
 * Default implementation of package de.fraunhofer.iais.eis.PXP
 * 
 * The reference to the PXP that operates a specific action, URI or reference to an associated PXP
 * interface.
 */
@JsonIgnoreProperties(ignoreUnknown = true)
@JsonTypeName("ids:PXP")
public class PXPImpl implements PXP {
    ...
    @JsonIgnore
    protected List<TypedLiteral> label = Arrays.asList(new TypedLiteral("policy execution point", "en"));

    // List of all comments of this class
    @JsonIgnore
    protected List<TypedLiteral> comment = Arrays.asList(new TypedLiteral(
        "The reference to the PXP that operates a specific action, URI or reference to an associated PXP interface.", "en"));
    ...
    protected PXPImpl() {
        id = VocabUtil.getInstance().createRandomUrl("pXP");
    }
    ...
    @Override
    public PXP deepCopy() {
        PXPBuilder builder = new PXPBuilder();
