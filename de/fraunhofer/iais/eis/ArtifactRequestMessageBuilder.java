...
public class ArtifactRequestMessageBuilder {
	...
	/**
	* This function allows setting a value for requestedArtifact
	* @param _requestedArtifact_ desired value to be set
	* @return Builder object with new value for requestedArtifact
	*/
	...
	*/
	final public ArtifactRequestMessageBuilder _recipientConnector_(ArrayList<? extends URI> _recipientConnector_) {
	...
	*/
	final public ArtifactRequestMessageBuilder _recipientAgent_(ArrayList<? extends URI> _recipientAgent_) {
