...
public enum DefaultPaymentModality implements PaymentModality {

    /**
     * To express that the exchange of resource is with a fixed price
     */
    FIXED_PRICE("https://w3id.org/idsa/code/FIXED_PRICE"),

    /**
     * To express that the exchange of resource is free
     */
    FREE("https://w3id.org/idsa/code/FREE"),

    /**
     * To express that the exchange of resource is negotiation-based.
     */
    NEGOTIATION_BASIS("https://w3id.org/idsa/code/NEGOTIATION_BASIS"),;

    private static final Map<String, DefaultPaymentModality> uriInstanceMapping;
    static {
    ...
    DefaultPaymentModality(String id) {
        this.paymentModality = new PaymentModalityBuilder(URI.create(id)).build();
    }
    ...
    final public URI getId() {
        return this.paymentModality.getId();
    }
    ...
    final public List<TypedLiteral> getLabel() {
        return this.paymentModality.getLabel();
    }
    ...
    final public List<TypedLiteral> getComment() {
        return this.paymentModality.getComment();
    }
    ...
    @JsonCreator
    public static DefaultPaymentModality deserialize(JsonNode node) {
        return uriInstanceMapping.get(node.has("@id") ? node.get("@id").textValue() : node.textValue());
    }

    @Override
    public String toString() {
        return this.paymentModality.getId().toString();
    }
