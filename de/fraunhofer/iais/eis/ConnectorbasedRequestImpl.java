...
/** 
* "Connector-restricted Data Usage Request"@en
* "The ContractRequest class representing the \'Connector-restricted Data Usage\' policy class."@en 
*/
@JsonIgnoreProperties(ignoreUnknown = true)
@JsonTypeName("ids:ConnectorbasedRequest")
public class ConnectorbasedRequestImpl implements Serializable, ConnectorbasedRequest {
	...
	@JsonIgnore
	protected List<TypedLiteral> label = Arrays.asList(new TypedLiteral("Connector-restricted Data Usage Request", "en"));

	//List of all comments of this class
	@JsonIgnore
	protected List<TypedLiteral> comment = Arrays.asList(new TypedLiteral("The ContractRequest class representing the 'Connector-restricted Data Usage' policy class.", "en"));
	...
	*/
	...
	protected ConnectorbasedRequestImpl() {
		id = VocabUtil.getInstance().createRandomUrl("connectorbasedRequest");
	}
	...
	public boolean equals(Object obj) {
		if (this == obj) {
			...
			ConnectorbasedRequestImpl other = (ConnectorbasedRequestImpl) obj;
