...
/**
 * Default implementation of package de.fraunhofer.iais.eis.SalesRequest
 * 
 * The ContractRequest class representing the 'Perpetual Data Sale' policy class.
 */
@JsonIgnoreProperties(ignoreUnknown = true)
@JsonTypeName("ids:SalesRequest")
public class SalesRequestImpl implements SalesRequest {
    ...
    protected List<TypedLiteral> comment =
        Arrays.asList(new TypedLiteral("The ContractRequest class representing the 'Perpetual Data Sale' policy class.", "en"));
    ...
    public SalesRequest deepCopy() {
        SalesRequestBuilder builder = new SalesRequestBuilder();
