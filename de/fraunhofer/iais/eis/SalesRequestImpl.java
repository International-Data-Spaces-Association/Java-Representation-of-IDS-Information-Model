...
/** 
* "Sales Request"@en
* "The ContractRequest class representing the \'Perpetual Data Sale\' policy class."@en 
*/
@JsonIgnoreProperties(ignoreUnknown = true)
@JsonTypeName("ids:SalesRequest")
public class SalesRequestImpl implements Serializable, SalesRequest {
	...
	@JsonIgnore
	protected List<TypedLiteral> comment = Arrays.asList(new TypedLiteral("The ContractRequest class representing the 'Perpetual Data Sale' policy class.", "en"));
	...
	*/
	...
	protected SalesRequestImpl() {
		id = VocabUtil.getInstance().createRandomUrl("salesRequest");
	}
	...
	public boolean equals(Object obj) {
		if (this == obj) {
			...
			SalesRequestImpl other = (SalesRequestImpl) obj;
