...
/**
 * Default implementation of package de.fraunhofer.iais.eis.Category
 * 
 * Represents a group of quality dimensions in which a common type of information is used as quality
 * indicator.
 */
@JsonIgnoreProperties(ignoreUnknown = true)
@JsonTypeName("http://www.w3.org/ns/dqv#Category")
public class CategoryImpl implements Category {
    ...
    @JsonIgnore
    protected List<TypedLiteral> label = Arrays.asList(new TypedLiteral("Category", "en"));
    ...
    protected CategoryImpl() {
        id = VocabUtil.getInstance().createRandomUrl("category");
    }
