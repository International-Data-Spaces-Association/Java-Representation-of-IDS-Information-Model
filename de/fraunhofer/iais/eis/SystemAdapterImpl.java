...
public class SystemAdapterImpl implements Serializable, SystemAdapter {
	...
	@JsonIgnore
	protected List<TypedLiteral> label = Arrays.asList(new TypedLiteral("System Adapter", "en"));

	//List of all comments of this class
	@JsonIgnore
	protected List<TypedLiteral> comment = Arrays.asList(new TypedLiteral("Data Apps that integrate sources and sinks of digital content maintained internally on Participant's premises with a Connector.", "en"));
	...
	*/
	...
	public boolean equals(Object obj) {
		if (this == obj) {
			...
			SystemAdapterImpl other = (SystemAdapterImpl) obj;
