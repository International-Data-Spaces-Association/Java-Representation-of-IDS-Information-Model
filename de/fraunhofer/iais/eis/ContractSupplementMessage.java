...
public interface ContractSupplementMessage extends NotificationMessage {
	...
	*/
	...
	/**
	* This function returns a hash code value for the ContractSupplementMessage for the benefit of e.g. hash tables.
	* @return a hash code value for the ContractSupplementMessage
	*/
	public int hashCode();
	...
	* @return true if this ContractSupplementMessage is the same as the obj argument; false otherwise.
	*/
