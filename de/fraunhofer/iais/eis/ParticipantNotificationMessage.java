...
public interface ParticipantNotificationMessage extends NotificationMessage {
	...
	*/
	...
	/**
	* This function returns a hash code value for the ParticipantNotificationMessage for the benefit of e.g. hash tables.
	* @return a hash code value for the ParticipantNotificationMessage
	*/
	public int hashCode();
	...
	* @return true if this ParticipantNotificationMessage is the same as the obj argument; false otherwise.
	*/
