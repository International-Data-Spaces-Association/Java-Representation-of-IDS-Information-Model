...
/** 
* "Duration Agreement"@en
* "The ContractAgreement class representing the \'Duration-restricted Data Usage\' policy class."@en 
*/
@JsonIgnoreProperties(ignoreUnknown = true)
@JsonTypeName("ids:DurationAgreement")
public class DurationAgreementImpl implements Serializable, DurationAgreement {
	...
	@JsonIgnore
	protected List<TypedLiteral> label = Arrays.asList(new TypedLiteral("Duration Agreement", "en"));

	//List of all comments of this class
	@JsonIgnore
	protected List<TypedLiteral> comment = Arrays.asList(new TypedLiteral("The ContractAgreement class representing the 'Duration-restricted Data Usage' policy class.", "en"));
	...
	*/
	...
	protected DurationAgreementImpl() {
		id = VocabUtil.getInstance().createRandomUrl("durationAgreement");
	}
