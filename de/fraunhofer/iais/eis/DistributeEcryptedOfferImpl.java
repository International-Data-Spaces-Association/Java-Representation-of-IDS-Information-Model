...
public class DistributeEcryptedOfferImpl implements Serializable, DistributeEcryptedOffer {
	...
	@JsonIgnore
	java.util.List<TypedLiteral> label = Arrays.asList(new TypedLiteral("Distribute Encrypted Offer", "en"));
	//List of all comments of this class
	@JsonIgnore
	java.util.List<TypedLiteral> comment = Arrays.asList(new TypedLiteral("The ContractOffer class representing the 'Distribute only if Encrypted' policy class.", "en"));
