...
/** 
* "Distribute Encrypted Offer"@en
* "The ContractOffer class representing the \'Distribute only if Encrypted\' policy class."@en 
*/
@JsonIgnoreProperties(ignoreUnknown = true)
@JsonTypeName("ids:DistributeEcryptedOffer")
public class DistributeEcryptedOfferImpl implements Serializable, DistributeEcryptedOffer {
	...
	@JsonIgnore
	protected List<TypedLiteral> label = Arrays.asList(new TypedLiteral("Distribute Encrypted Offer", "en"));

	//List of all comments of this class
	@JsonIgnore
	protected List<TypedLiteral> comment = Arrays.asList(new TypedLiteral("The ContractOffer class representing the 'Distribute only if Encrypted' policy class.", "en"));
	...
	*/
	...
	protected DistributeEcryptedOfferImpl() {
		id = VocabUtil.getInstance().createRandomUrl("distributeEcryptedOffer");
	}
	...
	public boolean equals(Object obj) {
		if (this == obj) {
			...
			DistributeEcryptedOfferImpl other = (DistributeEcryptedOfferImpl) obj;
