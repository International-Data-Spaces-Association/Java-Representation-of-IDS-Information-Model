...
public class ParticipantRequestMessageImpl implements Serializable, ParticipantRequestMessage {
	...
	@JsonIgnore
	java.util.List<TypedLiteral> label = Arrays.asList(new TypedLiteral("Participant Request Message", "en"));
	//List of all comments of this class
	@JsonIgnore
	java.util.List<TypedLiteral> comment = Arrays.asList(new TypedLiteral("Message asking for retrieving the specified Participants information as the payload of an ParticipantResponse message.", "en"));
	...
	*/
	@NotNull@JsonAlias({"ids:requestedParticipant", "requestedParticipant"})
	 URI _requestedParticipant;
	...
	*/
	...
	final public void setRequestedParticipant (URI _requestedParticipant_) {
