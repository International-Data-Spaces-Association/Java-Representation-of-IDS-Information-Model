...
public interface ContractOfferMessage extends NotificationMessage {
	...
	*/
	...
	/**
	* This function returns a hash code value for the ContractOfferMessage for the benefit of e.g. hash tables.
	* @return a hash code value for the ContractOfferMessage
	*/
	public int hashCode();
	...
	* @return true if this ContractOfferMessage is the same as the obj argument; false otherwise.
	*/
