...
public class InvokeOperationMessageImpl implements Serializable, InvokeOperationMessage {
	...
	@JsonIgnore
	protected List<TypedLiteral> comment = Arrays.asList(new TypedLiteral("Message requesting the recipient to invoke a specific operation.", "en"));
	...
	*/
	...
	/**
	* "References the operation to be invoked on the recipient\'s side by an URI."@en
	* @param _operationReference_ desired value for the property operationReference.
	* More information under https://w3id.org/idsa/core/operationReference
	*/
