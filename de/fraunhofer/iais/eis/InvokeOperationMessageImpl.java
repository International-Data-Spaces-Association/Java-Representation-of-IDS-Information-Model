...
public class InvokeOperationMessageImpl implements Serializable, InvokeOperationMessage {
	...
	@JsonIgnore
	java.util.List<TypedLiteral> label = Arrays.asList(new TypedLiteral("Invoke Operation Message", "en"));
	//List of all comments of this class
	@JsonIgnore
	java.util.List<TypedLiteral> comment = Arrays.asList(new TypedLiteral("Message requesting the recipient to invoke a specific operation.", "en"));
	...
	*/
	@NotNull@JsonAlias({"ids:operationReference", "operationReference"})
	 URI _operationReference;
	...
	*/
	...
	final public void setOperationReference (URI _operationReference_) {
