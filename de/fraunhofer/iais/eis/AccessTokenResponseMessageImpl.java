...
/** 
* "Access Token Response"@en
* "Response to an access token request, intended for point-to-point communication."@en 
*/
@JsonIgnoreProperties(ignoreUnknown = true)
@JsonTypeName("ids:AccessTokenResponseMessage")
public class AccessTokenResponseMessageImpl implements Serializable, AccessTokenResponseMessage {
	...
	@JsonIgnore
	protected List<TypedLiteral> comment = Arrays.asList(new TypedLiteral("Response to an access token request, intended for point-to-point communication.", "en"));
