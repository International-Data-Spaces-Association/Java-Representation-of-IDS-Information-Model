...
public class AccessTokenResponseMessageImpl implements Serializable, AccessTokenResponseMessage {
	...
	@JsonIgnore
	java.util.List<TypedLiteral> label = Arrays.asList(new TypedLiteral("Access Token Response", "en"));
	//List of all comments of this class
	@JsonIgnore
	java.util.List<TypedLiteral> comment = Arrays.asList(new TypedLiteral("Response to an access token request, intended for point-to-point communication.", "en"));
	...
	*/
	...
	AccessTokenResponseMessageImpl() {
