...
/** 
* "Connector Update Message"@en
* "Event notifying the recipient(s) about the availability and current configuration of a connector. The payload of the message must contain the updated connector\'s self-description."@en 
*/
@JsonIgnoreProperties(ignoreUnknown = true)
@JsonTypeName("ids:ConnectorUpdateMessage")
public class ConnectorUpdateMessageImpl implements Serializable, ConnectorUpdateMessage {
	...
	@JsonIgnore
	protected List<TypedLiteral> label = Arrays.asList(new TypedLiteral("Connector Update Message", "en"));

	//List of all comments of this class
	@JsonIgnore
	protected List<TypedLiteral> comment = Arrays.asList(new TypedLiteral("Event notifying the recipient(s) about the availability and current configuration of a connector. The payload of the message must contain the updated connector's self-description.", "en"));
	...
	*/
	...
	protected ConnectorUpdateMessageImpl() {
		id = VocabUtil.getInstance().createRandomUrl("connectorUpdateMessage");
	}
	...
	public boolean equals(Object obj) {
		if (this == obj) {
			...
			ConnectorUpdateMessageImpl other = (ConnectorUpdateMessageImpl) obj;
