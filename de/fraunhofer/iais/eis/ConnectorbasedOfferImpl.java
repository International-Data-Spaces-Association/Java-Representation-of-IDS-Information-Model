...
public class ConnectorbasedOfferImpl implements Serializable, ConnectorbasedOffer {
	...
	@JsonIgnore
	protected List<TypedLiteral> comment = Arrays.asList(new TypedLiteral("The ContractOffer class representing the 'Connector-restricted Data Usage' policy class.", "en"));
