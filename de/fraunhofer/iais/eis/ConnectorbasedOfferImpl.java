...
public class ConnectorbasedOfferImpl implements Serializable, ConnectorbasedOffer {
	...
	@JsonIgnore
	java.util.List<TypedLiteral> label = Arrays.asList(new TypedLiteral("Connector-restricted Data Usage Offer", "en"));
	//List of all comments of this class
	@JsonIgnore
	java.util.List<TypedLiteral> comment = Arrays.asList(new TypedLiteral("The ContractOffer class representing the 'Connector-restricted Data Usage' policy class.", "en"));
