...
/**
 * Default implementation of package de.fraunhofer.iais.eis.Representation
 * 
...
public class RepresentationImpl implements Representation {
    ...
    @JsonIgnore
    protected List<TypedLiteral> label = Arrays.asList(new TypedLiteral("Representation", "en"));

    // List of all comments of this class
    @JsonIgnore
    protected List<TypedLiteral> comment = Arrays.asList(new TypedLiteral("Syntactic template of a Resource.", "en"));
    ...
    public boolean equals(Object obj) {
        if (this == obj) {
            ...
            RepresentationImpl other = (RepresentationImpl) obj;
