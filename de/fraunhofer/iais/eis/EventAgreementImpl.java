...
public class EventAgreementImpl implements Serializable, EventAgreement {
	...
	@JsonIgnore
	java.util.List<TypedLiteral> label = Arrays.asList(new TypedLiteral("Event-restricted Data Usage Agreement", "en"));
	//List of all comments of this class
	@JsonIgnore
	java.util.List<TypedLiteral> comment = Arrays.asList(new TypedLiteral("The ContractAgreement class representing the 'Event-restricted Usage Policy' policy class.", "en"));
