...
/** 
* "Event-restricted Data Usage Agreement"@en
* "The ContractAgreement class representing the \'Event-restricted Usage Policy\' policy class."@en 
*/
@JsonIgnoreProperties(ignoreUnknown = true)
@JsonTypeName("ids:EventAgreement")
public class EventAgreementImpl implements Serializable, EventAgreement {
	...
	@JsonIgnore
	protected List<TypedLiteral> label = Arrays.asList(new TypedLiteral("Event-restricted Data Usage Agreement", "en"));

	//List of all comments of this class
	@JsonIgnore
	protected List<TypedLiteral> comment = Arrays.asList(new TypedLiteral("The ContractAgreement class representing the 'Event-restricted Usage Policy' policy class.", "en"));
	...
	*/
	...
	protected EventAgreementImpl() {
		id = VocabUtil.getInstance().createRandomUrl("eventAgreement");
	}
	...
	public boolean equals(Object obj) {
		if (this == obj) {
			...
			EventAgreementImpl other = (EventAgreementImpl) obj;
