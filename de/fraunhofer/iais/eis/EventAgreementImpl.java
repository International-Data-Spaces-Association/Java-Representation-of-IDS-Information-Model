...
/**
 * Default implementation of package de.fraunhofer.iais.eis.EventAgreement
 * 
...
public class EventAgreementImpl implements EventAgreement {
    ...
    protected List<TypedLiteral> comment =
        Arrays.asList(new TypedLiteral("The ContractAgreement class representing the 'Event-restricted Usage Policy' policy class.", "en"));
