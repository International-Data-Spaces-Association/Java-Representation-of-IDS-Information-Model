...
public interface AppRegistrationRequestMessage extends RequestMessage {
	...
	*/
	...
	/**
	* This function returns a hash code value for the AppRegistrationRequestMessage for the benefit of e.g. hash tables.
	* @return a hash code value for the AppRegistrationRequestMessage
	*/
	public int hashCode();
	...
	* @return true if this AppRegistrationRequestMessage is the same as the obj argument; false otherwise.
	*/
