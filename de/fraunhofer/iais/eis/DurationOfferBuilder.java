...
public class DurationOfferBuilder implements Builder<DurationOffer> {
     ...
     */
    public DurationOfferBuilder _contractStart_(XMLGregorianCalendar _contractStart_) {
        this.durationOfferImpl.setContractStart(_contractStart_);
        return this;
    }
     ...
     */
    public DurationOfferBuilder _contractEnd_(XMLGregorianCalendar _contractEnd_) {
        this.durationOfferImpl.setContractEnd(_contractEnd_);
        return this;
    }
     ...
     */
    public DurationOfferBuilder _contractDate_(XMLGregorianCalendar _contractDate_) {
        this.durationOfferImpl.setContractDate(_contractDate_);
        return this;
    }
     ...
     */
    public DurationOfferBuilder _provider_(URI _provider_) {
        this.durationOfferImpl.setProvider(_provider_);
        return this;
    }
     ...
     */
    public DurationOfferBuilder _consumer_(URI _consumer_) {
        this.durationOfferImpl.setConsumer(_consumer_);
        return this;
    }
     ...
     */
    public DurationOfferBuilder _contractDocument_(TextResource _contractDocument_) {
        this.durationOfferImpl.setContractDocument(_contractDocument_);
        return this;
    }
     ...
     */
    public DurationOfferBuilder _contractAnnex_(Resource _contractAnnex_) {
        this.durationOfferImpl.setContractAnnex(_contractAnnex_);
        return this;
    }
     ...
     */
    public DurationOfferBuilder _permission_(List<Permission> _permission_) {
        this.durationOfferImpl.setPermission(_permission_);
        return this;
    }
     ...
     * @return Builder object with new value for _permission
     */
    public DurationOfferBuilder _permission_(Permission _permission_) {
        this.durationOfferImpl.getPermission().add(_permission_);
        return this;
    }
     ...
     */
    public DurationOfferBuilder _prohibition_(List<Prohibition> _prohibition_) {
        this.durationOfferImpl.setProhibition(_prohibition_);
        return this;
    }
     ...
     * @return Builder object with new value for _prohibition
     */
    public DurationOfferBuilder _prohibition_(Prohibition _prohibition_) {
        this.durationOfferImpl.getProhibition().add(_prohibition_);
        return this;
    }
     ...
     */
    public DurationOfferBuilder _obligation_(List<Duty> _obligation_) {
        this.durationOfferImpl.setObligation(_obligation_);
        return this;
    }
     ...
     * @return Builder object with new value for _obligation
     */
    public DurationOfferBuilder _obligation_(Duty _obligation_) {
        this.durationOfferImpl.getObligation().add(_obligation_);
        return this;
    }
     ...
     */
    @Override
    public DurationOffer build() throws ConstraintViolationException {
