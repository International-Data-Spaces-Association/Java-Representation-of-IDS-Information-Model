...
public enum DefaultContentType implements ContentType {
     ...
     * Blueprint, WSDL.
     */
    INTERFACE_DEFINITION("https://w3id.org/idsa/code/INTERFACE_DEFINITION"),

    /**
     * Formal, machine-interpretable definition of a data schema, e.g., XMLSchema, JSONSchema
     */
    SCHEMA_DEFINITION("https://w3id.org/idsa/code/SCHEMA_DEFINITION"),;

    private static final Map<String, DefaultContentType> uriInstanceMapping;
    static {
    ...
    DefaultContentType(String id) {
        this.contentType = new ContentTypeBuilder(URI.create(id)).build();
    }
    ...
    final public List<TypedLiteral> getLabel() {
        return this.contentType.getLabel();
    }
    ...
    final public List<TypedLiteral> getComment() {
        return this.contentType.getComment();
    }
    ...
    @JsonCreator
    public static DefaultContentType deserialize(JsonNode node) {
        return uriInstanceMapping.get(node.has("@id") ? node.get("@id").textValue() : node.textValue());
    }

    @Override
    public String toString() {
        return this.contentType.getId().toString();
    }
