...
public class ConnectorUnavailableMessageImpl implements Serializable, ConnectorUnavailableMessage {
	...
	@JsonIgnore
	java.util.List<TypedLiteral> label = Arrays.asList(new TypedLiteral("Connector Unavailable Message", "en"));
	//List of all comments of this class
	@JsonIgnore
	java.util.List<TypedLiteral> comment = Arrays.asList(new TypedLiteral("Event notifying the recipient(s) that a connector will be unavailable. The same connector may be available again in the future.", "en"));
	...
	*/
	...
	ConnectorUnavailableMessageImpl() {
