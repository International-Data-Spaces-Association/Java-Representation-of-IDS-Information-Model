...
@JsonTypeName("ids:ConnectorUnavailableMessage")
public class ConnectorUnavailableMessageImpl implements Serializable, ConnectorUnavailableMessage {
	...
	@JsonIgnore
	protected List<TypedLiteral> label = Arrays.asList(new TypedLiteral("Connector Unavailable Message", "en"));

	//List of all comments of this class
	@JsonIgnore
	protected List<TypedLiteral> comment = Arrays.asList(new TypedLiteral("Event notifying the recipient(s) that a connector will be unavailable. The same connector may be available again in the future.", "en"));
	...
	*/
	...
	protected ConnectorUnavailableMessageImpl() {
		id = VocabUtil.getInstance().createRandomUrl("connectorUnavailableMessage");
	}
	...
	public boolean equals(Object obj) {
		if (this == obj) {
			...
			ConnectorUnavailableMessageImpl other = (ConnectorUnavailableMessageImpl) obj;
