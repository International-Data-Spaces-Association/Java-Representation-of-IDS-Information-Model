...
public interface DescriptionRequestMessage extends RequestMessage {
	...
	*/
	...
	/**
	* This function returns a hash code value for the DescriptionRequestMessage for the benefit of e.g. hash tables.
	* @return a hash code value for the DescriptionRequestMessage
	*/
	public int hashCode();
	...
	* @return true if this DescriptionRequestMessage is the same as the obj argument; false otherwise.
	*/
