...
public class VideoResourceBuilder {
	...
	*/
	final public VideoResourceBuilder _resourcePart_(List<Resource> _resourcePart_) {
	...
	*/
	final public VideoResourceBuilder _resourceEndpoint_(List<ConnectorEndpoint> _resourceEndpoint_) {
	...
	*/
	final public VideoResourceBuilder _contractOffer_(List<ContractOffer> _contractOffer_) {
	...
	*/
	final public VideoResourceBuilder _sample_(List<Resource> _sample_) {
	...
	*/
	final public VideoResourceBuilder _contentPart_(List<DigitalContent> _contentPart_) {
	...
	*/
	final public VideoResourceBuilder _representation_(List<Representation> _representation_) {
	...
	*/
	final public VideoResourceBuilder _defaultRepresentation_(List<Representation> _defaultRepresentation_) {
	...
	*/
	final public VideoResourceBuilder _theme_(List<URI> _theme_) {
	...
	*/
	final public VideoResourceBuilder _keyword_(List<TypedLiteral> _keyword_) {
	...
	*/
	final public VideoResourceBuilder _temporalCoverage_(List<TemporalEntity> _temporalCoverage_) {
	...
	*/
	final public VideoResourceBuilder _spatialCoverage_(List<Location> _spatialCoverage_) {
	...
	*/
	final public VideoResourceBuilder _language_(List<Language> _language_) {
	...
	*/
	final public VideoResourceBuilder _title_(List<TypedLiteral> _title_) {
	...
	*/
	final public VideoResourceBuilder _description_(List<TypedLiteral> _description_) {
