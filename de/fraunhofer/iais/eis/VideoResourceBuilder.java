...
public class VideoResourceBuilder implements Builder<VideoResource> {
     ...
     */
    public VideoResourceBuilder _publisherAsObject_(Agent _publisher_) {
        this.videoResourceImpl.setPublisherAsObject(_publisher_);
        return this;
    }
     ...
     */
    public VideoResourceBuilder _publisherAsUri_(URI _publisher_) {
        this.videoResourceImpl.setPublisherAsUri(_publisher_);
        return this;
    }
     ...
     */
    public VideoResourceBuilder _sovereignAsObject_(Agent _sovereign_) {
        this.videoResourceImpl.setSovereignAsObject(_sovereign_);
        return this;
    }
     ...
     */
    public VideoResourceBuilder _sovereignAsUri_(URI _sovereign_) {
        this.videoResourceImpl.setSovereignAsUri(_sovereign_);
        return this;
    }
     ...
     */
    public VideoResourceBuilder _hasQualityMeasurement_(List<QualityMeasurement> _hasQualityMeasurement_) {
        this.videoResourceImpl.setHasQualityMeasurement(_hasQualityMeasurement_);
        return this;
    }
     ...
     * @return Builder object with new value for _hasQualityMeasurement
     */
    public VideoResourceBuilder _hasQualityMeasurement_(QualityMeasurement _hasQualityMeasurement_) {
        this.videoResourceImpl.getHasQualityMeasurement().add(_hasQualityMeasurement_);
        return this;
    }
