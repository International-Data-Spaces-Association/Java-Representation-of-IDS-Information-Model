...
/** 
* "Sales Request"@en
* "The ContractRequest class representing the \'Remote Notifications\' policy class."@en 
*/
@JsonIgnoreProperties(ignoreUnknown = true)
@JsonTypeName("ids:NotificationRequest")
public class NotificationRequestImpl implements Serializable, NotificationRequest {
	...
	@JsonIgnore
	protected List<TypedLiteral> comment = Arrays.asList(new TypedLiteral("The ContractRequest class representing the 'Remote Notifications' policy class.", "en"));
	...
	*/
	...
	protected NotificationRequestImpl() {
		id = VocabUtil.getInstance().createRandomUrl("notificationRequest");
	}
	...
	public boolean equals(Object obj) {
		if (this == obj) {
			...
			NotificationRequestImpl other = (NotificationRequestImpl) obj;
