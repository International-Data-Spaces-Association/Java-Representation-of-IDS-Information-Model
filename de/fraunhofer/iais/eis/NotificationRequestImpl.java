...
/**
 * Default implementation of package de.fraunhofer.iais.eis.NotificationRequest
 * 
...
public class NotificationRequestImpl implements NotificationRequest {
    ...
    protected List<TypedLiteral> comment =
        Arrays.asList(new TypedLiteral("The ContractRequest class representing the 'Remote Notifications' policy class.", "en"));
