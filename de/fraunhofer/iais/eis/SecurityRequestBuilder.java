...
public class SecurityRequestBuilder {
	...
	*/
	final public SecurityRequestBuilder _permission_(List<Permission> _permission_) {
	...
	*/
	final public SecurityRequestBuilder _prohibition_(List<Prohibition> _prohibition_) {
	...
	*/
	final public SecurityRequestBuilder _obligation_(List<Duty> _obligation_) {
