...
public interface AppEndpoint extends Endpoint {
	...
	*/
	...
	/**
	* This function returns a hash code value for the AppEndpoint for the benefit of e.g. hash tables.
	* @return a hash code value for the AppEndpoint
	*/
	public int hashCode();
	...
	* @return true if this AppEndpoint is the same as the obj argument; false otherwise.
	*/
