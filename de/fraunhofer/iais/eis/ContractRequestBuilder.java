...
public class ContractRequestBuilder implements Builder<ContractRequest> {
    ...
    public ContractRequestBuilder(URI id) {
        this();
     ...
     */
    public ContractRequestBuilder _contractStart_(XMLGregorianCalendar _contractStart_) {
        this.contractRequestImpl.setContractStart(_contractStart_);
        return this;
    }
     ...
     */
    public ContractRequestBuilder _contractEnd_(XMLGregorianCalendar _contractEnd_) {
        this.contractRequestImpl.setContractEnd(_contractEnd_);
        return this;
    }
     ...
     */
    public ContractRequestBuilder _contractDate_(XMLGregorianCalendar _contractDate_) {
        this.contractRequestImpl.setContractDate(_contractDate_);
        return this;
    }
     ...
     */
    public ContractRequestBuilder _provider_(URI _provider_) {
        this.contractRequestImpl.setProvider(_provider_);
        return this;
    }
     ...
     */
    public ContractRequestBuilder _consumer_(URI _consumer_) {
        this.contractRequestImpl.setConsumer(_consumer_);
        return this;
    }
     ...
     */
    public ContractRequestBuilder _contractDocument_(TextResource _contractDocument_) {
        this.contractRequestImpl.setContractDocument(_contractDocument_);
        return this;
    }
     ...
     */
    public ContractRequestBuilder _contractAnnex_(Resource _contractAnnex_) {
        this.contractRequestImpl.setContractAnnex(_contractAnnex_);
        return this;
    }
     ...
     */
    public ContractRequestBuilder _permission_(List<Permission> _permission_) {
        this.contractRequestImpl.setPermission(_permission_);
        return this;
    }
     ...
     * @return Builder object with new value for _permission
     */
    public ContractRequestBuilder _permission_(Permission _permission_) {
        this.contractRequestImpl.getPermission().add(_permission_);
        return this;
    }
     ...
     */
    public ContractRequestBuilder _prohibition_(List<Prohibition> _prohibition_) {
        this.contractRequestImpl.setProhibition(_prohibition_);
        return this;
    }
     ...
     * @return Builder object with new value for _prohibition
     */
    public ContractRequestBuilder _prohibition_(Prohibition _prohibition_) {
        this.contractRequestImpl.getProhibition().add(_prohibition_);
        return this;
    }
     ...
     */
    public ContractRequestBuilder _obligation_(List<Duty> _obligation_) {
        this.contractRequestImpl.setObligation(_obligation_);
        return this;
    }
     ...
     * @return Builder object with new value for _obligation
     */
    public ContractRequestBuilder _obligation_(Duty _obligation_) {
        this.contractRequestImpl.getObligation().add(_obligation_);
        return this;
    }
     ...
     */
    @Override
    public ContractRequest build() throws ConstraintViolationException {
