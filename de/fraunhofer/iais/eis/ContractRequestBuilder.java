...
public class ContractRequestBuilder {
	...
	*/
	final public ContractRequestBuilder _permission_(List<Permission> _permission_) {
	...
	*/
	final public ContractRequestBuilder _prohibition_(List<Prohibition> _prohibition_) {
	...
	*/
	final public ContractRequestBuilder _obligation_(List<Duty> _obligation_) {
