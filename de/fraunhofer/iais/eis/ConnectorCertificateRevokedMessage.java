...
public interface ConnectorCertificateRevokedMessage extends ConnectorNotificationMessage {
	...
	*/
	...
	/**
	* This function returns a hash code value for the ConnectorCertificateRevokedMessage for the benefit of e.g. hash tables.
	* @return a hash code value for the ConnectorCertificateRevokedMessage
	*/
	public int hashCode();
	...
	* @return true if this ConnectorCertificateRevokedMessage is the same as the obj argument; false otherwise.
	*/
