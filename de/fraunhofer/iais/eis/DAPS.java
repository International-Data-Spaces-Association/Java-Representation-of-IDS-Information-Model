...
public interface DAPS extends InfrastructureComponent {
	...
	*/
	...
	/**
	* This function returns a hash code value for the DAPS for the benefit of e.g. hash tables.
	* @return a hash code value for the DAPS
	*/
	public int hashCode();
	...
	* @return true if this DAPS is the same as the obj argument; false otherwise.
	*/
