...
public class SwapRequestBuilder {
	...
	*/
	final public SwapRequestBuilder _permission_(ArrayList<? extends Permission> _permission_) {
	...
	*/
	final public SwapRequestBuilder _prohibition_(ArrayList<? extends Prohibition> _prohibition_) {
	...
	*/
	final public SwapRequestBuilder _obligation_(ArrayList<? extends Duty> _obligation_) {
	...
	*/
	...
	final public SwapRequest build() throws ConstraintViolationException {
