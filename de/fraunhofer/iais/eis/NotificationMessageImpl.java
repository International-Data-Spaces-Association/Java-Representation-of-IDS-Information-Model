...
public class NotificationMessageImpl implements Serializable, NotificationMessage {
	...
	@JsonIgnore
	protected List<TypedLiteral> label = Arrays.asList(new TypedLiteral("Notification Message", "en"));

	//List of all comments of this class
	@JsonIgnore
	protected List<TypedLiteral> comment = Arrays.asList(new TypedLiteral("Event messages are informative and no response is expected by the sender.", "en"));
