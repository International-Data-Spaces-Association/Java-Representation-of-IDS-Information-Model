...
/**
 * Default implementation of package de.fraunhofer.iais.eis.NotificationMessage
 * 
...
public class NotificationMessageImpl implements NotificationMessage {
    ...
    protected List<TypedLiteral> comment =
        Arrays.asList(new TypedLiteral("Event messages are informative and no response is expected by the sender.", "en"));
