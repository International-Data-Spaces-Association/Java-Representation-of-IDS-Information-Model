...
public class SpatialOfferBuilder {
	...
	*/
	final public SpatialOfferBuilder _permission_(List<Permission> _permission_) {
	...
	*/
	final public SpatialOfferBuilder _prohibition_(List<Prohibition> _prohibition_) {
	...
	*/
	final public SpatialOfferBuilder _obligation_(List<Duty> _obligation_) {
	...
	*/
	...
	final public SpatialOffer build() throws ConstraintViolationException {
