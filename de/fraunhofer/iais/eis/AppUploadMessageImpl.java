...
/**
 * Default implementation of package de.fraunhofer.iais.eis.AppUploadMessage
 * 
...
public class AppUploadMessageImpl implements AppUploadMessage {
    ...
    @Override
    public int hashCode() {
        return Objects.hash(this._appArtifactReference,
            this._modelVersion,
            this._issued,
