...
public class QueryMessageBuilder {
	...
	/**
	* This function allows setting a value for queryLanguage
	* @param _queryLanguage_ desired value to be set
	* @return Builder object with new value for queryLanguage
	*/
	...
	/**
	* This function allows setting a value for queryScope
	* @param _queryScope_ desired value to be set
	* @return Builder object with new value for queryScope
	*/
	...
	/**
	* This function allows setting a value for recipientScope
	* @param _recipientScope_ desired value to be set
	* @return Builder object with new value for recipientScope
	*/
	...
	*/
	final public QueryMessageBuilder _recipientConnector_(ArrayList<? extends URI> _recipientConnector_) {
	...
	*/
	final public QueryMessageBuilder _recipientAgent_(ArrayList<? extends URI> _recipientAgent_) {
