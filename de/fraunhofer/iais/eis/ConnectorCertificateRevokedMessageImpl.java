...
/**
 * Default implementation of package de.fraunhofer.iais.eis.ConnectorCertificateRevokedMessage
 * 
...
public class ConnectorCertificateRevokedMessageImpl implements ConnectorCertificateRevokedMessage {
    ...
    @JsonIgnore
    protected List<TypedLiteral> label = Arrays.asList(new TypedLiteral("Connector Certificate Revoked Message", "en"));
    ...
    protected ConnectorCertificateRevokedMessageImpl() {
    ...
    public boolean equals(Object obj) {
        if (this == obj) {
            ...
            ConnectorCertificateRevokedMessageImpl other = (ConnectorCertificateRevokedMessageImpl) obj;
            return Objects.equals(this._revocationReason, other._revocationReason) &&
                Objects.equals(this._affectedConnector, other._affectedConnector) &&
    ...
    public ConnectorCertificateRevokedMessage deepCopy() {
        ConnectorCertificateRevokedMessageBuilder builder = new ConnectorCertificateRevokedMessageBuilder();
        ...
        if (this._affectedConnector != null) {
            builder._affectedConnector_(URI.create(this._affectedConnector.toString()));
        }
