...
public class DeleteAfterIntervalAgreementBuilder {
	...
	*/
	final public DeleteAfterIntervalAgreementBuilder _permission_(List<Permission> _permission_) {
	...
	*/
	final public DeleteAfterIntervalAgreementBuilder _prohibition_(List<Prohibition> _prohibition_) {
	...
	*/
	final public DeleteAfterIntervalAgreementBuilder _obligation_(List<Duty> _obligation_) {
