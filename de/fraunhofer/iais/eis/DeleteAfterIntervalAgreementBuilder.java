...
public class DeleteAfterIntervalAgreementBuilder {
	...
	*/
	final public DeleteAfterIntervalAgreementBuilder _permission_(ArrayList<? extends Permission> _permission_) {
	...
	*/
	final public DeleteAfterIntervalAgreementBuilder _prohibition_(ArrayList<? extends Prohibition> _prohibition_) {
	...
	*/
	final public DeleteAfterIntervalAgreementBuilder _obligation_(ArrayList<? extends Duty> _obligation_) {
