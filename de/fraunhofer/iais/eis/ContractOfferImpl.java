...
public class ContractOfferImpl implements Serializable, ContractOffer {
	...
	@JsonIgnore
	java.util.List<TypedLiteral> label = Arrays.asList(new TypedLiteral("Contract offer", "en"));
	//List of all comments of this class
	@JsonIgnore
	java.util.List<TypedLiteral> comment = Arrays.asList(new TypedLiteral("Contract issued by the Data Provider offering the usage of a Resource at particular conditions.", "en"));
