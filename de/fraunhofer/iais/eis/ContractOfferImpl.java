...
public class ContractOfferImpl implements Serializable, ContractOffer {
	...
	@JsonIgnore
	protected List<TypedLiteral> comment = Arrays.asList(new TypedLiteral("Contract issued by the Data Provider offering the usage of a Resource at particular conditions.", "en"));
