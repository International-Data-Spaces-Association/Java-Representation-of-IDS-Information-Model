...
public class ContractResponseMessageImpl implements Serializable, ContractResponseMessage {
	...
	@JsonIgnore
	java.util.List<TypedLiteral> comment = Arrays.asList(new TypedLiteral("Message containing a response to a contract request (of a data consumer) in form of a counter-proposal of a contract in the associated payload (which is an instance of ids:ContractOffer). ", "en"));
