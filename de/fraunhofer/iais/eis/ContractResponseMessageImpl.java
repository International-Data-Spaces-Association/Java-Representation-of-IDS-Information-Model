...
* "Message containing a response to a contract request (of a data consumer) in form of a counter-proposal of a contract in the associated payload (which is an instance of ids:ContractOffer). "@en 
*/
...
public class ContractResponseMessageImpl implements Serializable, ContractResponseMessage {
	...
	@JsonIgnore
	protected List<TypedLiteral> label = Arrays.asList(new TypedLiteral("Contract Response Message", "en"));

	//List of all comments of this class
	@JsonIgnore
	protected List<TypedLiteral> comment = Arrays.asList(new TypedLiteral("Message containing a response to a contract request (of a data consumer) in form of a counter-proposal of a contract in the associated payload (which is an instance of ids:ContractOffer). ", "en"));
	...
	*/
	...
	protected ContractResponseMessageImpl() {
	...
	public boolean equals(Object obj) {
		if (this == obj) {
			...
			ContractResponseMessageImpl other = (ContractResponseMessageImpl) obj;
