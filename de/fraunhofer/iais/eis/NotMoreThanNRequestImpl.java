...
/**
 * Default implementation of package de.fraunhofer.iais.eis.NotMoreThanNRequest
 * 
 * The ContractRequest class representing the 'Restricted Number of Usages' policy class.
 */
@JsonIgnoreProperties(ignoreUnknown = true)
@JsonTypeName("ids:NotMoreThanNRequest")
public class NotMoreThanNRequestImpl implements NotMoreThanNRequest {
    ...
    protected List<TypedLiteral> comment =
        Arrays.asList(new TypedLiteral("The ContractRequest class representing the 'Restricted Number of Usages' policy class.", "en"));
    ...
    protected NotMoreThanNRequestImpl() {
        id = VocabUtil.getInstance().createRandomUrl("notMoreThanNRequest");
    }
    ...
    public boolean equals(Object obj) {
        if (this == obj) {
            ...
            NotMoreThanNRequestImpl other = (NotMoreThanNRequestImpl) obj;
    ...
    public NotMoreThanNRequest deepCopy() {
        NotMoreThanNRequestBuilder builder = new NotMoreThanNRequestBuilder();
