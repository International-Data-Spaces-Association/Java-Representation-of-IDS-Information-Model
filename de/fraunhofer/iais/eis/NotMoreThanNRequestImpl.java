...
/** 
* "Sales Request"@en
* "The ContractRequest class representing the \'Restricted Number of Usages\' policy class."@en 
*/
@JsonIgnoreProperties(ignoreUnknown = true)
@JsonTypeName("ids:NotMoreThanNRequest")
public class NotMoreThanNRequestImpl implements Serializable, NotMoreThanNRequest {
	...
	@JsonIgnore
	protected List<TypedLiteral> comment = Arrays.asList(new TypedLiteral("The ContractRequest class representing the 'Restricted Number of Usages' policy class.", "en"));
