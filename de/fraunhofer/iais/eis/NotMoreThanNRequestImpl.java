...
public class NotMoreThanNRequestImpl implements Serializable, NotMoreThanNRequest {
	...
	@JsonIgnore
	java.util.List<TypedLiteral> comment = Arrays.asList(new TypedLiteral("The ContractRequest class representing the 'Restricted Number of Usages' policy class.", "en"));
