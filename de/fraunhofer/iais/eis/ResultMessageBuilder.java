...
public class ResultMessageBuilder {
	...
	*/
	final public ResultMessageBuilder _recipientConnector_(List<URI> _recipientConnector_) {
	...
	*/
	final public ResultMessageBuilder _recipientAgent_(List<URI> _recipientAgent_) {
