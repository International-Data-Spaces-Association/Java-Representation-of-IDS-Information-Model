...
public class ResultMessageBuilder {
	...
	*/
	final public ResultMessageBuilder _recipientConnector_(ArrayList<? extends URI> _recipientConnector_) {
	...
	*/
	final public ResultMessageBuilder _recipientAgent_(ArrayList<? extends URI> _recipientAgent_) {
	...
	*/
	...
	final public ResultMessage build() throws ConstraintViolationException {
