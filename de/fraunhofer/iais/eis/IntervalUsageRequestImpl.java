...
public class IntervalUsageRequestImpl implements Serializable, IntervalUsageRequest {
	...
	@JsonIgnore
	java.util.List<TypedLiteral> comment = Arrays.asList(new TypedLiteral("The ContractRequest class representing the 'Interval-restricted Data Usage' policy class.", "en"));
