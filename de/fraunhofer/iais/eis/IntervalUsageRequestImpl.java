...
/**
 * Default implementation of package de.fraunhofer.iais.eis.IntervalUsageRequest
 * 
 * The ContractRequest class representing the 'Interval-restricted Data Usage' policy class.
 */
@JsonIgnoreProperties(ignoreUnknown = true)
@JsonTypeName("ids:IntervalUsageRequest")
public class IntervalUsageRequestImpl implements IntervalUsageRequest {
    ...
    protected List<TypedLiteral> comment =
        Arrays.asList(new TypedLiteral("The ContractRequest class representing the 'Interval-restricted Data Usage' policy class.", "en"));
    ...
    protected IntervalUsageRequestImpl() {
        id = VocabUtil.getInstance().createRandomUrl("intervalUsageRequest");
    }
    ...
    public boolean equals(Object obj) {
        if (this == obj) {
            ...
            IntervalUsageRequestImpl other = (IntervalUsageRequestImpl) obj;
    ...
    public IntervalUsageRequest deepCopy() {
        IntervalUsageRequestBuilder builder = new IntervalUsageRequestBuilder();
