...
/** 
* "Sales Request"@en
* "The ContractRequest class representing the \'Interval-restricted Data Usage\' policy class."@en 
*/
@JsonIgnoreProperties(ignoreUnknown = true)
@JsonTypeName("ids:IntervalUsageRequest")
public class IntervalUsageRequestImpl implements Serializable, IntervalUsageRequest {
	...
	@JsonIgnore
	protected List<TypedLiteral> comment = Arrays.asList(new TypedLiteral("The ContractRequest class representing the 'Interval-restricted Data Usage' policy class.", "en"));
