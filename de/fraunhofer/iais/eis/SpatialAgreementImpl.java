...
/** 
* "Spatial Usage Agreement"@en
* "The ContractAgreement class representing the \'Location Restricted Usage\' policy class."@en 
*/
@JsonIgnoreProperties(ignoreUnknown = true)
@JsonTypeName("ids:SpatialAgreement")
public class SpatialAgreementImpl implements Serializable, SpatialAgreement {
	...
	@JsonIgnore
	protected List<TypedLiteral> label = Arrays.asList(new TypedLiteral("Spatial Usage Agreement", "en"));

	//List of all comments of this class
	@JsonIgnore
	protected List<TypedLiteral> comment = Arrays.asList(new TypedLiteral("The ContractAgreement class representing the 'Location Restricted Usage' policy class.", "en"));
	...
	*/
	...
	protected SpatialAgreementImpl() {
		id = VocabUtil.getInstance().createRandomUrl("spatialAgreement");
	}
	...
	public boolean equals(Object obj) {
		if (this == obj) {
			...
			SpatialAgreementImpl other = (SpatialAgreementImpl) obj;
