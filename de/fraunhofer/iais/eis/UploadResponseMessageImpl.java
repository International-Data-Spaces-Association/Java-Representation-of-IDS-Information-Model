...
/** 
* "Upload Response Message"@en
* "Message that follows up a UploadMessage and contains the upload confirmation."@en 
*/
@JsonIgnoreProperties(ignoreUnknown = true)
@JsonTypeName("ids:UploadResponseMessage")
public class UploadResponseMessageImpl implements Serializable, UploadResponseMessage {
	...
	@JsonIgnore
	protected List<TypedLiteral> label = Arrays.asList(new TypedLiteral("Upload Response Message", "en"));

	//List of all comments of this class
	@JsonIgnore
	protected List<TypedLiteral> comment = Arrays.asList(new TypedLiteral("Message that follows up a UploadMessage and contains the upload confirmation.", "en"));
	...
	*/
	...
	protected UploadResponseMessageImpl() {
		id = VocabUtil.getInstance().createRandomUrl("uploadResponseMessage");
	}
	...
	public boolean equals(Object obj) {
		if (this == obj) {
			...
			UploadResponseMessageImpl other = (UploadResponseMessageImpl) obj;
