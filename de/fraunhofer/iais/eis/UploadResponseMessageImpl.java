...
public class UploadResponseMessageImpl implements Serializable, UploadResponseMessage {
	...
	@JsonIgnore
	java.util.List<TypedLiteral> label = Arrays.asList(new TypedLiteral("Upload Response Message", "en"));
	//List of all comments of this class
	@JsonIgnore
	java.util.List<TypedLiteral> comment = Arrays.asList(new TypedLiteral("Message that follows up a UploadMessage and contains the upload confirmation.", "en"));
