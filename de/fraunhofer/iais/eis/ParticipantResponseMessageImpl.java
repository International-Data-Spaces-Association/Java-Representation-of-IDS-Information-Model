...
public class ParticipantResponseMessageImpl implements Serializable, ParticipantResponseMessage {
	...
	@JsonIgnore
	java.util.List<TypedLiteral> label = Arrays.asList(new TypedLiteral("Participant Response Message", "en"));
	//List of all comments of this class
	@JsonIgnore
	java.util.List<TypedLiteral> comment = Arrays.asList(new TypedLiteral("Message that follows up a ParticipantRequestMessage and contains the Participant's information in the payload section.", "en"));
	...
	*/
	...
	ParticipantResponseMessageImpl() {
		id = VocabUtil.getInstance().createRandomUrl("participantResponseMessage");
	}
