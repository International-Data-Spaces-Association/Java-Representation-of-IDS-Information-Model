...
/**
 * Default implementation of package de.fraunhofer.iais.eis.ParticipantResponseMessage
 * 
...
public class ParticipantResponseMessageImpl implements ParticipantResponseMessage {
    ...
    protected ParticipantResponseMessageImpl() {
    ...
    public boolean equals(Object obj) {
        if (this == obj) {
            ...
            ParticipantResponseMessageImpl other = (ParticipantResponseMessageImpl) obj;
    ...
    public ParticipantResponseMessage deepCopy() {
        ParticipantResponseMessageBuilder builder = new ParticipantResponseMessageBuilder();
