...
@JsonTypeName("ids:AppRegistrationRequestMessage")
public class AppRegistrationRequestMessageImpl implements Serializable, AppRegistrationRequestMessage {
	...
	@JsonIgnore
	protected List<TypedLiteral> label = Arrays.asList(new TypedLiteral("App Registration Request Message", "en"));

	//List of all comments of this class
	@JsonIgnore
	protected List<TypedLiteral> comment = Arrays.asList(new TypedLiteral("Message that asks for registration or update of a data app to the App Store. Payload contains app-related metadata (instance of class ids:AppResource). Message header may contain an app identifier parameter of a prior registered data app. If the app identifier is supplied, the message should be interpreted as a registration for an app update. Otherwise this message is used to register a new app. ", "en"));
	...
	*/
	@JsonAlias({"ids:affectedDataApp", "affectedDataApp"})
	protected URI _affectedDataApp;
	...
	*/
	...
	protected AppRegistrationRequestMessageImpl() {
		id = VocabUtil.getInstance().createRandomUrl("appRegistrationRequestMessage");
	}
	...
	public int hashCode() {
		return Objects.hash(new Object[]{this._affectedDataApp,
			this._modelVersion,
			this._issued,
	...
	public boolean equals(Object obj) {
		if (this == obj) {
			...
			AppRegistrationRequestMessageImpl other = (AppRegistrationRequestMessageImpl) obj;
			return Objects.equals(this._affectedDataApp, other._affectedDataApp) &&
	...
	final public URI getAffectedDataApp() {
		return _affectedDataApp;
	}
	
	final public void setAffectedDataApp (URI _affectedDataApp_) {
		this._affectedDataApp = _affectedDataApp_;
	}
