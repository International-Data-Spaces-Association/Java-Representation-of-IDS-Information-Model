...
public class ConnectorbasedOfferBuilder {
	...
	*/
	final public ConnectorbasedOfferBuilder _permission_(List<Permission> _permission_) {
	...
	*/
	final public ConnectorbasedOfferBuilder _prohibition_(List<Prohibition> _prohibition_) {
	...
	*/
	final public ConnectorbasedOfferBuilder _obligation_(List<Duty> _obligation_) {
