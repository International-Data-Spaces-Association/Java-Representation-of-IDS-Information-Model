...
public class DynamicAttributeTokenImpl implements Serializable, DynamicAttributeToken {
	...
	@JsonIgnore
	java.util.List<TypedLiteral> label = Arrays.asList(new TypedLiteral("Dynamic Attribute Token (DAT).", "en"));
	//List of all comments of this class
	@JsonIgnore
	java.util.List<TypedLiteral> comment = Arrays.asList(new TypedLiteral("A JSON Web Token (e.g., for authorization) mediated as part of the message, formerly known as the 'DAPS Token'. The complete JWT *including* header, payload and signiture is referenced by this class and *not* only the JSON element in the payload. See ids:DatPayload for the payload definition.", "en"));
	...
	*/
	@NotNull@JsonAlias({"ids:tokenFormat", "tokenFormat"})
