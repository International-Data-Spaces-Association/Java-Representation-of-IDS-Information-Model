...
/** 
* "Artifact Response Message"@en
* "Message that follows up a RetrieveArtifact Message and contains the Artifact\'s data in the payload section."@en 
*/
@JsonIgnoreProperties(ignoreUnknown = true)
@JsonTypeName("ids:ArtifactResponseMessage")
public class ArtifactResponseMessageImpl implements Serializable, ArtifactResponseMessage {
	...
	@JsonIgnore
	protected List<TypedLiteral> label = Arrays.asList(new TypedLiteral("Artifact Response Message", "en"));

	//List of all comments of this class
	@JsonIgnore
	protected List<TypedLiteral> comment = Arrays.asList(new TypedLiteral("Message that follows up a RetrieveArtifact Message and contains the Artifact's data in the payload section.", "en"));
	...
	*/
	...
	protected ArtifactResponseMessageImpl() {
		id = VocabUtil.getInstance().createRandomUrl("artifactResponseMessage");
	}
	...
	public boolean equals(Object obj) {
		if (this == obj) {
			...
			ArtifactResponseMessageImpl other = (ArtifactResponseMessageImpl) obj;
