...
public interface ContractOffer extends Contract {
	...
	*/
	...
	/**
	* This function returns a hash code value for the ContractOffer for the benefit of e.g. hash tables.
	* @return a hash code value for the ContractOffer
	*/
	public int hashCode();
	...
	* @return true if this ContractOffer is the same as the obj argument; false otherwise.
	*/
