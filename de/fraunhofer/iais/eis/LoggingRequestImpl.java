...
/** 
* "Sales Request"@en
* "The ContractRequest class representing the \'Local Logging\' policy class."@en 
*/
@JsonIgnoreProperties(ignoreUnknown = true)
@JsonTypeName("ids:LoggingRequest")
public class LoggingRequestImpl implements Serializable, LoggingRequest {
	...
	@JsonIgnore
	protected List<TypedLiteral> comment = Arrays.asList(new TypedLiteral("The ContractRequest class representing the 'Local Logging' policy class.", "en"));
	...
	*/
	...
	protected LoggingRequestImpl() {
		id = VocabUtil.getInstance().createRandomUrl("loggingRequest");
	}
	...
	public boolean equals(Object obj) {
		if (this == obj) {
			...
			LoggingRequestImpl other = (LoggingRequestImpl) obj;
