...
public class SalesOfferBuilder {
	...
	*/
	final public SalesOfferBuilder _permission_(List<Permission> _permission_) {
	...
	*/
	final public SalesOfferBuilder _prohibition_(List<Prohibition> _prohibition_) {
	...
	*/
	final public SalesOfferBuilder _obligation_(List<Duty> _obligation_) {
