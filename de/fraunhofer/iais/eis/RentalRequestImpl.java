...
/** 
* "Sales Request"@en
* "The ContractRequest class representing the \'Data Rental\' policy class."@en 
*/
@JsonIgnoreProperties(ignoreUnknown = true)
@JsonTypeName("ids:RentalRequest")
public class RentalRequestImpl implements Serializable, RentalRequest {
	...
	@JsonIgnore
	protected List<TypedLiteral> comment = Arrays.asList(new TypedLiteral("The ContractRequest class representing the 'Data Rental' policy class.", "en"));
	...
	*/
	...
	protected RentalRequestImpl() {
		id = VocabUtil.getInstance().createRandomUrl("rentalRequest");
	}
	...
	public boolean equals(Object obj) {
		if (this == obj) {
			...
			RentalRequestImpl other = (RentalRequestImpl) obj;
