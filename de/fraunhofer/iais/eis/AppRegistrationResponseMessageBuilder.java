...
public class AppRegistrationResponseMessageBuilder {
	...
	*/
	final public AppRegistrationResponseMessageBuilder _recipientConnector_(ArrayList<? extends URI> _recipientConnector_) {
	...
	*/
	final public AppRegistrationResponseMessageBuilder _recipientAgent_(ArrayList<? extends URI> _recipientAgent_) {
