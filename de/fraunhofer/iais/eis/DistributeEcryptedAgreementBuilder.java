...
public class DistributeEcryptedAgreementBuilder {
	...
	*/
	final public DistributeEcryptedAgreementBuilder _permission_(List<Permission> _permission_) {
	...
	*/
	final public DistributeEcryptedAgreementBuilder _prohibition_(List<Prohibition> _prohibition_) {
	...
	*/
	final public DistributeEcryptedAgreementBuilder _obligation_(List<Duty> _obligation_) {
