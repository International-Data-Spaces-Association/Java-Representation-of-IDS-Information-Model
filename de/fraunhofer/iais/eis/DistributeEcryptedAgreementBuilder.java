...
public class DistributeEcryptedAgreementBuilder {
	...
	*/
	final public DistributeEcryptedAgreementBuilder _permission_(ArrayList<? extends Permission> _permission_) {
	...
	*/
	final public DistributeEcryptedAgreementBuilder _prohibition_(ArrayList<? extends Prohibition> _prohibition_) {
	...
	*/
	final public DistributeEcryptedAgreementBuilder _obligation_(ArrayList<? extends Duty> _obligation_) {
