...
/** 
* "Role-restricted Data Usage Request"@en
* "The ContractRequest class representing the \'Role-restricted Data Usage\' policy class."@en 
*/
@JsonIgnoreProperties(ignoreUnknown = true)
@JsonTypeName("ids:RolebasedRequest")
public class RolebasedRequestImpl implements Serializable, RolebasedRequest {
	...
	@JsonIgnore
	protected List<TypedLiteral> label = Arrays.asList(new TypedLiteral("Role-restricted Data Usage Request", "en"));

	//List of all comments of this class
	@JsonIgnore
	protected List<TypedLiteral> comment = Arrays.asList(new TypedLiteral("The ContractRequest class representing the 'Role-restricted Data Usage' policy class.", "en"));
	...
	*/
	...
	protected RolebasedRequestImpl() {
		id = VocabUtil.getInstance().createRandomUrl("rolebasedRequest");
	}
	...
	public boolean equals(Object obj) {
		if (this == obj) {
			...
			RolebasedRequestImpl other = (RolebasedRequestImpl) obj;
