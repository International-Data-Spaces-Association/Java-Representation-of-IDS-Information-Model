...
/** 
* "Sales Request"@en
* "The ContractRequest class representing the \'Data Swap\' policy class."@en 
*/
@JsonIgnoreProperties(ignoreUnknown = true)
@JsonTypeName("ids:SwapRequest")
public class SwapRequestImpl implements Serializable, SwapRequest {
	...
	@JsonIgnore
	protected List<TypedLiteral> comment = Arrays.asList(new TypedLiteral("The ContractRequest class representing the 'Data Swap' policy class.", "en"));
