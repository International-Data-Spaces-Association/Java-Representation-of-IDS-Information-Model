...
public interface RejectionMessage extends ResponseMessage {
	...
	*/
	...
	/**
	* This function returns a hash code value for the RejectionMessage for the benefit of e.g. hash tables.
	* @return a hash code value for the RejectionMessage
	*/
	public int hashCode();
	...
	* @return true if this RejectionMessage is the same as the obj argument; false otherwise.
	*/
