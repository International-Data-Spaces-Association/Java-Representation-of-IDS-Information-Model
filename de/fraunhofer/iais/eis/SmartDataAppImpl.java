...
/**
 * Default implementation of package de.fraunhofer.iais.eis.SmartDataApp
 * 
 * Smart DataApps are executing any kind of necessary data processing or transformation.
 */
@JsonIgnoreProperties(ignoreUnknown = true)
@JsonTypeName("ids:SmartDataApp")
public class SmartDataAppImpl implements SmartDataApp {
    ...
    protected List<TypedLiteral> comment =
        Arrays.asList(new TypedLiteral("Smart DataApps are executing any kind of necessary data processing or transformation.", "en"));
    ...
    public SmartDataApp deepCopy() {
        SmartDataAppBuilder builder = new SmartDataAppBuilder();
