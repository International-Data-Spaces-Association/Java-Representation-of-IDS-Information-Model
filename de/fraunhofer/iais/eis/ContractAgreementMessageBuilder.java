...
public class ContractAgreementMessageBuilder {
	...
	*/
	final public ContractAgreementMessageBuilder _recipientConnector_(List<URI> _recipientConnector_) {
	...
	*/
	final public ContractAgreementMessageBuilder _recipientAgent_(List<URI> _recipientAgent_) {
