...
public class ContractAgreementMessageBuilder {
	...
	*/
	final public ContractAgreementMessageBuilder _recipientConnector_(ArrayList<? extends URI> _recipientConnector_) {
	...
	*/
	final public ContractAgreementMessageBuilder _recipientAgent_(ArrayList<? extends URI> _recipientAgent_) {
