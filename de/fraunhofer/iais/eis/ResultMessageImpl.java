...
/** 
* "Result Message"@en
* "Result messages are intended to annotate the results of a query command. "@en 
*/
@JsonIgnoreProperties(ignoreUnknown = true)
@JsonTypeName("ids:ResultMessage")
public class ResultMessageImpl implements Serializable, ResultMessage {
	...
	@JsonIgnore
	protected List<TypedLiteral> label = Arrays.asList(new TypedLiteral("Result Message", "en"));

	//List of all comments of this class
	@JsonIgnore
	protected List<TypedLiteral> comment = Arrays.asList(new TypedLiteral("Result messages are intended to annotate the results of a query command. ", "en"));
	...
	*/
	...
	protected ResultMessageImpl() {
		id = VocabUtil.getInstance().createRandomUrl("resultMessage");
	}
	...
	public boolean equals(Object obj) {
		if (this == obj) {
			...
			ResultMessageImpl other = (ResultMessageImpl) obj;
