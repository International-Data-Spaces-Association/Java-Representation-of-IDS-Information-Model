...
public class SalesOfferImpl implements Serializable, SalesOffer {
	...
	@JsonIgnore
	protected List<TypedLiteral> comment = Arrays.asList(new TypedLiteral("The ContractOffer class representing the 'Perpetual Data Sale' policy class.", "en"));
	...
	*/
	...
	public boolean equals(Object obj) {
		if (this == obj) {
			...
			SalesOfferImpl other = (SalesOfferImpl) obj;
