...
/**
 * Default implementation of package de.fraunhofer.iais.eis.SalesOffer
 * 
 * The ContractOffer class representing the 'Perpetual Data Sale' policy class.
 */
@JsonIgnoreProperties(ignoreUnknown = true)
@JsonTypeName("ids:SalesOffer")
public class SalesOfferImpl implements SalesOffer {
    ...
    protected List<TypedLiteral> comment =
        Arrays.asList(new TypedLiteral("The ContractOffer class representing the 'Perpetual Data Sale' policy class.", "en"));
    ...
    public SalesOffer deepCopy() {
        SalesOfferBuilder builder = new SalesOfferBuilder();
