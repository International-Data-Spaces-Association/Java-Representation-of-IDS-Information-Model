...
/** 
	...
	"The ContractOffer class representing the \'Perpetual Data Sale\' policy class."@en */
@JsonIgnoreProperties(ignoreUnknown = true)
@JsonTypeName("ids:SalesOffer")
public class SalesOfferImpl implements Serializable, SalesOffer {
	...
	@JsonIgnore
	java.util.List<TypedLiteral> comment = Arrays.asList(new TypedLiteral("The ContractOffer class representing the 'Perpetual Data Sale' policy class.", "en"));
	...
	*/
	...
	SalesOfferImpl() {
		id = VocabUtil.getInstance().createRandomUrl("salesOffer");
	}
