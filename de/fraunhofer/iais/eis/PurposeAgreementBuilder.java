...
public class PurposeAgreementBuilder {
	...
	*/
	final public PurposeAgreementBuilder _permission_(List<Permission> _permission_) {
	...
	*/
	final public PurposeAgreementBuilder _prohibition_(List<Prohibition> _prohibition_) {
	...
	*/
	final public PurposeAgreementBuilder _obligation_(List<Duty> _obligation_) {
