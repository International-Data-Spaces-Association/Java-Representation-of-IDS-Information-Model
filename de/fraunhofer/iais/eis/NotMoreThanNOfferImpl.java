...
public class NotMoreThanNOfferImpl implements Serializable, NotMoreThanNOffer {
	...
	@JsonIgnore
	protected List<TypedLiteral> comment = Arrays.asList(new TypedLiteral("The ContractOffer class representing the 'Restricted Number of Usages' policy class.", "en"));
