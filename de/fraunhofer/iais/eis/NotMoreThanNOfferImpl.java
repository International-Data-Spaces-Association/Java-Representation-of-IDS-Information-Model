...
/** 
	...
	"The ContractOffer class representing the \'Restricted Number of Usages\' policy class."@en */
@JsonIgnoreProperties(ignoreUnknown = true)
@JsonTypeName("ids:NotMoreThanNOffer")
public class NotMoreThanNOfferImpl implements Serializable, NotMoreThanNOffer {
	...
	@JsonIgnore
	java.util.List<TypedLiteral> comment = Arrays.asList(new TypedLiteral("The ContractOffer class representing the 'Restricted Number of Usages' policy class.", "en"));
	...
	*/
	...
	NotMoreThanNOfferImpl() {
		id = VocabUtil.getInstance().createRandomUrl("notMoreThanNOffer");
	}
