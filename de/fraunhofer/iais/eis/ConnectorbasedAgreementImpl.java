...
/** 
* "Connector-restricted Data Usage Agreement"@en
* "The ContractAgreement class representing the \'Connector-restricted Data Usage\' policy class."@en 
*/
@JsonIgnoreProperties(ignoreUnknown = true)
@JsonTypeName("ids:ConnectorbasedAgreement")
public class ConnectorbasedAgreementImpl implements Serializable, ConnectorbasedAgreement {
	...
	@JsonIgnore
	protected List<TypedLiteral> label = Arrays.asList(new TypedLiteral("Connector-restricted Data Usage Agreement", "en"));

	//List of all comments of this class
	@JsonIgnore
	protected List<TypedLiteral> comment = Arrays.asList(new TypedLiteral("The ContractAgreement class representing the 'Connector-restricted Data Usage' policy class.", "en"));
	...
	*/
	...
	protected ConnectorbasedAgreementImpl() {
		id = VocabUtil.getInstance().createRandomUrl("connectorbasedAgreement");
	}
	...
	public boolean equals(Object obj) {
		if (this == obj) {
			...
			ConnectorbasedAgreementImpl other = (ConnectorbasedAgreementImpl) obj;
