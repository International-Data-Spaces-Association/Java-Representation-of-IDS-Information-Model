...
public class ConnectorbasedAgreementImpl implements Serializable, ConnectorbasedAgreement {
	...
	@JsonIgnore
	java.util.List<TypedLiteral> label = Arrays.asList(new TypedLiteral("Connector-restricted Data Usage Agreement", "en"));
	//List of all comments of this class
	@JsonIgnore
	java.util.List<TypedLiteral> comment = Arrays.asList(new TypedLiteral("The ContractAgreement class representing the 'Connector-restricted Data Usage' policy class.", "en"));
