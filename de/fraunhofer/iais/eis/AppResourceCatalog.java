...
public interface AppResourceCatalog extends Catalog {
	...
	*/
	...
	/**
	* This function returns a hash code value for the AppResourceCatalog for the benefit of e.g. hash tables.
	* @return a hash code value for the AppResourceCatalog
	*/
	public int hashCode();
	...
	* @return true if this AppResourceCatalog is the same as the obj argument; false otherwise.
	*/
