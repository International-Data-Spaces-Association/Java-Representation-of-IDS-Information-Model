...
/** 
* "Event-restricted Data Usage Offer"@en
* "The ContractOffer class representing the \'Event-restricted Usage Policy\' policy class."@en 
*/
@JsonIgnoreProperties(ignoreUnknown = true)
@JsonTypeName("ids:EventOffer")
public class EventOfferImpl implements Serializable, EventOffer {
	...
	@JsonIgnore
	protected List<TypedLiteral> label = Arrays.asList(new TypedLiteral("Event-restricted Data Usage Offer", "en"));

	//List of all comments of this class
	@JsonIgnore
	protected List<TypedLiteral> comment = Arrays.asList(new TypedLiteral("The ContractOffer class representing the 'Event-restricted Usage Policy' policy class.", "en"));
	...
	*/
	...
	protected EventOfferImpl() {
		id = VocabUtil.getInstance().createRandomUrl("eventOffer");
	}
	...
	public boolean equals(Object obj) {
		if (this == obj) {
			...
			EventOfferImpl other = (EventOfferImpl) obj;
