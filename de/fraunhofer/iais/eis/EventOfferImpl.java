...
public class EventOfferImpl implements Serializable, EventOffer {
	...
	@JsonIgnore
	java.util.List<TypedLiteral> label = Arrays.asList(new TypedLiteral("Event-restricted Data Usage Offer", "en"));
	//List of all comments of this class
	@JsonIgnore
	java.util.List<TypedLiteral> comment = Arrays.asList(new TypedLiteral("The ContractOffer class representing the 'Event-restricted Usage Policy' policy class.", "en"));
