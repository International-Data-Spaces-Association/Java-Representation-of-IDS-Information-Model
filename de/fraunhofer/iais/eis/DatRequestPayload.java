...
public interface DatRequestPayload extends JwtPayload {
	...
	*/
	...
	/**
	* This function returns a hash code value for the DatRequestPayload for the benefit of e.g. hash tables.
	* @return a hash code value for the DatRequestPayload
	*/
	public int hashCode();
	...
	* @return true if this DatRequestPayload is the same as the obj argument; false otherwise.
	*/
