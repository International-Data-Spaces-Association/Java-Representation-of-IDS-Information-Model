...
public class PurposeRequestBuilder implements Builder<PurposeRequest> {
    ...
    public PurposeRequestBuilder(URI id) {
        this();
     ...
     */
    public PurposeRequestBuilder _contractStart_(XMLGregorianCalendar _contractStart_) {
        this.purposeRequestImpl.setContractStart(_contractStart_);
        return this;
    }
     ...
     */
    public PurposeRequestBuilder _contractEnd_(XMLGregorianCalendar _contractEnd_) {
        this.purposeRequestImpl.setContractEnd(_contractEnd_);
        return this;
    }
     ...
     */
    public PurposeRequestBuilder _contractDate_(XMLGregorianCalendar _contractDate_) {
        this.purposeRequestImpl.setContractDate(_contractDate_);
        return this;
    }
     ...
     */
    public PurposeRequestBuilder _provider_(URI _provider_) {
        this.purposeRequestImpl.setProvider(_provider_);
        return this;
    }
     ...
     */
    public PurposeRequestBuilder _consumer_(URI _consumer_) {
        this.purposeRequestImpl.setConsumer(_consumer_);
        return this;
    }
     ...
     */
    public PurposeRequestBuilder _contractDocument_(TextResource _contractDocument_) {
        this.purposeRequestImpl.setContractDocument(_contractDocument_);
        return this;
    }
     ...
     */
    public PurposeRequestBuilder _contractAnnex_(Resource _contractAnnex_) {
        this.purposeRequestImpl.setContractAnnex(_contractAnnex_);
        return this;
    }
     ...
     */
    public PurposeRequestBuilder _permission_(List<Permission> _permission_) {
        this.purposeRequestImpl.setPermission(_permission_);
        return this;
    }
     ...
     * @return Builder object with new value for _permission
     */
    public PurposeRequestBuilder _permission_(Permission _permission_) {
        this.purposeRequestImpl.getPermission().add(_permission_);
        return this;
    }
     ...
     */
    public PurposeRequestBuilder _prohibition_(List<Prohibition> _prohibition_) {
        this.purposeRequestImpl.setProhibition(_prohibition_);
        return this;
    }
     ...
     * @return Builder object with new value for _prohibition
     */
    public PurposeRequestBuilder _prohibition_(Prohibition _prohibition_) {
        this.purposeRequestImpl.getProhibition().add(_prohibition_);
        return this;
    }
     ...
     */
    public PurposeRequestBuilder _obligation_(List<Duty> _obligation_) {
        this.purposeRequestImpl.setObligation(_obligation_);
        return this;
    }
     ...
     * @return Builder object with new value for _obligation
     */
    public PurposeRequestBuilder _obligation_(Duty _obligation_) {
        this.purposeRequestImpl.getObligation().add(_obligation_);
        return this;
    }
     ...
     */
    @Override
    public PurposeRequest build() throws ConstraintViolationException {
