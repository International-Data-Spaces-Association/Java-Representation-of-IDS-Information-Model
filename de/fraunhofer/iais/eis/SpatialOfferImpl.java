...
/** 
* "Spatial Usage Offer"@en
* "The ContractOffer class representing the \'Location Restricted Usage\' policy class."@en 
*/
@JsonIgnoreProperties(ignoreUnknown = true)
@JsonTypeName("ids:SpatialOffer")
public class SpatialOfferImpl implements Serializable, SpatialOffer {
	...
	@JsonIgnore
	protected List<TypedLiteral> label = Arrays.asList(new TypedLiteral("Spatial Usage Offer", "en"));

	//List of all comments of this class
	@JsonIgnore
	protected List<TypedLiteral> comment = Arrays.asList(new TypedLiteral("The ContractOffer class representing the 'Location Restricted Usage' policy class.", "en"));
	...
	*/
	...
	protected SpatialOfferImpl() {
		id = VocabUtil.getInstance().createRandomUrl("spatialOffer");
	}
	...
	public boolean equals(Object obj) {
		if (this == obj) {
			...
			SpatialOfferImpl other = (SpatialOfferImpl) obj;
