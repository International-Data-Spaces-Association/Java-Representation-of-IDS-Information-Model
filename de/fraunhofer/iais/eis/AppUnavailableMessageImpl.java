...
public class AppUnavailableMessageImpl implements Serializable, AppUnavailableMessage {
	...
	@JsonIgnore
	java.util.List<TypedLiteral> label = Arrays.asList(new TypedLiteral("App Unavailable Message", "en"));
	//List of all comments of this class
	@JsonIgnore
	java.util.List<TypedLiteral> comment = Arrays.asList(new TypedLiteral("Message indicating that a specific App should be unavailable in the AppStore.", "en"));
