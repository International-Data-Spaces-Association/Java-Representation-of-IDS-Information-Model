...
/** 
* "App Unavailable Message"@en
* "Message indicating that a specific App should be unavailable in the AppStore."@en 
*/
@JsonIgnoreProperties(ignoreUnknown = true)
@JsonTypeName("ids:AppUnavailableMessage")
public class AppUnavailableMessageImpl implements Serializable, AppUnavailableMessage {
	...
	@JsonIgnore
	protected List<TypedLiteral> comment = Arrays.asList(new TypedLiteral("Message indicating that a specific App should be unavailable in the AppStore.", "en"));
