...
public interface DataRepresentation extends Representation {
	...
	*/
	...
	/**
	* This function returns a hash code value for the DataRepresentation for the benefit of e.g. hash tables.
	* @return a hash code value for the DataRepresentation
	*/
	public int hashCode();
	...
	* @return true if this DataRepresentation is the same as the obj argument; false otherwise.
	*/
