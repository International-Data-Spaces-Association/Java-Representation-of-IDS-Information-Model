...
* "Message containing a suggested content contract (as offered by the data consumer to the data provider) in the associated payload (which is an instance of ids:ContractRequest)."@en 
*/
@JsonIgnoreProperties(ignoreUnknown = true)
@JsonTypeName("ids:ContractRequestMessage")
public class ContractRequestMessageImpl implements ContractRequestMessage {
	...
	@JsonIgnore
	protected List<TypedLiteral> label = Arrays.asList(new TypedLiteral("Contract Request Message", "en"));

	//List of all comments of this class
	@JsonIgnore
	protected List<TypedLiteral> comment = Arrays.asList(new TypedLiteral("Message containing a suggested content contract (as offered by the data consumer to the data provider) in the associated payload (which is an instance of ids:ContractRequest).", "en"));
	...
	*/
	...
	protected ContractRequestMessageImpl() {
	...
	public boolean equals(Object obj) {
		if (this == obj) {
			...
			ContractRequestMessageImpl other = (ContractRequestMessageImpl) obj;
