...
public class SwapOfferBuilder {
	...
	*/
	final public SwapOfferBuilder _permission_(ArrayList<? extends Permission> _permission_) {
	...
	*/
	final public SwapOfferBuilder _prohibition_(ArrayList<? extends Prohibition> _prohibition_) {
	...
	*/
	final public SwapOfferBuilder _obligation_(ArrayList<? extends Duty> _obligation_) {
	...
	*/
	...
	final public SwapOffer build() throws ConstraintViolationException {
