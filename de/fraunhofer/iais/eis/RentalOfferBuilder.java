...
public class RentalOfferBuilder {
	...
	*/
	final public RentalOfferBuilder _permission_(ArrayList<? extends Permission> _permission_) {
	...
	*/
	final public RentalOfferBuilder _prohibition_(ArrayList<? extends Prohibition> _prohibition_) {
	...
	*/
	final public RentalOfferBuilder _obligation_(ArrayList<? extends Duty> _obligation_) {
	...
	*/
	...
	final public RentalOffer build() throws ConstraintViolationException {
