...
public class RentalOfferBuilder {
	...
	*/
	final public RentalOfferBuilder _permission_(List<Permission> _permission_) {
	...
	*/
	final public RentalOfferBuilder _prohibition_(List<Prohibition> _prohibition_) {
	...
	*/
	final public RentalOfferBuilder _obligation_(List<Duty> _obligation_) {
