...
public interface ParticipantRequestMessage extends RequestMessage {
	...
	*/
	...
	/**
	* This function returns a hash code value for the ParticipantRequestMessage for the benefit of e.g. hash tables.
	* @return a hash code value for the ParticipantRequestMessage
	*/
	public int hashCode();
	...
	* @return true if this ParticipantRequestMessage is the same as the obj argument; false otherwise.
	*/
