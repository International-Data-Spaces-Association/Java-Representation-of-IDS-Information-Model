...
/** 
* "App execution resources"@en
* "Resource control for deployed services."@en 
*/
...
public enum AppExecutionResources {
	...
	*/
	...
	private static final Map<String,AppExecutionResources> uriInstanceMapping;
	static {
	...
	AppExecutionResources(String id, List<TypedLiteral> label, List<TypedLiteral> comment) {
		try {
			this.id = new URI(id);
			this.label = label;
	...
	*/
	...
	@JsonCreator
	public static AppExecutionResources deserialize(JsonNode node) {
