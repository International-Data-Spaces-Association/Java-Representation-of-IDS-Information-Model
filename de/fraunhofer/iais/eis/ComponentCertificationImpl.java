...
public class ComponentCertificationImpl implements Serializable, ComponentCertification {
	...
	@JsonIgnore
	java.util.List<TypedLiteral> label = Arrays.asList(new TypedLiteral("Component Certification", "en"));
	//List of all comments of this class
	@JsonIgnore
	java.util.List<TypedLiteral> comment = Arrays.asList(new TypedLiteral("Process and result of certifying a software component/servivce in order to become a certified part of the International Data Space infrastructure.", "en"));
