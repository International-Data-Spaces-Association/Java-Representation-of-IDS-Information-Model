...
public class ParticipantUpdateMessageImpl implements Serializable, ParticipantUpdateMessage {
	...
	@JsonIgnore
	protected List<TypedLiteral> label = Arrays.asList(new TypedLiteral("Participant Available Message", "en"));

	//List of all comments of this class
	@JsonIgnore
	protected List<TypedLiteral> comment = Arrays.asList(new TypedLiteral("Event notifying the recipient(s) about the availability and current description of a participant. The payload of the message must contain the participant's self-description.", "en"));
	...
	*/
	...
	protected ParticipantUpdateMessageImpl() {
	...
	public boolean equals(Object obj) {
		if (this == obj) {
			...
			ParticipantUpdateMessageImpl other = (ParticipantUpdateMessageImpl) obj;
