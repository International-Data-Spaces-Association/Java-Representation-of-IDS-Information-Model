...
/** 
	"Participant Available Message"@en

	"Event notifying the recipient(s) about the availability and current description of a participant. The payload of the message must contain the participant\'s self-description."@en */
@JsonIgnoreProperties(ignoreUnknown = true)
@JsonTypeName("ids:ParticipantUpdateMessage")
public class ParticipantUpdateMessageImpl implements Serializable, ParticipantUpdateMessage {
	...
	@JsonIgnore
	java.util.List<TypedLiteral> label = Arrays.asList(new TypedLiteral("Participant Available Message", "en"));
	//List of all comments of this class
	@JsonIgnore
	java.util.List<TypedLiteral> comment = Arrays.asList(new TypedLiteral("Event notifying the recipient(s) about the availability and current description of a participant. The payload of the message must contain the participant's self-description.", "en"));
	...
	*/
	...
	ParticipantUpdateMessageImpl() {
		id = VocabUtil.getInstance().createRandomUrl("participantUpdateMessage");
	}
