...
public class ResourceUpdateMessageBuilder {
	...
	*/
	final public ResourceUpdateMessageBuilder _recipientConnector_(List<URI> _recipientConnector_) {
	...
	*/
	final public ResourceUpdateMessageBuilder _recipientAgent_(List<URI> _recipientAgent_) {
