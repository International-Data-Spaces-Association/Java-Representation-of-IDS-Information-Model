...
public class ResourceUpdateMessageBuilder {
	...
	*/
	final public ResourceUpdateMessageBuilder _recipientConnector_(ArrayList<? extends URI> _recipientConnector_) {
	...
	*/
	final public ResourceUpdateMessageBuilder _recipientAgent_(ArrayList<? extends URI> _recipientAgent_) {
	...
	*/
	...
	final public ResourceUpdateMessage build() throws ConstraintViolationException {
