...
/** 
* "Distribute Encrypted Agreement"@en
* "The ContractAgreement class representing the \'Distribute only if Encrypted\' policy class."@en 
*/
@JsonIgnoreProperties(ignoreUnknown = true)
@JsonTypeName("ids:DistributeEcryptedAgreement")
public class DistributeEcryptedAgreementImpl implements Serializable, DistributeEcryptedAgreement {
	...
	@JsonIgnore
	protected List<TypedLiteral> label = Arrays.asList(new TypedLiteral("Distribute Encrypted Agreement", "en"));

	//List of all comments of this class
	@JsonIgnore
	protected List<TypedLiteral> comment = Arrays.asList(new TypedLiteral("The ContractAgreement class representing the 'Distribute only if Encrypted' policy class.", "en"));
	...
	*/
	...
	protected DistributeEcryptedAgreementImpl() {
		id = VocabUtil.getInstance().createRandomUrl("distributeEcryptedAgreement");
	}
	...
	public boolean equals(Object obj) {
		if (this == obj) {
			...
			DistributeEcryptedAgreementImpl other = (DistributeEcryptedAgreementImpl) obj;
