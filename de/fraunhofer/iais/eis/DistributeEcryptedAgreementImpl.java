...
public class DistributeEcryptedAgreementImpl implements Serializable, DistributeEcryptedAgreement {
	...
	@JsonIgnore
	java.util.List<TypedLiteral> label = Arrays.asList(new TypedLiteral("Distribute Encrypted Agreement", "en"));
	//List of all comments of this class
	@JsonIgnore
	java.util.List<TypedLiteral> comment = Arrays.asList(new TypedLiteral("The ContractAgreement class representing the 'Distribute only if Encrypted' policy class.", "en"));
	...
	*/
	...
	DistributeEcryptedAgreementImpl() {
