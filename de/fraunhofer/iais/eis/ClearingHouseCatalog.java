...
public interface ClearingHouseCatalog extends Catalog {
	...
	*/
	...
	/**
	* This function returns a hash code value for the ClearingHouseCatalog for the benefit of e.g. hash tables.
	* @return a hash code value for the ClearingHouseCatalog
	*/
	public int hashCode();
	...
	* @return true if this ClearingHouseCatalog is the same as the obj argument; false otherwise.
	*/
