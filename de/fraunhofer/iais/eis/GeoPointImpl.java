...
public class GeoPointImpl implements Serializable, GeoPoint {
	...
	@JsonIgnore
	java.util.List<TypedLiteral> label = Arrays.asList(new TypedLiteral("GeoPoint", "en"));
	//List of all comments of this class
	@JsonIgnore
	java.util.List<TypedLiteral> comment = Arrays.asList(new TypedLiteral("A location identified by geo coordinates.", "en"));
	...
	*/
	@NotNull@JsonAlias({"ids:latitude", "latitude"})
	 float _latitude;
	...
	*/
	@NotNull@JsonAlias({"ids:longitude", "longitude"})
	 float _longitude;
