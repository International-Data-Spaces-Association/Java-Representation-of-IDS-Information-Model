...
public class BoundingPolygonImpl implements Serializable, BoundingPolygon {
	...
	@JsonIgnore
	java.util.List<TypedLiteral> label = Arrays.asList(new TypedLiteral("BoundingPolygon", "en"));
	//List of all comments of this class
	@JsonIgnore
	java.util.List<TypedLiteral> comment = Arrays.asList(new TypedLiteral("Defines an area of interest as a set of connected points.", "en"));
	...
	*/
	@NotEmpty@JsonAlias({"ids:geoPoint", "geoPoint"})
	 java.util.ArrayList<? extends GeoPoint> _geoPoint;
	...
	final public void setGeoPoint (java.util.ArrayList<? extends GeoPoint> _geoPoint_) {
