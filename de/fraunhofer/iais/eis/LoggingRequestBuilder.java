...
public class LoggingRequestBuilder {
	...
	*/
	final public LoggingRequestBuilder _permission_(List<Permission> _permission_) {
	...
	*/
	final public LoggingRequestBuilder _prohibition_(List<Prohibition> _prohibition_) {
	...
	*/
	final public LoggingRequestBuilder _obligation_(List<Duty> _obligation_) {
	...
	*/
	...
	final public LoggingRequest build() throws ConstraintViolationException {
