...
/**
 * Default implementation of package de.fraunhofer.iais.eis.TextResource
 * 
...
public class TextResourceImpl implements TextResource {
    ...
    @JsonIgnore
    protected List<TypedLiteral> label = Arrays.asList(new TypedLiteral("Text Resource", "en"));

    // List of all comments of this class
    @JsonIgnore
    protected List<TypedLiteral> comment =
        Arrays.asList(new TypedLiteral("Resource (at least partially) comprising textual content.", "en"));
    ...
    public boolean equals(Object obj) {
        if (this == obj) {
            ...
            TextResourceImpl other = (TextResourceImpl) obj;
