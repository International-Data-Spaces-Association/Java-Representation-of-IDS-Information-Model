...
/** 
* "Delete After Interval Agreement"@en
* "The ContractAgreement class representing the \'Interval-restricted Data Usage\' policy class with the further obligation to delete the data."@en 
*/
@JsonIgnoreProperties(ignoreUnknown = true)
@JsonTypeName("ids:DeleteAfterIntervalAgreement")
public class DeleteAfterIntervalAgreementImpl implements Serializable, DeleteAfterIntervalAgreement {
	...
	@JsonIgnore
	protected List<TypedLiteral> label = Arrays.asList(new TypedLiteral("Delete After Interval Agreement", "en"));

	//List of all comments of this class
	@JsonIgnore
	protected List<TypedLiteral> comment = Arrays.asList(new TypedLiteral("The ContractAgreement class representing the 'Interval-restricted Data Usage' policy class with the further obligation to delete the data.", "en"));
	...
	*/
	...
	protected DeleteAfterIntervalAgreementImpl() {
		id = VocabUtil.getInstance().createRandomUrl("deleteAfterIntervalAgreement");
	}
	...
	public boolean equals(Object obj) {
		if (this == obj) {
			...
			DeleteAfterIntervalAgreementImpl other = (DeleteAfterIntervalAgreementImpl) obj;
