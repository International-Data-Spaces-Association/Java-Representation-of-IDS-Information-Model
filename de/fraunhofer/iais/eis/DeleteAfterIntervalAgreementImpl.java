...
public class DeleteAfterIntervalAgreementImpl implements Serializable, DeleteAfterIntervalAgreement {
	...
	@JsonIgnore
	java.util.List<TypedLiteral> label = Arrays.asList(new TypedLiteral("Delete After Interval Agreement", "en"));
	//List of all comments of this class
	@JsonIgnore
	java.util.List<TypedLiteral> comment = Arrays.asList(new TypedLiteral("The ContractAgreement class representing the 'Interval-restricted Data Usage' policy class with the further obligation to delete the data.", "en"));
	...
	*/
	...
	DeleteAfterIntervalAgreementImpl() {
