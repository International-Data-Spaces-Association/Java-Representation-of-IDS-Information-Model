...
public enum IntegrityVerificationScopeGuarantee implements ModelClass {
    ...
    */
    ...
    IntegrityVerificationScopeGuarantee(String id, List<TypedLiteral> label, List<TypedLiteral> comment) {
        try {
            this.id = new URI(id);
            this.label = label;
