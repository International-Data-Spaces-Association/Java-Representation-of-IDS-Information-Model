...
/** 
* "Participant Certificate Revoked Message"@en
* "Indicates that a (previously certified) Participant is no more certified. This could happen, for instance, if the Certification Body revokes a granted certificate or if the certificate just expires."@en 
*/
@JsonIgnoreProperties(ignoreUnknown = true)
@JsonTypeName("ids:ParticipantCertificateRevokedMessage")
public class ParticipantCertificateRevokedMessageImpl implements Serializable, ParticipantCertificateRevokedMessage {
	...
	@JsonIgnore
	protected List<TypedLiteral> label = Arrays.asList(new TypedLiteral("Participant Certificate Revoked Message", "en"));

	//List of all comments of this class
	@JsonIgnore
	protected List<TypedLiteral> comment = Arrays.asList(new TypedLiteral("Indicates that a (previously certified) Participant is no more certified. This could happen, for instance, if the Certification Body revokes a granted certificate or if the certificate just expires.", "en"));
	...
	*/
	...
	protected ParticipantCertificateRevokedMessageImpl() {
		id = VocabUtil.getInstance().createRandomUrl("participantCertificateRevokedMessage");
	}
	...
	public int hashCode() {
		return Objects.hash(new Object[]{this._revocationReason,
	...
	public boolean equals(Object obj) {
		if (this == obj) {
			...
			ParticipantCertificateRevokedMessageImpl other = (ParticipantCertificateRevokedMessageImpl) obj;
			return Objects.equals(this._revocationReason, other._revocationReason) &&
				Objects.equals(this._affectedParticipant, other._affectedParticipant) &&
	...
	final public TypedLiteral getRevocationReason() {
		return _revocationReason;
	}
	
	final public void setRevocationReason (TypedLiteral _revocationReason_) {
