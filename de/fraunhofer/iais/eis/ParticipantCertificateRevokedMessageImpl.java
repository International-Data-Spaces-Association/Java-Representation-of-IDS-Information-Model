...
public class ParticipantCertificateRevokedMessageImpl implements Serializable, ParticipantCertificateRevokedMessage {
	...
	@JsonIgnore
	java.util.List<TypedLiteral> label = Arrays.asList(new TypedLiteral("Participant Certificate Revoked Message", "en"));
	//List of all comments of this class
	@JsonIgnore
	java.util.List<TypedLiteral> comment = Arrays.asList(new TypedLiteral("Indicates that a (previously certified) Participant is no more certified. This could happen, for instance, if the Certification Body revokes a granted certificate or if the certificate just expires.", "en"));
	...
	*/
	@NotNull@JsonAlias({"ids:affectedParticipant", "affectedParticipant"})
	 URI _affectedParticipant;
	...
	*/
	...
	ParticipantCertificateRevokedMessageImpl() {
