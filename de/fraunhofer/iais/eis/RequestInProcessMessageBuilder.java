...
public class RequestInProcessMessageBuilder {
	...
	*/
	final public RequestInProcessMessageBuilder _recipientConnector_(ArrayList<? extends URI> _recipientConnector_) {
	...
	*/
	final public RequestInProcessMessageBuilder _recipientAgent_(ArrayList<? extends URI> _recipientAgent_) {
