...
public class RequestInProcessMessageBuilder {
	...
	*/
	final public RequestInProcessMessageBuilder _recipientConnector_(List<URI> _recipientConnector_) {
	...
	*/
	final public RequestInProcessMessageBuilder _recipientAgent_(List<URI> _recipientAgent_) {
