...
/** 
* "App Registration Response Message"@en
* "Message that follows up an AppRegistrationRequestMessage and contains the app registration confimation."@en 
*/
@JsonIgnoreProperties(ignoreUnknown = true)
@JsonTypeName("ids:AppRegistrationResponseMessage")
public class AppRegistrationResponseMessageImpl implements Serializable, AppRegistrationResponseMessage {
	...
	@JsonIgnore
	protected List<TypedLiteral> comment = Arrays.asList(new TypedLiteral("Message that follows up an AppRegistrationRequestMessage and contains the app registration confimation.", "en"));
