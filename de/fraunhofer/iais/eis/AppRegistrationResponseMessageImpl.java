...
public class AppRegistrationResponseMessageImpl implements Serializable, AppRegistrationResponseMessage {
	...
	@JsonIgnore
	java.util.List<TypedLiteral> label = Arrays.asList(new TypedLiteral("App Registration Response Message", "en"));
	//List of all comments of this class
	@JsonIgnore
	java.util.List<TypedLiteral> comment = Arrays.asList(new TypedLiteral("Message that follows up an AppRegistrationRequestMessage and contains the app registration confimation.", "en"));
	...
	*/
	...
	AppRegistrationResponseMessageImpl() {
