...
/**
 * Default implementation of package de.fraunhofer.iais.eis.ContractRejectionMessage
 * 
 * Message indicating rejection of a contract.
 */
@JsonIgnoreProperties(ignoreUnknown = true)
@JsonTypeName("ids:ContractRejectionMessage")
public class ContractRejectionMessageImpl implements ContractRejectionMessage {
    ...
    @Override
    public int hashCode() {
        return Objects.hash(this._contractRejectionReason,
    ...
    public boolean equals(Object obj) {
        if (this == obj) {
            ...
            ContractRejectionMessageImpl other = (ContractRejectionMessageImpl) obj;
            return Objects.equals(this._contractRejectionReason, other._contractRejectionReason) &&
                Objects.equals(this._rejectionReason, other._rejectionReason) &&
    ...
    public ContractRejectionMessage deepCopy() {
        ContractRejectionMessageBuilder builder = new ContractRejectionMessageBuilder();
        if (this._contractRejectionReason != null && this._contractRejectionReason.getLanguage() != null) {
            builder._contractRejectionReason_(
                new TypedLiteral(this._contractRejectionReason.getValue(), this._contractRejectionReason.getLanguage()));
        } else {
            builder._contractRejectionReason_(
                new TypedLiteral(this._contractRejectionReason.getValue(), URI.create(this._contractRejectionReason.getType())));
        }
