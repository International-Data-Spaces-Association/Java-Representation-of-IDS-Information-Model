...
public class RejectionMessageImpl implements Serializable, RejectionMessage {
	...
	@JsonIgnore
	protected List<TypedLiteral> comment = Arrays.asList(new TypedLiteral("Rejection messages are specialized response messages that notify the sender of a message that processing of this message has failed.", "en"));
	...
	*/
	...
	public int hashCode() {
		return Objects.hash(new Object[]{this._rejectionReason,
			this._modelVersion,
			this._issued,
