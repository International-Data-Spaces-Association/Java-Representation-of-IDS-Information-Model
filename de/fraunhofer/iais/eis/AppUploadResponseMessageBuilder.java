...
public class AppUploadResponseMessageBuilder {
	...
	*/
	final public AppUploadResponseMessageBuilder _recipientConnector_(ArrayList<? extends URI> _recipientConnector_) {
	...
	*/
	final public AppUploadResponseMessageBuilder _recipientAgent_(ArrayList<? extends URI> _recipientAgent_) {
