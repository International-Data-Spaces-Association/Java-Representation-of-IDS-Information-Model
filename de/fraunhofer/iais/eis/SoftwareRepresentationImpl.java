...
/**
 * Default implementation of package de.fraunhofer.iais.eis.SoftwareRepresentation
 * 
 * Software representation
 */
@JsonIgnoreProperties(ignoreUnknown = true)
@JsonTypeName("ids:SoftwareRepresentation")
public class SoftwareRepresentationImpl implements SoftwareRepresentation {
    ...
    @JsonIgnore
    protected List<TypedLiteral> label = Arrays.asList(new TypedLiteral("Software Representation", "en"));

    // List of all comments of this class
    @JsonIgnore
    protected List<TypedLiteral> comment = Arrays.asList(new TypedLiteral("Software representation", "en"));
    ...
    protected SoftwareRepresentationImpl() {
    ...
    @Override
    public int hashCode() {
        return Objects.hash(this._instance,
            this._mediaType,
    ...
    public boolean equals(Object obj) {
        if (this == obj) {
            ...
            SoftwareRepresentationImpl other = (SoftwareRepresentationImpl) obj;
            return Objects.equals(this._instance, other._instance) &&
    ...
    public SoftwareRepresentation deepCopy() {
        SoftwareRepresentationBuilder builder = new SoftwareRepresentationBuilder();
