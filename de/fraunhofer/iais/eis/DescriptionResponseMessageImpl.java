...
/** 
* "Description Response Message"@en
* "Message containing the metadata, which a Connector previously requested via the ids:DescriptionRequestMessage, in its payload."@en 
*/
@JsonIgnoreProperties(ignoreUnknown = true)
@JsonTypeName("ids:DescriptionResponseMessage")
public class DescriptionResponseMessageImpl implements Serializable, DescriptionResponseMessage {
	...
	@JsonIgnore
	protected List<TypedLiteral> label = Arrays.asList(new TypedLiteral("Description Response Message", "en"));

	//List of all comments of this class
	@JsonIgnore
	protected List<TypedLiteral> comment = Arrays.asList(new TypedLiteral("Message containing the metadata, which a Connector previously requested via the ids:DescriptionRequestMessage, in its payload.", "en"));
	...
	*/
	...
	protected DescriptionResponseMessageImpl() {
		id = VocabUtil.getInstance().createRandomUrl("descriptionResponseMessage");
	}
	...
	public boolean equals(Object obj) {
		if (this == obj) {
			...
			DescriptionResponseMessageImpl other = (DescriptionResponseMessageImpl) obj;
