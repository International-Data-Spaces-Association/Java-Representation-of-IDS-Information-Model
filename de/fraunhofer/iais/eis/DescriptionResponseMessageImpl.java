...
public class DescriptionResponseMessageImpl implements Serializable, DescriptionResponseMessage {
	...
	@JsonIgnore
	java.util.List<TypedLiteral> label = Arrays.asList(new TypedLiteral("Description Response Message", "en"));
	//List of all comments of this class
	@JsonIgnore
	java.util.List<TypedLiteral> comment = Arrays.asList(new TypedLiteral("Message containing the metadata, which a Connector previously requested via the ids:DescriptionRequestMessage, in its payload.", "en"));
	...
	*/
	...
	DescriptionResponseMessageImpl() {
