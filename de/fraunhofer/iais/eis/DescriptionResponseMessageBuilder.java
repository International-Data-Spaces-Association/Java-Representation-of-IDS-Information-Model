...
public class DescriptionResponseMessageBuilder {
	...
	*/
	final public DescriptionResponseMessageBuilder _recipientConnector_(List<URI> _recipientConnector_) {
	...
	*/
	final public DescriptionResponseMessageBuilder _recipientAgent_(List<URI> _recipientAgent_) {
