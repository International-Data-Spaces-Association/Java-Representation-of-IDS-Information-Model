...
public class DescriptionResponseMessageBuilder {
	...
	*/
	final public DescriptionResponseMessageBuilder _recipientConnector_(ArrayList<? extends URI> _recipientConnector_) {
	...
	*/
	final public DescriptionResponseMessageBuilder _recipientAgent_(ArrayList<? extends URI> _recipientAgent_) {
