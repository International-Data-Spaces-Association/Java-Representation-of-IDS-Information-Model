...
public interface ContractAgreement extends Contract {
	...
	*/
	...
	/**
	* This function returns a hash code value for the ContractAgreement for the benefit of e.g. hash tables.
	* @return a hash code value for the ContractAgreement
	*/
	public int hashCode();
	...
	* @return true if this ContractAgreement is the same as the obj argument; false otherwise.
	*/
