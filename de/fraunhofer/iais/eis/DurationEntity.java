...
public interface DurationEntity extends TemporalEntity {
	...
	*/
	...
	/**
	* This function returns a hash code value for the DurationEntity for the benefit of e.g. hash tables.
	* @return a hash code value for the DurationEntity
	*/
	public int hashCode();
	...
	* @return true if this DurationEntity is the same as the obj argument; false otherwise.
	*/
