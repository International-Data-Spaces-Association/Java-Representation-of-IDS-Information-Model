...
public class ContractAgreementImpl implements Serializable, ContractAgreement {
	...
	@JsonIgnore
	protected List<TypedLiteral> comment = Arrays.asList(new TypedLiteral("Contract governing the actual usage of a Resource that has been agreed by all parties.", "en"));
