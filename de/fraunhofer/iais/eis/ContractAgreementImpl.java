...
public class ContractAgreementImpl implements Serializable, ContractAgreement {
	...
	@JsonIgnore
	java.util.List<TypedLiteral> label = Arrays.asList(new TypedLiteral("Contract agreement", "en"));
	//List of all comments of this class
	@JsonIgnore
	java.util.List<TypedLiteral> comment = Arrays.asList(new TypedLiteral("Contract governing the actual usage of a Resource that has been agreed by all parties.", "en"));
