...
public class UploadResponseMessageBuilder {
	...
	*/
	final public UploadResponseMessageBuilder _recipientConnector_(ArrayList<? extends URI> _recipientConnector_) {
	...
	*/
	final public UploadResponseMessageBuilder _recipientAgent_(ArrayList<? extends URI> _recipientAgent_) {
	...
	*/
	...
	final public UploadResponseMessage build() throws ConstraintViolationException {
