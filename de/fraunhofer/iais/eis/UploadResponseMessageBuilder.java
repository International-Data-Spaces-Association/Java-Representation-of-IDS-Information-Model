...
public class UploadResponseMessageBuilder {
	...
	*/
	final public UploadResponseMessageBuilder _recipientConnector_(List<URI> _recipientConnector_) {
	...
	*/
	final public UploadResponseMessageBuilder _recipientAgent_(List<URI> _recipientAgent_) {
