...
/** 
* "Logging Agreement"@en
* "The ContractAgreement class representing the \'Local Logging\' policy class."@en 
*/
@JsonIgnoreProperties(ignoreUnknown = true)
@JsonTypeName("ids:LoggingAgreement")
public class LoggingAgreementImpl implements Serializable, LoggingAgreement {
	...
	@JsonIgnore
	protected List<TypedLiteral> label = Arrays.asList(new TypedLiteral("Logging Agreement", "en"));

	//List of all comments of this class
	@JsonIgnore
	protected List<TypedLiteral> comment = Arrays.asList(new TypedLiteral("The ContractAgreement class representing the 'Local Logging' policy class.", "en"));
	...
	*/
	...
	protected LoggingAgreementImpl() {
		id = VocabUtil.getInstance().createRandomUrl("loggingAgreement");
	}
	...
	public boolean equals(Object obj) {
		if (this == obj) {
			...
			LoggingAgreementImpl other = (LoggingAgreementImpl) obj;
