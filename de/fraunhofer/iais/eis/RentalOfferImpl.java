...
/** 
	...
	"The ContractOffer class representing the \'Data Rental\' policy class."@en */
@JsonIgnoreProperties(ignoreUnknown = true)
@JsonTypeName("ids:RentalOffer")
public class RentalOfferImpl implements Serializable, RentalOffer {
	...
	@JsonIgnore
	java.util.List<TypedLiteral> comment = Arrays.asList(new TypedLiteral("The ContractOffer class representing the 'Data Rental' policy class.", "en"));
	...
	*/
	...
	RentalOfferImpl() {
		id = VocabUtil.getInstance().createRandomUrl("rentalOffer");
	}
