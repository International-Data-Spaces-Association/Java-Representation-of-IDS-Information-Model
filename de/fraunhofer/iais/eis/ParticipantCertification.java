...
public interface ParticipantCertification extends Certification {
	...
	*/
	...
	/**
	* This function returns a hash code value for the ParticipantCertification for the benefit of e.g. hash tables.
	* @return a hash code value for the ParticipantCertification
	*/
	public int hashCode();
	...
	* @return true if this ParticipantCertification is the same as the obj argument; false otherwise.
	*/
