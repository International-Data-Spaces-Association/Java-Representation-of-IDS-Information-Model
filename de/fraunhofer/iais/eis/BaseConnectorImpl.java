...
/** 
	...
	"Implementation of the Connector specification providing only restricted security capabilities."@en */
...
public class BaseConnectorImpl implements Serializable, BaseConnector {
	...
	@JsonIgnore
	java.util.List<TypedLiteral> label = Arrays.asList(new TypedLiteral("Base Connector", "en"));
	//List of all comments of this class
	@JsonIgnore
	java.util.List<TypedLiteral> comment = Arrays.asList(new TypedLiteral("Implementation of the Connector specification providing only restricted security capabilities.", "en"));
