...
public interface GenericEndpoint extends Endpoint {
	...
	*/
	...
	/**
	* This function returns a hash code value for the GenericEndpoint for the benefit of e.g. hash tables.
	* @return a hash code value for the GenericEndpoint
	*/
	public int hashCode();
	...
	* @return true if this GenericEndpoint is the same as the obj argument; false otherwise.
	*/
