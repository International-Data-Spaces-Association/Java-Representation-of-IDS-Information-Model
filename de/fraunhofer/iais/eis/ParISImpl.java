...
public class ParISImpl implements Serializable, ParIS {
	...
	@JsonIgnore
	java.util.List<TypedLiteral> label = Arrays.asList(new TypedLiteral("Participant Information Service", "en"));
	//List of all comments of this class
	@JsonIgnore
	java.util.List<TypedLiteral> comment = Arrays.asList(new TypedLiteral("The Participant Information Service (ParIS) provides metadata and relevant information about participants (humans and organizations) in the International Data Spaces.", "en"));
	...
	*/
	@JsonAlias({"ids:participantCatalog", "participantCatalog"})
	 java.util.ArrayList<? extends ParticipantCatalog> _participantCatalog;
	...
	*/
	...
	final public void setParticipantCatalog (java.util.ArrayList<? extends ParticipantCatalog> _participantCatalog_) {
