...
public class ParISImpl implements Serializable, ParIS {
	...
	*/
	...
	protected ArrayList<? extends ParticipantCatalog> _participantCatalog;
	...
	*/
	...
	final public ArrayList<? extends ParticipantCatalog> getParticipantCatalog() {
	...
	/**
	* "List of participants a ParIS may expose."@en
	* @param _participantCatalog_ desired value for the property participantCatalog.
	* More information under https://w3id.org/idsa/core/participantCatalog
	*/
	final public void setParticipantCatalog (ArrayList<? extends ParticipantCatalog> _participantCatalog_) {
