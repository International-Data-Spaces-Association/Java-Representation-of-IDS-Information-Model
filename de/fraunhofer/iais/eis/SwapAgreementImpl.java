...
/** 
* "Swap Agreement"@en
* "The ContractAgreement class representing the \'Data Swap\' policy class."@en 
*/
@JsonIgnoreProperties(ignoreUnknown = true)
@JsonTypeName("ids:SwapAgreement")
public class SwapAgreementImpl implements Serializable, SwapAgreement {
	...
	@JsonIgnore
	protected List<TypedLiteral> comment = Arrays.asList(new TypedLiteral("The ContractAgreement class representing the 'Data Swap' policy class.", "en"));
