...
/** 
* "Use Not More Than N Times Agreement"@en
* "The ContractAgreement class representing the \'Restricted Number of Usages\' policy class."@en 
*/
@JsonIgnoreProperties(ignoreUnknown = true)
@JsonTypeName("ids:NotMoreThanNAgreement")
public class NotMoreThanNAgreementImpl implements Serializable, NotMoreThanNAgreement {
	...
	@JsonIgnore
	protected List<TypedLiteral> label = Arrays.asList(new TypedLiteral("Use Not More Than N Times Agreement", "en"));

	//List of all comments of this class
	@JsonIgnore
	protected List<TypedLiteral> comment = Arrays.asList(new TypedLiteral("The ContractAgreement class representing the 'Restricted Number of Usages' policy class.", "en"));
	...
	*/
	...
	protected NotMoreThanNAgreementImpl() {
		id = VocabUtil.getInstance().createRandomUrl("notMoreThanNAgreement");
	}
	...
	public boolean equals(Object obj) {
		if (this == obj) {
			...
			NotMoreThanNAgreementImpl other = (NotMoreThanNAgreementImpl) obj;
