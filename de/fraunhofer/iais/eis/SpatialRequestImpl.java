...
/** 
* "Spatial Usage Request"@en
* "The ContractRequest class representing the \'Location Restricted Usage\' policy class."@en 
*/
@JsonIgnoreProperties(ignoreUnknown = true)
@JsonTypeName("ids:SpatialRequest")
public class SpatialRequestImpl implements Serializable, SpatialRequest {
	...
	@JsonIgnore
	protected List<TypedLiteral> label = Arrays.asList(new TypedLiteral("Spatial Usage Request", "en"));

	//List of all comments of this class
	@JsonIgnore
	protected List<TypedLiteral> comment = Arrays.asList(new TypedLiteral("The ContractRequest class representing the 'Location Restricted Usage' policy class.", "en"));
	...
	*/
	...
	protected SpatialRequestImpl() {
		id = VocabUtil.getInstance().createRandomUrl("spatialRequest");
	}
	...
	public boolean equals(Object obj) {
		if (this == obj) {
			...
			SpatialRequestImpl other = (SpatialRequestImpl) obj;
