...
public class SpatialRequestImpl implements Serializable, SpatialRequest {
	...
	@JsonIgnore
	java.util.List<TypedLiteral> label = Arrays.asList(new TypedLiteral("Spatial Usage Request", "en"));
	//List of all comments of this class
	@JsonIgnore
	java.util.List<TypedLiteral> comment = Arrays.asList(new TypedLiteral("The ContractRequest class representing the 'Location Restricted Usage' policy class.", "en"));
