...
public enum ConnectorStatus implements ModelClass {
    ...
    CONNECTOR_BADLY_CONFIGURED("https://w3id.org/idsa/code/CONNECTOR_BADLY_CONFIGURED",
        Arrays.asList(new TypedLiteral("Connector badly configured", "en")),
        Arrays.asList(new TypedLiteral("Indicates that a Connector is badly configured.", "en"))),

    /**
     * Indicates that a Connector is offline.
     */
    CONNECTOR_OFFLINE("https://w3id.org/idsa/code/CONNECTOR_OFFLINE", Arrays.asList(new TypedLiteral("Connector Offline", "en")),
        Arrays.asList(new TypedLiteral("Indicates that a Connector is offline.", "en"))),

    /**
     * Indicates that a Connector is online.
     */
    CONNECTOR_ONLINE("https://w3id.org/idsa/code/CONNECTOR_ONLINE", Arrays.asList(new TypedLiteral("Connector Online", "en")),
        Arrays.asList(new TypedLiteral("Indicates that a Connector is online.", "en")));
    ...
    ConnectorStatus(String id, List<TypedLiteral> label, List<TypedLiteral> comment) {
        try {
            this.id = new URI(id);
            this.label = label;
