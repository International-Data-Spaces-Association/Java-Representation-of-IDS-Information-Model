...
/** 
* "Purpose Agreement"@en
* "The ContractAgreement class representing the \'Purpose-restricted Data Usage\' policy class."@en 
*/
@JsonIgnoreProperties(ignoreUnknown = true)
@JsonTypeName("ids:PurposeAgreement")
public class PurposeAgreementImpl implements Serializable, PurposeAgreement {
	...
	@JsonIgnore
	protected List<TypedLiteral> label = Arrays.asList(new TypedLiteral("Purpose Agreement", "en"));

	//List of all comments of this class
	@JsonIgnore
	protected List<TypedLiteral> comment = Arrays.asList(new TypedLiteral("The ContractAgreement class representing the 'Purpose-restricted Data Usage' policy class.", "en"));
	...
	*/
	...
	protected PurposeAgreementImpl() {
		id = VocabUtil.getInstance().createRandomUrl("purposeAgreement");
	}
	...
	public boolean equals(Object obj) {
		if (this == obj) {
			...
			PurposeAgreementImpl other = (PurposeAgreementImpl) obj;
