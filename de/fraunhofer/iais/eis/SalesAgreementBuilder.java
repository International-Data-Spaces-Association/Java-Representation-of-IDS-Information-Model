...
public class SalesAgreementBuilder {
	...
	*/
	final public SalesAgreementBuilder _permission_(ArrayList<? extends Permission> _permission_) {
	...
	*/
	final public SalesAgreementBuilder _prohibition_(ArrayList<? extends Prohibition> _prohibition_) {
	...
	*/
	final public SalesAgreementBuilder _obligation_(ArrayList<? extends Duty> _obligation_) {
