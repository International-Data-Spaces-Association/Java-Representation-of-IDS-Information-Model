...
public class SoftwareResourceBuilder implements Builder<SoftwareResource> {
     ...
     */
    public SoftwareResourceBuilder _hasQualityMeasurement_(List<QualityMeasurement> _hasQualityMeasurement_) {
        this.softwareResourceImpl.setHasQualityMeasurement(_hasQualityMeasurement_);
        return this;
    }
     ...
     * @return Builder object with new value for _hasQualityMeasurement
     */
    public SoftwareResourceBuilder _hasQualityMeasurement_(QualityMeasurement _hasQualityMeasurement_) {
        this.softwareResourceImpl.getHasQualityMeasurement().add(_hasQualityMeasurement_);
        return this;
    }
