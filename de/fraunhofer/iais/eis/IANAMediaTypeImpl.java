...
/** 
	...
	"The class of media types registered with IANA."@en */
@JsonIgnoreProperties(ignoreUnknown = true)
@JsonTypeName("ids:IANAMediaType")
public class IANAMediaTypeImpl implements Serializable, IANAMediaType {
	...
	@JsonIgnore
	java.util.List<TypedLiteral> label = Arrays.asList(new TypedLiteral("IANA Media Type", "en"));
	//List of all comments of this class
	@JsonIgnore
	java.util.List<TypedLiteral> comment = Arrays.asList(new TypedLiteral("The class of media types registered with IANA.", "en"));
