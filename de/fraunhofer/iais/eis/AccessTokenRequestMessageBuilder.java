...
public class AccessTokenRequestMessageBuilder {
	...
	*/
	final public AccessTokenRequestMessageBuilder _recipientConnector_(ArrayList<? extends URI> _recipientConnector_) {
	...
	*/
	final public AccessTokenRequestMessageBuilder _recipientAgent_(ArrayList<? extends URI> _recipientAgent_) {
