...
/** 
* "Sales Request"@en
* "The ContractRequest class representing the \'Purpose-restricted Data Usage\' policy class."@en 
*/
@JsonIgnoreProperties(ignoreUnknown = true)
@JsonTypeName("ids:PurposeRequest")
public class PurposeRequestImpl implements Serializable, PurposeRequest {
	...
	@JsonIgnore
	protected List<TypedLiteral> comment = Arrays.asList(new TypedLiteral("The ContractRequest class representing the 'Purpose-restricted Data Usage' policy class.", "en"));
	...
	*/
	...
	protected PurposeRequestImpl() {
		id = VocabUtil.getInstance().createRandomUrl("purposeRequest");
	}
	...
	public boolean equals(Object obj) {
		if (this == obj) {
			...
			PurposeRequestImpl other = (PurposeRequestImpl) obj;
