...
public class PurposeRequestImpl implements Serializable, PurposeRequest {
	...
	@JsonIgnore
	java.util.List<TypedLiteral> comment = Arrays.asList(new TypedLiteral("The ContractRequest class representing the 'Purpose-restricted Data Usage' policy class.", "en"));
