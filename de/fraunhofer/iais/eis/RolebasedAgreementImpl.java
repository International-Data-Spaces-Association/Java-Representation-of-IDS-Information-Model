...
/** 
* "Role-restricted Data Usage Agreement"@en
* "The ContractAgreement class representing the \'Role-restricted Data Usage\' policy class."@en 
*/
@JsonIgnoreProperties(ignoreUnknown = true)
@JsonTypeName("ids:RolebasedAgreement")
public class RolebasedAgreementImpl implements Serializable, RolebasedAgreement {
	...
	@JsonIgnore
	protected List<TypedLiteral> label = Arrays.asList(new TypedLiteral("Role-restricted Data Usage Agreement", "en"));

	//List of all comments of this class
	@JsonIgnore
	protected List<TypedLiteral> comment = Arrays.asList(new TypedLiteral("The ContractAgreement class representing the 'Role-restricted Data Usage' policy class.", "en"));
	...
	*/
	...
	protected RolebasedAgreementImpl() {
		id = VocabUtil.getInstance().createRandomUrl("rolebasedAgreement");
	}
	...
	public boolean equals(Object obj) {
		if (this == obj) {
			...
			RolebasedAgreementImpl other = (RolebasedAgreementImpl) obj;
