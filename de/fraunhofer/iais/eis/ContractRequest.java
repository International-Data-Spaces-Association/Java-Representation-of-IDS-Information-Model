...
public interface ContractRequest extends Contract {
	...
	*/
	...
	/**
	* This function returns a hash code value for the ContractRequest for the benefit of e.g. hash tables.
	* @return a hash code value for the ContractRequest
	*/
	public int hashCode();
	...
	* @return true if this ContractRequest is the same as the obj argument; false otherwise.
	*/
