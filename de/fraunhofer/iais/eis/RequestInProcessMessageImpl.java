...
public class RequestInProcessMessageImpl implements Serializable, RequestInProcessMessage {
	...
	@JsonIgnore
	java.util.List<TypedLiteral> label = Arrays.asList(new TypedLiteral("Request In Process Message", "en"));
	//List of all comments of this class
	@JsonIgnore
	java.util.List<TypedLiteral> comment = Arrays.asList(new TypedLiteral("Notification that a request has been accepted and is being processed.", "en"));
