...
/** 
* "Request In Process Message"@en
* "Notification that a request has been accepted and is being processed."@en 
*/
@JsonIgnoreProperties(ignoreUnknown = true)
@JsonTypeName("ids:RequestInProcessMessage")
public class RequestInProcessMessageImpl implements Serializable, RequestInProcessMessage {
	...
	@JsonIgnore
	protected List<TypedLiteral> comment = Arrays.asList(new TypedLiteral("Notification that a request has been accepted and is being processed.", "en"));
