...
public class ConnectorbasedAgreementBuilder {
	...
	*/
	final public ConnectorbasedAgreementBuilder _permission_(ArrayList<? extends Permission> _permission_) {
	...
	*/
	final public ConnectorbasedAgreementBuilder _prohibition_(ArrayList<? extends Prohibition> _prohibition_) {
	...
	*/
	final public ConnectorbasedAgreementBuilder _obligation_(ArrayList<? extends Duty> _obligation_) {
	...
	*/
	...
	final public ConnectorbasedAgreement build() throws ConstraintViolationException {
