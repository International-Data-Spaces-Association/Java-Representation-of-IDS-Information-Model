...
public interface InvokeOperationMessage extends RequestMessage {
	...
	*/
	...
	/**
	* This function returns a hash code value for the InvokeOperationMessage for the benefit of e.g. hash tables.
	* @return a hash code value for the InvokeOperationMessage
	*/
	public int hashCode();
	...
	* @return true if this InvokeOperationMessage is the same as the obj argument; false otherwise.
	*/
