...
public class ResourceBuilder implements Builder<Resource> {
     ...
     */
    public ResourceBuilder _hasQualityMeasurement_(List<QualityMeasurement> _hasQualityMeasurement_) {
        this.resourceImpl.setHasQualityMeasurement(_hasQualityMeasurement_);
        return this;
    }
     ...
     * @return Builder object with new value for _hasQualityMeasurement
     */
    public ResourceBuilder _hasQualityMeasurement_(QualityMeasurement _hasQualityMeasurement_) {
        this.resourceImpl.getHasQualityMeasurement().add(_hasQualityMeasurement_);
        return this;
    }
