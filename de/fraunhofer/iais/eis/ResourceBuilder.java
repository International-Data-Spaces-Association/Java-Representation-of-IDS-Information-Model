...
public class ResourceBuilder {
	...
	*/
	final public ResourceBuilder _resourceEndpoint_(ArrayList<? extends ConnectorEndpoint> _resourceEndpoint_) {
	...
	*/
	final public ResourceBuilder _resourcePart_(ArrayList<? extends Resource> _resourcePart_) {
	...
	*/
	final public ResourceBuilder _contractOffer_(ArrayList<? extends ContractOffer> _contractOffer_) {
	...
	*/
	final public ResourceBuilder _sample_(ArrayList<? extends Resource> _sample_) {
	...
	*/
	final public ResourceBuilder _contentPart_(ArrayList<? extends DigitalContent> _contentPart_) {
	...
	*/
	final public ResourceBuilder _spatialCoverage_(ArrayList<? extends Location> _spatialCoverage_) {
	...
	*/
	final public ResourceBuilder _temporalCoverage_(ArrayList<? extends TemporalEntity> _temporalCoverage_) {
	...
	*/
	final public ResourceBuilder _theme_(ArrayList<? extends URI> _theme_) {
	...
	*/
	final public ResourceBuilder _keyword_(ArrayList<? extends TypedLiteral> _keyword_) {
	...
	*/
	final public ResourceBuilder _representation_(ArrayList<? extends Representation> _representation_) {
	...
	*/
	final public ResourceBuilder _defaultRepresentation_(ArrayList<? extends Representation> _defaultRepresentation_) {
	...
	*/
	final public ResourceBuilder _language_(ArrayList<? extends Language> _language_) {
	...
	*/
	final public ResourceBuilder _title_(ArrayList<? extends TypedLiteral> _title_) {
	...
	*/
	final public ResourceBuilder _description_(ArrayList<? extends TypedLiteral> _description_) {
