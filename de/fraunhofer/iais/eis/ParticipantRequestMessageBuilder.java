...
public class ParticipantRequestMessageBuilder {
	...
	/**
	* This function allows setting a value for requestedParticipant
	* @param _requestedParticipant_ desired value to be set
	* @return Builder object with new value for requestedParticipant
	*/
	...
	*/
	final public ParticipantRequestMessageBuilder _recipientConnector_(ArrayList<? extends URI> _recipientConnector_) {
	...
	*/
	final public ParticipantRequestMessageBuilder _recipientAgent_(ArrayList<? extends URI> _recipientAgent_) {
