...
public class PurposeOfferBuilder {
	...
	*/
	final public PurposeOfferBuilder _permission_(List<Permission> _permission_) {
	...
	*/
	final public PurposeOfferBuilder _prohibition_(List<Prohibition> _prohibition_) {
	...
	*/
	final public PurposeOfferBuilder _obligation_(List<Duty> _obligation_) {
