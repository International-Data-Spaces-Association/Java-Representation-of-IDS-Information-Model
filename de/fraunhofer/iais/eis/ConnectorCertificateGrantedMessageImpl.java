...
/** 
* "Connector Certificate Granted Message"@en
* "Whenever a Connector has been successfully certified by the Certification Body, the Identity Provider can use this message to notify Infrastructure Components."@en 
*/
@JsonIgnoreProperties(ignoreUnknown = true)
@JsonTypeName("ids:ConnectorCertificateGrantedMessage")
public class ConnectorCertificateGrantedMessageImpl implements Serializable, ConnectorCertificateGrantedMessage {
	...
	@JsonIgnore
	protected List<TypedLiteral> label = Arrays.asList(new TypedLiteral("Connector Certificate Granted Message", "en"));

	//List of all comments of this class
	@JsonIgnore
	protected List<TypedLiteral> comment = Arrays.asList(new TypedLiteral("Whenever a Connector has been successfully certified by the Certification Body, the Identity Provider can use this message to notify Infrastructure Components.", "en"));
	...
	*/
	...
	protected ConnectorCertificateGrantedMessageImpl() {
		id = VocabUtil.getInstance().createRandomUrl("connectorCertificateGrantedMessage");
	}
	...
	public int hashCode() {
		return Objects.hash(new Object[]{this._affectedConnector,
			this._modelVersion,
			this._issued,
	...
	public boolean equals(Object obj) {
		if (this == obj) {
			...
			ConnectorCertificateGrantedMessageImpl other = (ConnectorCertificateGrantedMessageImpl) obj;
			return Objects.equals(this._affectedConnector, other._affectedConnector) &&
	...
	final public URI getAffectedConnector() {
