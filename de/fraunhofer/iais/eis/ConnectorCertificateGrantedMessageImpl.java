...
public class ConnectorCertificateGrantedMessageImpl implements Serializable, ConnectorCertificateGrantedMessage {
	...
	@JsonIgnore
	java.util.List<TypedLiteral> label = Arrays.asList(new TypedLiteral("Connector Certificate Granted Message", "en"));
	//List of all comments of this class
	@JsonIgnore
	java.util.List<TypedLiteral> comment = Arrays.asList(new TypedLiteral("Whenever a Connector has been successfully certified by the Certification Body, the Identity Provider can use this message to notify Infrastructure Components.", "en"));
	...
	*/
	...
	ConnectorCertificateGrantedMessageImpl() {
