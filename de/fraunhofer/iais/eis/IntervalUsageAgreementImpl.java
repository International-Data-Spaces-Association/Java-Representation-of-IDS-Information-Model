...
public class IntervalUsageAgreementImpl implements Serializable, IntervalUsageAgreement {
	...
	@JsonIgnore
	java.util.List<TypedLiteral> label = Arrays.asList(new TypedLiteral("Interval Usage Agreement", "en"));
	//List of all comments of this class
	@JsonIgnore
	java.util.List<TypedLiteral> comment = Arrays.asList(new TypedLiteral("The ContractAgreement class representing the 'Interval-restricted Data Usage' policy class.", "en"));
