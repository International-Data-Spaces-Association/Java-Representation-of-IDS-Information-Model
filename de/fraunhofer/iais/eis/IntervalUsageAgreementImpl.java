...
/** 
* "Interval Usage Agreement"@en
* "The ContractAgreement class representing the \'Interval-restricted Data Usage\' policy class."@en 
*/
@JsonIgnoreProperties(ignoreUnknown = true)
@JsonTypeName("ids:IntervalUsageAgreement")
public class IntervalUsageAgreementImpl implements Serializable, IntervalUsageAgreement {
	...
	@JsonIgnore
	protected List<TypedLiteral> label = Arrays.asList(new TypedLiteral("Interval Usage Agreement", "en"));

	//List of all comments of this class
	@JsonIgnore
	protected List<TypedLiteral> comment = Arrays.asList(new TypedLiteral("The ContractAgreement class representing the 'Interval-restricted Data Usage' policy class.", "en"));
	...
	*/
	...
	protected IntervalUsageAgreementImpl() {
		id = VocabUtil.getInstance().createRandomUrl("intervalUsageAgreement");
	}
	...
	public boolean equals(Object obj) {
		if (this == obj) {
			...
			IntervalUsageAgreementImpl other = (IntervalUsageAgreementImpl) obj;
