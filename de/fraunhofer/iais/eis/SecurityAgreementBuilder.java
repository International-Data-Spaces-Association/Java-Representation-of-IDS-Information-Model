...
public class SecurityAgreementBuilder {
	...
	*/
	final public SecurityAgreementBuilder _permission_(ArrayList<? extends Permission> _permission_) {
	...
	*/
	final public SecurityAgreementBuilder _prohibition_(ArrayList<? extends Prohibition> _prohibition_) {
	...
	*/
	final public SecurityAgreementBuilder _obligation_(ArrayList<? extends Duty> _obligation_) {
