...
public class AppAvailableMessageBuilder {
	...
	*/
	final public AppAvailableMessageBuilder _recipientConnector_(ArrayList<? extends URI> _recipientConnector_) {
	...
	*/
	final public AppAvailableMessageBuilder _recipientAgent_(ArrayList<? extends URI> _recipientAgent_) {
	...
	*/
	...
	final public AppAvailableMessage build() throws ConstraintViolationException {
