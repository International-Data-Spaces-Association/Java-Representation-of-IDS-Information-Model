...
public class ArtifactBuilder {
	...
	/**
	* This function allows setting a value for byteSize
	* @param _byteSize_ desired value to be set
	* @return Builder object with new value for byteSize
	*/
	...
	/**
	* This function allows setting a value for fileName
	* @param _fileName_ desired value to be set
	* @return Builder object with new value for fileName
	*/
	...
	/**
	* This function allows setting a value for creationDate
	* @param _creationDate_ desired value to be set
	* @return Builder object with new value for creationDate
	*/
	...
	*/
	...
	/**
	* This function allows setting a value for duration
	* @param _duration_ desired value to be set
	* @return Builder object with new value for duration
	*/
