...
public class MessageProcessedNotificationMessageBuilder {
	...
	*/
	final public MessageProcessedNotificationMessageBuilder _recipientConnector_(ArrayList<? extends URI> _recipientConnector_) {
	...
	*/
	final public MessageProcessedNotificationMessageBuilder _recipientAgent_(ArrayList<? extends URI> _recipientAgent_) {
	...
	*/
	...
	final public MessageProcessedNotificationMessage build() throws ConstraintViolationException {
