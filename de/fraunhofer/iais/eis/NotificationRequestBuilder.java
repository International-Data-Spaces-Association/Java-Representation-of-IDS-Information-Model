...
public class NotificationRequestBuilder {
	...
	*/
	final public NotificationRequestBuilder _permission_(List<Permission> _permission_) {
	...
	*/
	final public NotificationRequestBuilder _prohibition_(List<Prohibition> _prohibition_) {
	...
	*/
	final public NotificationRequestBuilder _obligation_(List<Duty> _obligation_) {
