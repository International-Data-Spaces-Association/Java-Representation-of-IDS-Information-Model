...
/** 
	...
	"The ContractOffer class representing the \'Purpose-restricted Data Usage\' policy class."@en */
@JsonIgnoreProperties(ignoreUnknown = true)
@JsonTypeName("ids:PurposeOffer")
public class PurposeOfferImpl implements Serializable, PurposeOffer {
	...
	@JsonIgnore
	java.util.List<TypedLiteral> comment = Arrays.asList(new TypedLiteral("The ContractOffer class representing the 'Purpose-restricted Data Usage' policy class.", "en"));
	...
	*/
	...
	PurposeOfferImpl() {
		id = VocabUtil.getInstance().createRandomUrl("purposeOffer");
	}
