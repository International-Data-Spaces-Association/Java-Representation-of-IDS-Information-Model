...
public class PurposeOfferImpl implements Serializable, PurposeOffer {
	...
	@JsonIgnore
	protected List<TypedLiteral> comment = Arrays.asList(new TypedLiteral("The ContractOffer class representing the 'Purpose-restricted Data Usage' policy class.", "en"));
	...
	*/
	...
	public boolean equals(Object obj) {
		if (this == obj) {
			...
			PurposeOfferImpl other = (PurposeOfferImpl) obj;
