...
public class EventAgreementBuilder {
	...
	*/
	final public EventAgreementBuilder _permission_(ArrayList<? extends Permission> _permission_) {
	...
	*/
	final public EventAgreementBuilder _prohibition_(ArrayList<? extends Prohibition> _prohibition_) {
	...
	*/
	final public EventAgreementBuilder _obligation_(ArrayList<? extends Duty> _obligation_) {
