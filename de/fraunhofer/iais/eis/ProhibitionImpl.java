...
/**
 * Default implementation of package de.fraunhofer.iais.eis.Prohibition
 * 
...
public class ProhibitionImpl implements Prohibition {
    ...
    protected List<TypedLiteral> comment =
        Arrays.asList(new TypedLiteral("The class of Prohibitions as defined in the ODRL ontology.", "en"));
    ...
    @Override
    /**
     * Helper function for (de-)serialization of the _prohibition and the
     * _prohibitionAsParticipantfields.
     *
    ...
    @Override
    /**
     * Helper function for (de-)serialization of the _prohibition and the _prohibitionAsAssetfields.
     *
     * @return Returns the a UriOrModelClass object with the content of the field or null if the field
     *         is not set.
     */
