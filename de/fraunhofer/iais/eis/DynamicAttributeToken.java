...
public interface DynamicAttributeToken extends Token {
	...
	*/
	...
	/**
	* This function returns a hash code value for the DynamicAttributeToken for the benefit of e.g. hash tables.
	* @return a hash code value for the DynamicAttributeToken
	*/
	public int hashCode();
	...
	* @return true if this DynamicAttributeToken is the same as the obj argument; false otherwise.
	*/
