...
/** 
	...
	"The ContractOffer class representing the \'Duration-restricted Data Usage\' policy class."@en */
@JsonIgnoreProperties(ignoreUnknown = true)
@JsonTypeName("ids:DurationOffer")
public class DurationOfferImpl implements Serializable, DurationOffer {
	...
	@JsonIgnore
	java.util.List<TypedLiteral> comment = Arrays.asList(new TypedLiteral("The ContractOffer class representing the 'Duration-restricted Data Usage' policy class.", "en"));
	...
	*/
	...
	DurationOfferImpl() {
		id = VocabUtil.getInstance().createRandomUrl("durationOffer");
	}
