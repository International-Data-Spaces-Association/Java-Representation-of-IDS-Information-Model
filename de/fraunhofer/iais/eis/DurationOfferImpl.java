...
public class DurationOfferImpl implements Serializable, DurationOffer {
	...
	@JsonIgnore
	protected List<TypedLiteral> comment = Arrays.asList(new TypedLiteral("The ContractOffer class representing the 'Duration-restricted Data Usage' policy class.", "en"));
	...
	*/
	...
	public boolean equals(Object obj) {
		if (this == obj) {
			...
			DurationOfferImpl other = (DurationOfferImpl) obj;
