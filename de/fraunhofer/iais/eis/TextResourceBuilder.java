...
public class TextResourceBuilder implements Builder<TextResource> {
     ...
     */
    public TextResourceBuilder _hasQualityMeasurement_(List<QualityMeasurement> _hasQualityMeasurement_) {
        this.textResourceImpl.setHasQualityMeasurement(_hasQualityMeasurement_);
        return this;
    }
     ...
     * @return Builder object with new value for _hasQualityMeasurement
     */
    public TextResourceBuilder _hasQualityMeasurement_(QualityMeasurement _hasQualityMeasurement_) {
        this.textResourceImpl.getHasQualityMeasurement().add(_hasQualityMeasurement_);
        return this;
    }
