...
public class TextResourceBuilder {
	...
	*/
	final public TextResourceBuilder _resourceEndpoint_(ArrayList<? extends ConnectorEndpoint> _resourceEndpoint_) {
	...
	*/
	final public TextResourceBuilder _resourcePart_(ArrayList<? extends Resource> _resourcePart_) {
	...
	*/
	final public TextResourceBuilder _contractOffer_(ArrayList<? extends ContractOffer> _contractOffer_) {
	...
	*/
	final public TextResourceBuilder _sample_(ArrayList<? extends Resource> _sample_) {
	...
	*/
	final public TextResourceBuilder _contentPart_(ArrayList<? extends DigitalContent> _contentPart_) {
	...
	*/
	final public TextResourceBuilder _spatialCoverage_(ArrayList<? extends Location> _spatialCoverage_) {
	...
	*/
	final public TextResourceBuilder _temporalCoverage_(ArrayList<? extends TemporalEntity> _temporalCoverage_) {
	...
	*/
	final public TextResourceBuilder _theme_(ArrayList<? extends URI> _theme_) {
	...
	*/
	final public TextResourceBuilder _keyword_(ArrayList<? extends TypedLiteral> _keyword_) {
	...
	*/
	final public TextResourceBuilder _representation_(ArrayList<? extends Representation> _representation_) {
	...
	*/
	final public TextResourceBuilder _defaultRepresentation_(ArrayList<? extends Representation> _defaultRepresentation_) {
	...
	*/
	final public TextResourceBuilder _language_(ArrayList<? extends Language> _language_) {
	...
	*/
	final public TextResourceBuilder _title_(ArrayList<? extends TypedLiteral> _title_) {
	...
	*/
	final public TextResourceBuilder _description_(ArrayList<? extends TypedLiteral> _description_) {
