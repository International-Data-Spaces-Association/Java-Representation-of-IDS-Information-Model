...
public class LogMessageImpl implements Serializable, LogMessage {
	...
	@JsonIgnore
	java.util.List<TypedLiteral> label = Arrays.asList(new TypedLiteral("Log Message", "en"));
	//List of all comments of this class
	@JsonIgnore
	java.util.List<TypedLiteral> comment = Arrays.asList(new TypedLiteral("Log Message which can be used to transfer logs e.g. to the clearing house.", "en"));
	...
	*/
	...
	LogMessageImpl() {
		id = VocabUtil.getInstance().createRandomUrl("logMessage");
	}
