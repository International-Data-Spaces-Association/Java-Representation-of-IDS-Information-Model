...
/**
 * Default implementation of package de.fraunhofer.iais.eis.Metric
 * 
...
@JsonTypeName("http://www.w3.org/ns/dqv#Metric")
public class MetricImpl implements Metric {
    ...
    @JsonIgnore
    protected List<TypedLiteral> label = Arrays.asList(new TypedLiteral("Metric", "en"));
    ...
    protected MetricImpl() {
        id = VocabUtil.getInstance().createRandomUrl("metric");
    }
