...
/**
 * Default implementation of package de.fraunhofer.iais.eis.DataRepresentation
 * 
 * Physical representation of (structured) data.
 */
@JsonIgnoreProperties(ignoreUnknown = true)
@JsonTypeName("ids:DataRepresentation")
public class DataRepresentationImpl implements DataRepresentation {
    ...
    @JsonIgnore
    protected List<TypedLiteral> label = Arrays.asList(new TypedLiteral("Data representation", "en"));

    // List of all comments of this class
    @JsonIgnore
    protected List<TypedLiteral> comment = Arrays.asList(new TypedLiteral("Physical representation of (structured) data.", "en"));
    ...
    protected URI _dataType;

    @JsonAlias({"ids:dataTypeSchema", "dataTypeSchema"})
    protected Resource _dataTypeSchema;
    ...
    protected DataRepresentationImpl() {
    ...
    @Override
    public int hashCode() {
        return Objects.hash(this._dataType,
            this._dataTypeSchema,
            this._instance,
            this._mediaType,
    ...
    public boolean equals(Object obj) {
        if (this == obj) {
            ...
            DataRepresentationImpl other = (DataRepresentationImpl) obj;
            return Objects.equals(this._dataType, other._dataType) &&
                Objects.equals(this._dataTypeSchema, other._dataTypeSchema) &&
