...
public class DataRepresentationImpl implements Serializable, DataRepresentation {
	...
	*/
	...
	/**
	* "Indicates the data type of the Representation."@en
	* @return Returns the URI for the property dataType.
	...
	*/
	...
	/**
	* "Indicates the data type of the Representation."@en
	* @param _dataType_ desired value for the property dataType.
	* More information under https://w3id.org/idsa/core/dataType
	*/
	...
	/**
	* "Indicates the data type schema of the Representation."@en
	* @return Returns the Resource for the property dataTypeSchema.
	...
	*/
	...
	/**
	* "Indicates the data type schema of the Representation."@en
	* @param _dataTypeSchema_ desired value for the property dataTypeSchema.
	* More information under https://w3id.org/idsa/core/dataTypeSchema
	*/
