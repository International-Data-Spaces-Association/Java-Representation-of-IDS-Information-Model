...
public interface ParticipantCertificateRevokedMessage extends ParticipantNotificationMessage {
	...
	*/
	...
	/**
	* This function returns a hash code value for the ParticipantCertificateRevokedMessage for the benefit of e.g. hash tables.
	* @return a hash code value for the ParticipantCertificateRevokedMessage
	*/
	public int hashCode();
	...
	* @return true if this ParticipantCertificateRevokedMessage is the same as the obj argument; false otherwise.
	*/
