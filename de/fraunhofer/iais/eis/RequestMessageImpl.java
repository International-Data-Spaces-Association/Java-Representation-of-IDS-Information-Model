...
@JsonTypeName("ids:RequestMessage")
public class RequestMessageImpl implements Serializable, RequestMessage {
	...
	@JsonIgnore
	java.util.List<TypedLiteral> label = Arrays.asList(new TypedLiteral("Request Message", "en"));
	//List of all comments of this class
	@JsonIgnore
	java.util.List<TypedLiteral> comment = Arrays.asList(new TypedLiteral("Client-generated message initiating a communication, motivated by a certain reason and with an answer expected.", "en"));
	...
	*/
	...
	RequestMessageImpl() {
		id = VocabUtil.getInstance().createRandomUrl("requestMessage");
	}
