...
/** 
* "Participant Unavailable Message"@en
* "Event notifying the recipient(s) that a participant will be unavailable. The same participant may be available again in the future."@en 
*/
@JsonIgnoreProperties(ignoreUnknown = true)
@JsonTypeName("ids:ParticipantUnavailableMessage")
public class ParticipantUnavailableMessageImpl implements Serializable, ParticipantUnavailableMessage {
	...
	@JsonIgnore
	protected List<TypedLiteral> label = Arrays.asList(new TypedLiteral("Participant Unavailable Message", "en"));

	//List of all comments of this class
	@JsonIgnore
	protected List<TypedLiteral> comment = Arrays.asList(new TypedLiteral("Event notifying the recipient(s) that a participant will be unavailable. The same participant may be available again in the future.", "en"));
	...
	*/
	...
	protected ParticipantUnavailableMessageImpl() {
		id = VocabUtil.getInstance().createRandomUrl("participantUnavailableMessage");
	}
	...
	public boolean equals(Object obj) {
		if (this == obj) {
			...
			ParticipantUnavailableMessageImpl other = (ParticipantUnavailableMessageImpl) obj;
