...
public class ParticipantUnavailableMessageImpl implements Serializable, ParticipantUnavailableMessage {
	...
	@JsonIgnore
	java.util.List<TypedLiteral> label = Arrays.asList(new TypedLiteral("Participant Unavailable Message", "en"));
	//List of all comments of this class
	@JsonIgnore
	java.util.List<TypedLiteral> comment = Arrays.asList(new TypedLiteral("Event notifying the recipient(s) that a participant will be unavailable. The same participant may be available again in the future.", "en"));
	...
	*/
	...
	ParticipantUnavailableMessageImpl() {
